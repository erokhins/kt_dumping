...
'createLazyValue' @ [41:52] ==> public abstract fun <T : Any> createLazyValue(computable: () -> Map<String, KotlinJvmBinaryClass>): NotNullLazyValue<Map<String, KotlinJvmBinaryClass>> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
...
'findPackageParts' @ [42:36] ==> public abstract fun findPackageParts(packageFqName: String): List<String> defined in org.jetbrains.kotlin.descriptors.PackagePartProvider[DeserializedSimpleFunctionDescriptor]

'fqName' @ [42:53] ==> public final val fqName: FqName defined in org.jetbrains.kotlin.load.java.lazy.descriptors.LazyJavaPackageFragment[DeserializedPropertyDescriptor]
...
'ClassId' @ [43:27] ==> public constructor ClassId(@NotNull p0: FqName, @NotNull p1: Name) defined in org.jetbrains.kotlin.name.ClassId[JavaClassConstructorDescriptor]

'fqName' @ [43:35] ==> public final val fqName: FqName defined in org.jetbrains.kotlin.load.java.lazy.descriptors.LazyJavaPackageFragment[DeserializedPropertyDescriptor]

'identifier' @ [43:48] ==> @NotNull public open fun identifier(@NotNull p0: String): Name defined in org.jetbrains.kotlin.name.Name[JavaMethodDescriptor]
...
'createRecursionTolerantLazyValue' @ [50:48] ==> public abstract fun <T : Any> createRecursionTolerantLazyValue(computable: () -> List<FqName>, onRecursiveCall: List<FqName>): NotNullLazyValue<List<FqName>> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T : Any> -> List<FqName>
...
'isIgnored' @ [58:74] ==> public final fun isIgnored(): Boolean defined in org.jetbrains.kotlin.utils.Jsr305State[DeserializedSimpleFunctionDescriptor]

'EMPTY' @ [58:99] ==> public final val EMPTY: Annotations defined in org.jetbrains.kotlin.descriptors.annotations.Annotations.Companion[DeserializedPropertyDescriptor]
...
'createLazyValue' @ [65:50] ==> public abstract fun <T : Any> createLazyValue(computable: () -> HashMap<String, String> /* = HashMap<String, String> */): NotNullLazyValue<HashMap<String, String> /* = HashMap<String, String> */> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
...
'fqName' @ [87:61] ==> public final val fqName: FqName defined in org.jetbrains.kotlin.load.java.lazy.descriptors.LazyJavaPackageFragment[DeserializedPropertyDescriptor]
