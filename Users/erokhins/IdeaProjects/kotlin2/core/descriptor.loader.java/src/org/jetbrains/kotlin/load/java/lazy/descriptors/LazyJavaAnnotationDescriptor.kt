...
'createNullableLazyValue' @ [46:45] ==> public abstract fun <T : Any> createNullableLazyValue(computable: () -> FqName?): NullableLazyValue<FqName> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T : Any> -> FqName
...
'createLazyValue' @ [50:43] ==> public abstract fun <T : Any> createLazyValue(computable: () -> SimpleType): NotNullLazyValue<SimpleType> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T : Any> -> SimpleType
...
'createErrorType' @ [51:66] ==> @NotNull public open fun createErrorType(@NotNull p0: String): SimpleType defined in org.jetbrains.kotlin.types.ErrorUtils[JavaMethodDescriptor]
...
'builtIns' @ [52:85] ==> public abstract val builtIns: KotlinBuiltIns defined in org.jetbrains.kotlin.descriptors.ModuleDescriptor[DeserializedPropertyDescriptor]
...
'ConstantValueFactory' @ [60:27] ==> public constructor ConstantValueFactory(builtins: KotlinBuiltIns) defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[DeserializedClassConstructorDescriptor]
...
'builtIns' @ [60:57] ==> public abstract val builtIns: KotlinBuiltIns defined in org.jetbrains.kotlin.descriptors.ModuleDescriptor[DeserializedPropertyDescriptor]
...
'createConstantValue' @ [71:57] ==> public final fun createConstantValue(value: Any?): ConstantValue<*>? defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[DeserializedSimpleFunctionDescriptor]
...
'createAnnotationValue' @ [81:24] ==> public final fun createAnnotationValue(value: AnnotationDescriptor): AnnotationValue defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[DeserializedSimpleFunctionDescriptor]
...
'isError' @ [85:18] ==> public val KotlinType.isError: Boolean defined in org.jetbrains.kotlin.types[DeserializedPropertyDescriptor]
...
'annotationClass' @ [88:84] ==> public val AnnotationDescriptor.annotationClass: ClassDescriptor? defined in org.jetbrains.kotlin.resolve.descriptorUtil[DeserializedPropertyDescriptor]
...
'builtIns' @ [90:41] ==> public abstract val builtIns: KotlinBuiltIns defined in org.jetbrains.kotlin.descriptors.ModuleDescriptor[DeserializedPropertyDescriptor]

'getArrayType' @ [90:50] ==> @NotNull public open fun getArrayType(@NotNull p0: Variance, @NotNull p1: KotlinType): SimpleType defined in org.jetbrains.kotlin.builtins.KotlinBuiltIns[JavaMethodDescriptor]

'INVARIANT' @ [91:34] ==> enum entry INVARIANT defined in org.jetbrains.kotlin.types.Variance[FakeCallableDescriptorForObject]

'createErrorType' @ [92:36] ==> @NotNull public open fun createErrorType(@NotNull p0: String): SimpleType defined in org.jetbrains.kotlin.types.ErrorUtils[JavaMethodDescriptor]
...
'createNullValue' @ [96:72] ==> public final fun createNullValue(): NullValue defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[DeserializedSimpleFunctionDescriptor]
...
'createArrayValue' @ [99:24] ==> public final fun createArrayValue(value: List<ConstantValue<*>>, type: KotlinType): ArrayValue defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[DeserializedSimpleFunctionDescriptor]
...
'createEnumValue' @ [105:28] ==> public final fun createEnumValue(enumEntryClass: ClassDescriptor): EnumValue defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[DeserializedSimpleFunctionDescriptor]

'createErrorClassWithExactName' @ [105:55] ==> @NotNull public open fun createErrorClassWithExactName(@NotNull p0: Name): ClassDescriptor defined in org.jetbrains.kotlin.types.ErrorUtils[JavaMethodDescriptor]
...
'getContributedClassifier' @ [112:67] ==> public abstract fun getContributedClassifier(name: Name, location: LookupLocation): ClassifierDescriptor? defined in org.jetbrains.kotlin.resolve.scopes.MemberScope[DeserializedSimpleFunctionDescriptor]
...
'createEnumValue' @ [115:24] ==> public final fun createEnumValue(enumEntryClass: ClassDescriptor): EnumValue defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[DeserializedSimpleFunctionDescriptor]
...
'makeNotNullable' @ [120:30] ==> @NotNull public open fun makeNotNullable(@NotNull p0: KotlinType): KotlinType defined in org.jetbrains.kotlin.types.TypeUtils[JavaMethodDescriptor]
...
'resolveTopLevelClass' @ [125:32] ==> public fun ModuleDescriptor.resolveTopLevelClass(topLevelClassFqName: FqName, location: LookupLocation): ClassDescriptor? defined in org.jetbrains.kotlin.resolve.descriptorUtil[DeserializedSimpleFunctionDescriptor]

'FqName' @ [125:53] ==> public constructor FqName(@NotNull p0: String) defined in org.jetbrains.kotlin.name.FqName[JavaClassConstructorDescriptor]
...
'TypeProjectionImpl' @ [127:32] ==> public constructor TypeProjectionImpl(@NotNull p0: KotlinType) defined in org.jetbrains.kotlin.types.TypeProjectionImpl[JavaClassConstructorDescriptor]
...
'createKClassValue' @ [131:24] ==> public final fun createKClassValue(type: KotlinType): KClassValue defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[DeserializedSimpleFunctionDescriptor]
...
'FQ_NAMES_IN_TYPES' @ [135:35] ==> @field:JvmField public final val FQ_NAMES_IN_TYPES: DescriptorRenderer defined in org.jetbrains.kotlin.renderer.DescriptorRenderer.Companion[DeserializedPropertyDescriptor]

'renderAnnotation' @ [135:53] ==> public abstract fun renderAnnotation(annotation: AnnotationDescriptor, target: AnnotationUseSiteTarget? = ...): String defined in org.jetbrains.kotlin.renderer.DescriptorRenderer[DeserializedSimpleFunctionDescriptor]
...
'findNonGenericClassAcrossDependencies' @ [139:22] ==> public fun ModuleDescriptor.findNonGenericClassAcrossDependencies(classId: ClassId, notFoundClasses: NotFoundClasses): ClassDescriptor defined in org.jetbrains.kotlin.descriptors[DeserializedSimpleFunctionDescriptor]

'topLevel' @ [140:29] ==> @NotNull public open fun topLevel(@NotNull p0: FqName): ClassId defined in org.jetbrains.kotlin.name.ClassId[JavaMethodDescriptor]
...
'notFoundClasses' @ [141:76] ==> public final val notFoundClasses: NotFoundClasses defined in org.jetbrains.kotlin.serialization.deserialization.DeserializationComponents[DeserializedPropertyDescriptor]
