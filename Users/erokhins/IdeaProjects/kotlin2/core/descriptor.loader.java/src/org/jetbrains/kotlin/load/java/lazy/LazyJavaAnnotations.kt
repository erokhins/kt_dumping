...
'createMemoizedFunctionWithNullableValues' @ [31:69] ==> public abstract fun <K, V : Any> createMemoizedFunctionWithNullableValues(compute: (JavaAnnotation) -> AnnotationDescriptor?): MemoizedFunctionToNullable<JavaAnnotation, AnnotationDescriptor> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <K> -> JavaAnnotation
...
'AnnotationWithTarget' @ [44:51] ==> public constructor AnnotationWithTarget(annotation: AnnotationDescriptor, target: AnnotationUseSiteTarget?) defined in org.jetbrains.kotlin.descriptors.annotations.AnnotationWithTarget[DeserializedClassConstructorDescriptor]
