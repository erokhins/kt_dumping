...
'createLazyValue' @ [67:49] ==> public abstract fun <T : Any> createLazyValue(computable: () -> SimpleType): NotNullLazyValue<SimpleType> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T : Any> -> SimpleType
...
'findNonGenericClassAcrossDependencies' @ [68:31] ==> public fun ModuleDescriptor.findNonGenericClassAcrossDependencies(classId: ClassId, notFoundClasses: NotFoundClasses): ClassDescriptor defined in org.jetbrains.kotlin.descriptors[DeserializedSimpleFunctionDescriptor]
...
'NotFoundClasses' @ [70:17] ==> public constructor NotFoundClasses(storageManager: StorageManager, module: ModuleDescriptor) defined in org.jetbrains.kotlin.descriptors.NotFoundClasses[DeserializedClassConstructorDescriptor]
...
'createCacheWithNotNullValues' @ [74:78] ==> public abstract fun <K, V : Any> createCacheWithNotNullValues(): CacheWithNotNullValues<FqName, ClassDescriptor> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <K> -> FqName
...
'createLazyValue' @ [77:60] ==> public abstract fun <T : Any> createLazyValue(computable: () -> AnnotationsImpl): NotNullLazyValue<AnnotationsImpl> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
...
'builtIns' @ [78:26] ==> public abstract val builtIns: KotlinBuiltIns defined in org.jetbrains.kotlin.descriptors.ModuleDescriptor[DeserializedPropertyDescriptor]

'createDeprecatedAnnotation' @ [78:35] ==> public fun KotlinBuiltIns.createDeprecatedAnnotation(message: String, replaceWith: String = ..., level: String = ...): AnnotationDescriptor defined in org.jetbrains.kotlin.descriptors.annotations[DeserializedSimpleFunctionDescriptor]
...
'AnnotationsImpl' @ [80:17] ==> public constructor AnnotationsImpl(annotations: List<AnnotationDescriptor>) defined in org.jetbrains.kotlin.descriptors.annotations.AnnotationsImpl[DeserializedClassConstructorDescriptor]
...
'PackageFragmentDescriptorImpl' @ [84:50] ==> public constructor PackageFragmentDescriptorImpl(module: ModuleDescriptor, fqName: FqName) defined in org.jetbrains.kotlin.descriptors.impl.PackageFragmentDescriptorImpl[DeserializedClassConstructorDescriptor]
...
'FqName' @ [84:98] ==> public constructor FqName(@NotNull p0: String) defined in org.jetbrains.kotlin.name.FqName[JavaClassConstructorDescriptor]
...
'LazyWrappedType' @ [89:33] ==> public constructor LazyWrappedType(storageManager: StorageManager, computation: () -> KotlinType) defined in org.jetbrains.kotlin.types.LazyWrappedType[DeserializedClassConstructorDescriptor]
...
'builtIns' @ [89:74] ==> public abstract val builtIns: KotlinBuiltIns defined in org.jetbrains.kotlin.descriptors.ModuleDescriptor[DeserializedPropertyDescriptor]
...
'identifier' @ [92:49] ==> @NotNull public open fun identifier(@NotNull p0: String): Name defined in org.jetbrains.kotlin.name.Name[JavaMethodDescriptor]
...
'fqNameUnsafe' @ [101:38] ==> public val DeclarationDescriptor.fqNameUnsafe: FqNameUnsafe defined in org.jetbrains.kotlin.resolve.descriptorUtil[DeserializedPropertyDescriptor]
...
'isArrayOrPrimitiveArray' @ [111:28] ==> public open fun isArrayOrPrimitiveArray(@NotNull p0: ClassDescriptor): Boolean defined in org.jetbrains.kotlin.builtins.KotlinBuiltIns[JavaMethodDescriptor]
...
'classProto' @ [113:33] ==> public final val classProto: ProtoBuf.Class defined in org.jetbrains.kotlin.serialization.deserialization.descriptors.DeserializedClassDescriptor[DeserializedPropertyDescriptor]
...
'c' @ [114:33] ==> public final val c: DeserializationContext defined in org.jetbrains.kotlin.serialization.deserialization.descriptors.DeserializedClassDescriptor[DeserializedPropertyDescriptor]

'nameResolver' @ [114:35] ==> public final val nameResolver: NameResolver defined in org.jetbrains.kotlin.serialization.deserialization.DeserializationContext[DeserializedPropertyDescriptor]

'getName' @ [114:48] ==> @NotNull public abstract fun getName(p0: Int): Name defined in org.jetbrains.kotlin.serialization.deserialization.NameResolver[JavaMethodDescriptor]
...
'memberScope' @ [119:52] ==> public abstract val memberScope: MemberScope defined in org.jetbrains.kotlin.types.SimpleType[DeserializedPropertyDescriptor]

'getContributedFunctions' @ [119:64] ==> public abstract fun getContributedFunctions(name: Name, location: LookupLocation): Collection<SimpleFunctionDescriptor> defined in org.jetbrains.kotlin.resolve.scopes.MemberScope[DeserializedSimpleFunctionDescriptor]
...
'getContributedFunctions' @ [126:16] ==> public abstract fun getContributedFunctions(name: Name, location: LookupLocation): Collection<SimpleFunctionDescriptor> defined in org.jetbrains.kotlin.resolve.scopes.MemberScope[DeserializedSimpleFunctionDescriptor]
...
'substitute' @ [130:38] ==> @Nullable public abstract fun substitute(@NotNull substitutor: TypeSubstitutor): FunctionDescriptor? defined in org.jetbrains.kotlin.descriptors.SimpleFunctionDescriptor[JavaMethodDescriptor]
...
'buildSubstitutor' @ [132:113] ==> public final fun buildSubstitutor(): TypeSubstitutor defined in org.jetbrains.kotlin.types.TypeConstructorSubstitution[DeserializedSimpleFunctionDescriptor]
...
'newCopyBuilder' @ [135:49] ==> @NotNull public abstract fun newCopyBuilder(): FunctionDescriptor.CopyBuilder<out (SimpleFunctionDescriptor..SimpleFunctionDescriptor?)> defined in org.jetbrains.kotlin.descriptors.SimpleFunctionDescriptor[JavaMethodDescriptor]
...
'setOwner' @ [136:17] ==> @NotNull public abstract fun setOwner(@NotNull p0: DeclarationDescriptor): FunctionDescriptor.CopyBuilder<out (SimpleFunctionDescriptor..SimpleFunctionDescriptor?)> defined in org.jetbrains.kotlin.descriptors.FunctionDescriptor.CopyBuilder[JavaMethodDescriptor]
...
'setDispatchReceiverParameter' @ [137:17] ==> @NotNull public abstract fun setDispatchReceiverParameter(@Nullable p0: ReceiverParameterDescriptor?): FunctionDescriptor.CopyBuilder<out (SimpleFunctionDescriptor..SimpleFunctionDescriptor?)> defined in org.jetbrains.kotlin.descriptors.FunctionDescriptor.CopyBuilder[JavaMethodDescriptor]
...
'setSubstitution' @ [139:17] ==> @NotNull public abstract fun setSubstitution(@NotNull p0: TypeSubstitution): FunctionDescriptor.CopyBuilder<out (SimpleFunctionDescriptor..SimpleFunctionDescriptor?)> defined in org.jetbrains.kotlin.descriptors.FunctionDescriptor.CopyBuilder[JavaMethodDescriptor]
...
'builtIns' @ [139:81] ==> public abstract val builtIns: KotlinBuiltIns defined in org.jetbrains.kotlin.descriptors.ModuleDescriptor[DeserializedPropertyDescriptor]
...
'isFinalClass' @ [145:45] ==> public val ClassDescriptor.isFinalClass: Boolean defined in org.jetbrains.kotlin.descriptors[DeserializedPropertyDescriptor]
...
'setAdditionalAnnotations' @ [150:25] ==> @NotNull public abstract fun setAdditionalAnnotations(@NotNull p0: Annotations): FunctionDescriptor.CopyBuilder<out (SimpleFunctionDescriptor..SimpleFunctionDescriptor?)> defined in org.jetbrains.kotlin.descriptors.FunctionDescriptor.CopyBuilder[JavaMethodDescriptor]
...
'build' @ [158:15] ==> @Nullable public abstract fun build(): SimpleFunctionDescriptor? defined in org.jetbrains.kotlin.descriptors.FunctionDescriptor.CopyBuilder[JavaMethodDescriptor]
...
'fqNameSafe' @ [175:90] ==> public val DeclarationDescriptor.fqNameSafe: FqName defined in org.jetbrains.kotlin.resolve.descriptorUtil[DeserializedPropertyDescriptor]
...
'create' @ [177:39] ==> @JvmStatic public final fun <T> create(set: Collection<FqName>): SmartSet<FqName> defined in org.jetbrains.kotlin.utils.SmartSet.Companion[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T> -> FqName
...
'fqNameSafe' @ [177:78] ==> public val DeclarationDescriptor.fqNameSafe: FqName defined in org.jetbrains.kotlin.resolve.descriptorUtil[DeserializedPropertyDescriptor]
...
'computeIfAbsent' @ [181:83] ==> public abstract fun computeIfAbsent(key: FqName, computation: () -> ClassDescriptor): ClassDescriptor defined in org.jetbrains.kotlin.storage.CacheWithNotNullValues[DeserializedSimpleFunctionDescriptor]
...
'fqNameSafe' @ [181:122] ==> public val DeclarationDescriptor.fqNameSafe: FqName defined in org.jetbrains.kotlin.resolve.descriptorUtil[DeserializedPropertyDescriptor]
...
'isPublicAPI' @ [192:52] ==> public final val isPublicAPI: Boolean defined in org.jetbrains.kotlin.descriptors.Visibility[DeserializedPropertyDescriptor]

'isDeprecated' @ [193:40] ==> public open fun isDeprecated(@NotNull p0: DeclarationDescriptor): Boolean defined in org.jetbrains.kotlin.builtins.KotlinBuiltIns[JavaMethodDescriptor]
...
'fqNameSafe' @ [196:50] ==> public val DeclarationDescriptor.fqNameSafe: FqName defined in org.jetbrains.kotlin.resolve.descriptorUtil[DeserializedPropertyDescriptor]
...
'newCopyBuilder' @ [206:54] ==> @NotNull public abstract fun newCopyBuilder(): FunctionDescriptor.CopyBuilder<out (SimpleFunctionDescriptor..SimpleFunctionDescriptor?)> defined in org.jetbrains.kotlin.descriptors.SimpleFunctionDescriptor[JavaMethodDescriptor]
...
'setOwner' @ [207:9] ==> @NotNull public abstract fun setOwner(@NotNull p0: DeclarationDescriptor): FunctionDescriptor.CopyBuilder<out (SimpleFunctionDescriptor..SimpleFunctionDescriptor?)> defined in org.jetbrains.kotlin.descriptors.FunctionDescriptor.CopyBuilder[JavaMethodDescriptor]
...
'setVisibility' @ [208:9] ==> @NotNull public abstract fun setVisibility(@NotNull p0: Visibility): FunctionDescriptor.CopyBuilder<out (SimpleFunctionDescriptor..SimpleFunctionDescriptor?)> defined in org.jetbrains.kotlin.descriptors.FunctionDescriptor.CopyBuilder[JavaMethodDescriptor]
...
'setReturnType' @ [209:9] ==> @NotNull public abstract fun setReturnType(@NotNull p0: KotlinType): FunctionDescriptor.CopyBuilder<out (SimpleFunctionDescriptor..SimpleFunctionDescriptor?)> defined in org.jetbrains.kotlin.descriptors.FunctionDescriptor.CopyBuilder[JavaMethodDescriptor]
...
'setDispatchReceiverParameter' @ [210:9] ==> @NotNull public abstract fun setDispatchReceiverParameter(@Nullable p0: ReceiverParameterDescriptor?): FunctionDescriptor.CopyBuilder<out (SimpleFunctionDescriptor..SimpleFunctionDescriptor?)> defined in org.jetbrains.kotlin.descriptors.FunctionDescriptor.CopyBuilder[JavaMethodDescriptor]
...
'build' @ [211:7] ==> @Nullable public abstract fun build(): SimpleFunctionDescriptor? defined in org.jetbrains.kotlin.descriptors.FunctionDescriptor.CopyBuilder[JavaMethodDescriptor]
...
'dfs' @ [233:20] ==> public final fun <N : (Any..Any?), R : (Any..Any?)> dfs(@NotNull p0: (MutableCollection<(ClassDescriptor..ClassDescriptor?)>..Collection<(ClassDescriptor..ClassDescriptor?)>), @NotNull p1: ((ClassDescriptor..ClassDescriptor?)) -> (MutableIterable<(ClassDescriptor..ClassDescriptor?)>..Iterable<(ClassDescriptor..ClassDescriptor?)>), @NotNull p2: DFS.NodeHandler<(ClassDescriptor..ClassDescriptor?), (JvmBuiltInsSettings.JDKMemberStatus..JvmBuiltInsSettings.JDKMemberStatus?)>): (JvmBuiltInsSettings.JDKMemberStatus..JvmBuiltInsSettings.JDKMemberStatus?) defined in org.jetbrains.kotlin.utils.DFS[SamAdapterFunctionDescriptor]
Inferred types:
...
'constructor' @ [240:29] ==> public abstract val constructor: TypeConstructor defined in org.jetbrains.kotlin.types.KotlinType[DeserializedPropertyDescriptor]
...
'isAny' @ [266:28] ==> public open fun isAny(@NotNull p0: ClassDescriptor): Boolean defined in org.jetbrains.kotlin.builtins.KotlinBuiltIns[JavaMethodDescriptor]
...
'isUnderKotlinPackage' @ [269:29] ==> public open fun isUnderKotlinPackage(@NotNull p0: DeclarationDescriptor): Boolean defined in org.jetbrains.kotlin.builtins.KotlinBuiltIns[JavaMethodDescriptor]
...
'fqNameUnsafe' @ [271:22] ==> public val DeclarationDescriptor.fqNameUnsafe: FqNameUnsafe defined in org.jetbrains.kotlin.resolve.descriptorUtil[DeserializedPropertyDescriptor]
...
'resolveClassByFqName' @ [275:38] ==> public fun ModuleDescriptor.resolveClassByFqName(fqName: FqName, lookupLocation: LookupLocation): ClassDescriptor? defined in org.jetbrains.kotlin.descriptors[DeserializedSimpleFunctionDescriptor]
...
'fqNameSafe' @ [284:68] ==> public val DeclarationDescriptor.fqNameSafe: FqName defined in org.jetbrains.kotlin.resolve.descriptorUtil[DeserializedPropertyDescriptor]
...
'buildSubstitutor' @ [286:112] ==> public final fun buildSubstitutor(): TypeSubstitutor defined in org.jetbrains.kotlin.types.TypeConstructorSubstitution[DeserializedSimpleFunctionDescriptor]
...
'getBothWaysOverridability' @ [289:32] ==> @Nullable public open fun getBothWaysOverridability(p0: (CallableDescriptor..CallableDescriptor?), p1: (CallableDescriptor..CallableDescriptor?)): OverridingUtil.OverrideCompatibilityInfo.Result? defined in org.jetbrains.kotlin.resolve.OverridingUtil[JavaMethodDescriptor]
...
'substitute' @ [289:80] ==> @Nullable public abstract fun substitute(@NotNull substitutor: TypeSubstitutor): ConstructorDescriptor? defined in org.jetbrains.kotlin.descriptors.ConstructorDescriptor[JavaMethodDescriptor]
...
'isPublicAPI' @ [294:40] ==> public final val isPublicAPI: Boolean defined in org.jetbrains.kotlin.descriptors.Visibility[DeserializedPropertyDescriptor]
...
'isDeprecated' @ [297:33] ==> public open fun isDeprecated(@NotNull p0: DeclarationDescriptor): Boolean defined in org.jetbrains.kotlin.builtins.KotlinBuiltIns[JavaMethodDescriptor]
...
'newCopyBuilder' @ [301:29] ==> @NotNull public abstract fun newCopyBuilder(): FunctionDescriptor.CopyBuilder<out (FunctionDescriptor..FunctionDescriptor?)> defined in org.jetbrains.kotlin.descriptors.ClassConstructorDescriptor[JavaMethodDescriptor]
...
'setOwner' @ [302:17] ==> @NotNull public abstract fun setOwner(@NotNull p0: DeclarationDescriptor): FunctionDescriptor.CopyBuilder<out (FunctionDescriptor..FunctionDescriptor?)> defined in org.jetbrains.kotlin.descriptors.FunctionDescriptor.CopyBuilder[JavaMethodDescriptor]
...
'setReturnType' @ [303:17] ==> @NotNull public abstract fun setReturnType(@NotNull p0: KotlinType): FunctionDescriptor.CopyBuilder<out (FunctionDescriptor..FunctionDescriptor?)> defined in org.jetbrains.kotlin.descriptors.FunctionDescriptor.CopyBuilder[JavaMethodDescriptor]
...
'setSubstitution' @ [305:17] ==> @NotNull public abstract fun setSubstitution(@NotNull p0: TypeSubstitution): FunctionDescriptor.CopyBuilder<out (FunctionDescriptor..FunctionDescriptor?)> defined in org.jetbrains.kotlin.descriptors.FunctionDescriptor.CopyBuilder[JavaMethodDescriptor]
...
'setAdditionalAnnotations' @ [307:21] ==> @NotNull public abstract fun setAdditionalAnnotations(@NotNull p0: Annotations): FunctionDescriptor.CopyBuilder<out (FunctionDescriptor..FunctionDescriptor?)> defined in org.jetbrains.kotlin.descriptors.FunctionDescriptor.CopyBuilder[JavaMethodDescriptor]
...
'build' @ [310:15] ==> @Nullable public abstract fun build(): FunctionDescriptor? defined in org.jetbrains.kotlin.descriptors.FunctionDescriptor.CopyBuilder[JavaMethodDescriptor]
...
'annotations' @ [317:33] ==> public abstract val annotations: Annotations defined in org.jetbrains.kotlin.descriptors.SimpleFunctionDescriptor[DeserializedPropertyDescriptor]

'hasAnnotation' @ [317:45] ==> public open fun hasAnnotation(fqName: FqName): Boolean defined in org.jetbrains.kotlin.descriptors.annotations.Annotations[DeserializedSimpleFunctionDescriptor]

'PLATFORM_DEPENDENT_ANNOTATION_FQ_NAME' @ [317:59] ==> public val PLATFORM_DEPENDENT_ANNOTATION_FQ_NAME: FqName defined in org.jetbrains.kotlin.descriptors.deserialization[DeserializedPropertyDescriptor]
...
'constructor' @ [329:43] ==> public abstract val constructor: TypeConstructor defined in org.jetbrains.kotlin.types.KotlinType[DeserializedPropertyDescriptor]
...
'fqNameUnsafe' @ [329:78] ==> public val DeclarationDescriptor.fqNameUnsafe: FqNameUnsafe defined in org.jetbrains.kotlin.resolve.descriptorUtil[DeserializedPropertyDescriptor]
...
'fqNameUnsafe' @ [329:110] ==> public val DeclarationDescriptor.fqNameUnsafe: FqNameUnsafe defined in org.jetbrains.kotlin.resolve.descriptorUtil[DeserializedPropertyDescriptor]
...
'isPrimitiveArray' @ [347:78] ==> public open fun isPrimitiveArray(@NotNull p0: FqNameUnsafe): Boolean defined in org.jetbrains.kotlin.builtins.KotlinBuiltIns[JavaMethodDescriptor]
...
'KotlinBuiltIns' @ [481:56] ==> protected/*protected and package*/ constructor KotlinBuiltIns(@NotNull p0: StorageManager) defined in org.jetbrains.kotlin.builtins.KotlinBuiltIns[JavaClassConstructorDescriptor]
...
'BuiltInsInitializer' @ [487:35] ==> public constructor BuiltInsInitializer<out T : KotlinBuiltIns>(constructor: () -> FallbackBuiltIns) defined in org.jetbrains.kotlin.builtins.BuiltInsInitializer[DeserializedClassConstructorDescriptor]
Inferred types:
...
'get' @ [493:33] ==> public final fun get(): FallbackBuiltIns defined in org.jetbrains.kotlin.builtins.BuiltInsInitializer[DeserializedSimpleFunctionDescriptor]
