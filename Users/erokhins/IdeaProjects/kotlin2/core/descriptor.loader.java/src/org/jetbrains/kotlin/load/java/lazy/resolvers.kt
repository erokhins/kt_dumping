...
'mapToIndex' @ [40:97] ==> public fun <K> Iterable<JavaTypeParameter>.mapToIndex(): Map<JavaTypeParameter, Int> defined in org.jetbrains.kotlin.utils[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <K> -> JavaTypeParameter
