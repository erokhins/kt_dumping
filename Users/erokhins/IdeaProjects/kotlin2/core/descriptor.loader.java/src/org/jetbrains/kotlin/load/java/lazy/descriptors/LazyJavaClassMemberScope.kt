...
'memberScope' @ [74:16] ==> public abstract val memberScope: MemberScope defined in org.jetbrains.kotlin.types.KotlinType[DeserializedPropertyDescriptor]

'getFunctionNames' @ [74:28] ==> public abstract fun getFunctionNames(): Set<Name> defined in org.jetbrains.kotlin.resolve.scopes.MemberScope[DeserializedSimpleFunctionDescriptor]
...
'newCopyBuilder' @ [164:18] ==> @NotNull public abstract fun newCopyBuilder(): FunctionDescriptor.CopyBuilder<out (SimpleFunctionDescriptor..SimpleFunctionDescriptor?)> defined in org.jetbrains.kotlin.descriptors.SimpleFunctionDescriptor[JavaMethodDescriptor]
...
'setName' @ [165:17] ==> @NotNull public abstract fun setName(@NotNull p0: Name): FunctionDescriptor.CopyBuilder<out (SimpleFunctionDescriptor..SimpleFunctionDescriptor?)> defined in org.jetbrains.kotlin.descriptors.FunctionDescriptor.CopyBuilder[JavaMethodDescriptor]
...
'build' @ [168:15] ==> @Nullable public abstract fun build(): SimpleFunctionDescriptor? defined in org.jetbrains.kotlin.descriptors.FunctionDescriptor.CopyBuilder[JavaMethodDescriptor]
...
'isOverridableByWithoutExternalConditions' @ [182:40] ==> @NotNull public open fun isOverridableByWithoutExternalConditions(@NotNull p0: CallableDescriptor, @NotNull p1: CallableDescriptor, p2: Boolean): OverridingUtil.OverrideCompatibilityInfo defined in org.jetbrains.kotlin.resolve.OverridingUtil[JavaMethodDescriptor]
...
'identifier' @ [207:31] ==> @NotNull public open fun identifier(@NotNull p0: String): Name defined in org.jetbrains.kotlin.name.Name[JavaMethodDescriptor]
...
'firstNotNullResult' @ [207:55] ==> public inline fun <T, R : Any> Iterable<SimpleFunctionDescriptor>.firstNotNullResult(transform: (SimpleFunctionDescriptor) -> SimpleFunctionDescriptor?): SimpleFunctionDescriptor? defined in org.jetbrains.kotlin.utils.addToStdlib[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T> -> SimpleFunctionDescriptor
...
'isSubtypeOf' @ [211:59] ==> public abstract fun isSubtypeOf(@NotNull p0: KotlinType, @NotNull p1: KotlinType): Boolean defined in org.jetbrains.kotlin.types.checker.KotlinTypeChecker[JavaMethodDescriptor]
...
'identifier' @ [218:31] ==> @NotNull public open fun identifier(@NotNull p0: String): Name defined in org.jetbrains.kotlin.name.Name[JavaMethodDescriptor]
...
'firstNotNullResult' @ [218:79] ==> public inline fun <T, R : Any> Iterable<SimpleFunctionDescriptor>.firstNotNullResult(transform: (SimpleFunctionDescriptor) -> SimpleFunctionDescriptor?): SimpleFunctionDescriptor? defined in org.jetbrains.kotlin.utils.addToStdlib[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T> -> SimpleFunctionDescriptor
    <R : Any> -> SimpleFunctionDescriptor
...
'isUnit' @ [222:33] ==> public open fun isUnit(@NotNull p0: KotlinType): Boolean defined in org.jetbrains.kotlin.builtins.KotlinBuiltIns[JavaMethodDescriptor]
...
'equalTypes' @ [223:59] ==> public abstract fun equalTypes(@NotNull p0: KotlinType, @NotNull p1: KotlinType): Boolean defined in org.jetbrains.kotlin.types.checker.KotlinTypeChecker[JavaMethodDescriptor]
...
'create' @ [253:54] ==> @JvmStatic public final fun <T> create(): SmartSet<SimpleFunctionDescriptor> defined in org.jetbrains.kotlin.utils.SmartSet.Companion[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T> -> SimpleFunctionDescriptor
...
'identifier' @ [313:43] ==> @NotNull public open fun identifier(@NotNull p0: String): Name defined in org.jetbrains.kotlin.name.Name[JavaMethodDescriptor]
...
'newCopyBuilder' @ [351:13] ==> @NotNull public abstract fun newCopyBuilder(): FunctionDescriptor.CopyBuilder<out (SimpleFunctionDescriptor..SimpleFunctionDescriptor?)> defined in org.jetbrains.kotlin.descriptors.SimpleFunctionDescriptor[JavaMethodDescriptor]
...
'build' @ [351:66] ==> @Nullable public abstract fun build(): SimpleFunctionDescriptor? defined in org.jetbrains.kotlin.descriptors.FunctionDescriptor.CopyBuilder[JavaMethodDescriptor]
...
'newCopyBuilder' @ [361:22] ==> @NotNull public abstract fun newCopyBuilder(): FunctionDescriptor.CopyBuilder<out (SimpleFunctionDescriptor..SimpleFunctionDescriptor?)> defined in org.jetbrains.kotlin.descriptors.SimpleFunctionDescriptor[JavaMethodDescriptor]
...
'build' @ [365:15] ==> @Nullable public abstract fun build(): SimpleFunctionDescriptor? defined in org.jetbrains.kotlin.descriptors.FunctionDescriptor.CopyBuilder[JavaMethodDescriptor]
...
'memberScope' @ [371:16] ==> public abstract val memberScope: MemberScope defined in org.jetbrains.kotlin.types.KotlinType[DeserializedPropertyDescriptor]

'getContributedFunctions' @ [371:28] ==> public abstract fun getContributedFunctions(name: Name, location: LookupLocation): Collection<SimpleFunctionDescriptor> defined in org.jetbrains.kotlin.resolve.scopes.MemberScope[DeserializedSimpleFunctionDescriptor]
...
'create' @ [383:58] ==> @JvmStatic public final fun <T> create(): SmartSet<PropertyDescriptor> defined in org.jetbrains.kotlin.utils.SmartSet.Companion[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T> -> PropertyDescriptor
...
'createDefaultGetter' @ [425:40] ==> @NotNull public open fun createDefaultGetter(@NotNull p0: PropertyDescriptor, @NotNull p1: Annotations): PropertyGetterDescriptorImpl defined in org.jetbrains.kotlin.resolve.DescriptorFactory[JavaMethodDescriptor]
...
'initialize' @ [426:28] ==> public open fun initialize(@Nullable p0: PropertyGetterDescriptorImpl?, @Nullable p1: PropertySetterDescriptor?): Unit defined in org.jetbrains.kotlin.load.java.descriptors.JavaPropertyDescriptor[JavaMethodDescriptor]
...
'setType' @ [429:28] ==> public open fun setType(@NotNull p0: KotlinType, @ReadOnly @NotNull p1: List<(TypeParameterDescriptor..TypeParameterDescriptor?)>, @Nullable p2: ReceiverParameterDescriptor?, @Nullable p3: KotlinType?): Unit defined in org.jetbrains.kotlin.load.java.descriptors.JavaPropertyDescriptor[JavaMethodDescriptor]
...
'initialize' @ [430:16] ==> public open fun initialize(p0: (KotlinType..KotlinType?)): Unit defined in org.jetbrains.kotlin.descriptors.impl.PropertyGetterDescriptorImpl[JavaMethodDescriptor]
...
'setType' @ [459:28] ==> public open fun setType(@NotNull p0: KotlinType, @ReadOnly @NotNull p1: List<(TypeParameterDescriptor..TypeParameterDescriptor?)>, @Nullable p2: ReceiverParameterDescriptor?, @Nullable p3: KotlinType?): Unit defined in org.jetbrains.kotlin.load.java.descriptors.JavaPropertyDescriptor[JavaMethodDescriptor]
...
'createGetter' @ [461:40] ==> @NotNull public open fun createGetter(@NotNull p0: PropertyDescriptor, @NotNull p1: Annotations, p2: Boolean, p3: Boolean, p4: Boolean, @NotNull p5: SourceElement): PropertyGetterDescriptorImpl defined in org.jetbrains.kotlin.resolve.DescriptorFactory[JavaMethodDescriptor]
...
'annotations' @ [462:50] ==> public abstract val annotations: Annotations defined in org.jetbrains.kotlin.descriptors.SimpleFunctionDescriptor[DeserializedPropertyDescriptor]
...
'initialize' @ [466:13] ==> public open fun initialize(p0: (KotlinType..KotlinType?)): Unit defined in org.jetbrains.kotlin.descriptors.impl.PropertyGetterDescriptorImpl[JavaMethodDescriptor]
...
'createSetter' @ [470:31] ==> @NotNull public open fun createSetter(@NotNull p0: PropertyDescriptor, @NotNull p1: Annotations, p2: Boolean, p3: Boolean, p4: Boolean, @NotNull p5: Visibility, @NotNull p6: SourceElement): PropertySetterDescriptorImpl defined in org.jetbrains.kotlin.resolve.DescriptorFactory[JavaMethodDescriptor]
...
'annotations' @ [470:77] ==> public abstract val annotations: Annotations defined in org.jetbrains.kotlin.descriptors.SimpleFunctionDescriptor[DeserializedPropertyDescriptor]
...
'initialize' @ [477:43] ==> public open fun initialize(@Nullable p0: PropertyGetterDescriptorImpl?, @Nullable p1: PropertySetterDescriptor?): Unit defined in org.jetbrains.kotlin.load.java.descriptors.JavaPropertyDescriptor[JavaMethodDescriptor]
...
'memberScope' @ [482:16] ==> public abstract val memberScope: MemberScope defined in org.jetbrains.kotlin.types.KotlinType[DeserializedPropertyDescriptor]

'getContributedVariables' @ [482:28] ==> public abstract fun getContributedVariables(name: Name, location: LookupLocation): Collection<PropertyDescriptor> defined in org.jetbrains.kotlin.resolve.scopes.MemberScope[DeserializedSimpleFunctionDescriptor]
...
'makeNotNullable' @ [606:27] ==> @NotNull public open fun makeNotNullable(@NotNull p0: KotlinType): KotlinType defined in org.jetbrains.kotlin.types.TypeUtils[JavaMethodDescriptor]
...
'makeNotNullable' @ [611:52] ==> @NotNull public open fun makeNotNullable(@NotNull p0: KotlinType): KotlinType defined in org.jetbrains.kotlin.types.TypeUtils[JavaMethodDescriptor]
...
'createLazyValue' @ [616:53] ==> public abstract fun <T : Any> createLazyValue(computable: () -> Set<Name>): NotNullLazyValue<Set<Name>> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T : Any> -> Set<Name>
...
'createLazyValue' @ [620:51] ==> public abstract fun <T : Any> createLazyValue(computable: () -> Map<Name, JavaField>): NotNullLazyValue<Map<Name, JavaField>> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
...
'createMemoizedFunctionWithNullableValues' @ [624:50] ==> public abstract fun <K, V : Any> createMemoizedFunctionWithNullableValues(compute: (Name) -> ClassDescriptorBase?): MemoizedFunctionToNullable<Name, ClassDescriptorBase> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <K> -> Name
...
'createLazyValue' @ [629:85] ==> public abstract fun <T : Any> createLazyValue(computable: () -> Set<Name>): NotNullLazyValue<Set<Name>> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T : Any> -> Set<Name>
...
'create' @ [632:51] ==> @NotNull public open fun create(@NotNull p0: StorageManager, @NotNull p1: ClassDescriptor, @NotNull p2: Name, @NotNull p3: NotNullLazyValue<(MutableSet<(Name..Name?)>..Set<(Name..Name?)>?)>, @NotNull p4: Annotations, @NotNull p5: SourceElement): EnumEntrySyntheticClassDescriptor defined in org.jetbrains.kotlin.descriptors.impl.EnumEntrySyntheticClassDescriptor[JavaMethodDescriptor]
...
'classId' @ [640:59] ==> public val ClassifierDescriptorWithTypeParameters.classId: ClassId? defined in org.jetbrains.kotlin.resolve.descriptorUtil[DeserializedPropertyDescriptor]

'createNestedClassId' @ [640:69] ==> @NotNull public open fun createNestedClassId(@NotNull p0: Name): ClassId defined in org.jetbrains.kotlin.name.ClassId[JavaMethodDescriptor]
...
'getDispatchReceiverParameterIfNeeded' @ [647:29] ==> @Nullable public open fun getDispatchReceiverParameterIfNeeded(@NotNull p0: DeclarationDescriptor): ReceiverParameterDescriptor? defined in org.jetbrains.kotlin.resolve.DescriptorUtils[JavaMethodDescriptor]
...
'memberScope' @ [671:23] ==> public abstract val memberScope: MemberScope defined in org.jetbrains.kotlin.types.KotlinType[DeserializedPropertyDescriptor]

'getVariableNames' @ [671:35] ==> public abstract fun getVariableNames(): Set<Name> defined in org.jetbrains.kotlin.resolve.scopes.MemberScope[DeserializedSimpleFunctionDescriptor]
...
'record' @ [676:36] ==> public fun LookupTracker.record(from: LookupLocation, scopeOwner: ClassDescriptor, name: Name): Unit defined in org.jetbrains.kotlin.incremental[DeserializedSimpleFunctionDescriptor]
