'ClassDescriptorBase' @ [57:5] ==> protected/*protected and package*/ constructor ClassDescriptorBase(@NotNull p0: StorageManager, @NotNull p1: DeclarationDescriptor, @NotNull p2: Name, @NotNull p3: SourceElement, p4: Boolean) defined in org.jetbrains.kotlin.descriptors.impl.ClassDescriptorBase[JavaClassConstructorDescriptor]
...
'convertFromFlags' @ [85:42] ==> public final fun convertFromFlags(abstract: Boolean, open: Boolean): Modality defined in org.jetbrains.kotlin.descriptors.Modality.Companion[DeserializedSimpleFunctionDescriptor]
...
'InnerClassesScopeWrapper' @ [114:37] ==> public constructor InnerClassesScopeWrapper(workerScope: MemberScope) defined in org.jetbrains.kotlin.resolve.scopes.InnerClassesScopeWrapper[DeserializedClassConstructorDescriptor]
...
'createLazyValue' @ [128:55] ==> public abstract fun <T : Any> createLazyValue(computable: () -> List<TypeParameterDescriptor>): NotNullLazyValue<List<TypeParameterDescriptor>> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
...
'constructor' @ [155:16] ==> public abstract val constructor: TypeConstructor defined in org.jetbrains.kotlin.types.KotlinType[DeserializedPropertyDescriptor]
...
'safeAs' @ [155:50] ==> public inline fun <reified T : Any> Any?.safeAs(): LazyJavaClassDescriptor? defined in org.jetbrains.kotlin.utils.addToStdlib[DeserializedSimpleFunctionDescriptor]
Inferred types:
...
'fqNameUnsafe' @ [161:55] ==> public val DeclarationDescriptor.fqNameUnsafe: FqNameUnsafe defined in org.jetbrains.kotlin.resolve.descriptorUtil[DeserializedPropertyDescriptor]

'AbstractClassTypeConstructor' @ [163:56] ==> public constructor AbstractClassTypeConstructor(@NotNull p0: StorageManager) defined in org.jetbrains.kotlin.types.AbstractClassTypeConstructor[JavaClassConstructorDescriptor]
...
'createLazyValue' @ [164:51] ==> public abstract fun <T : Any> createLazyValue(computable: () -> List<TypeParameterDescriptor>): NotNullLazyValue<List<TypeParameterDescriptor>> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T : Any> -> List<TypeParameterDescriptor>
...
'computeConstructorTypeParameters' @ [165:42] ==> public fun ClassifierDescriptorWithTypeParameters.computeConstructorTypeParameters(): List<TypeParameterDescriptor> defined in org.jetbrains.kotlin.descriptors[DeserializedSimpleFunctionDescriptor]
...
'constructor' @ [179:32] ==> public abstract val constructor: TypeConstructor defined in org.jetbrains.kotlin.types.KotlinType[DeserializedPropertyDescriptor]
...
'constructor' @ [183:32] ==> public abstract val constructor: TypeConstructor defined in org.jetbrains.kotlin.types.KotlinType[DeserializedPropertyDescriptor]
...
'constructor' @ [183:75] ==> public abstract val constructor: TypeConstructor defined in org.jetbrains.kotlin.types.KotlinType[DeserializedPropertyDescriptor]

'!' @ [187:21] ==> public final operator fun not(): Boolean defined in kotlin.Boolean[DeserializedSimpleFunctionDescriptor]

'isAnyOrNullableAny' @ [187:37] ==> public open fun isAnyOrNullableAny(@NotNull p0: KotlinType): Boolean defined in org.jetbrains.kotlin.builtins.KotlinBuiltIns[JavaMethodDescriptor]
...
'addIfNotNull' @ [194:20] ==> public fun <T : Any> MutableCollection<KotlinType>.addIfNotNull(t: KotlinType?): Unit defined in org.jetbrains.kotlin.utils[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T : Any> -> KotlinType
...
'buildSubstitutor' @ [197:34] ==> public final fun buildSubstitutor(): TypeSubstitutor defined in org.jetbrains.kotlin.types.TypeConstructorSubstitution[DeserializedSimpleFunctionDescriptor]

'substitute' @ [197:53] ==> @Nullable public open fun substitute(@NotNull p0: KotlinType, @NotNull p1: Variance): KotlinType? defined in org.jetbrains.kotlin.types.TypeSubstitutor[JavaMethodDescriptor]
...
'addIfNotNull' @ [200:20] ==> public fun <T : Any> MutableCollection<KotlinType>.addIfNotNull(t: KotlinType?): Unit defined in org.jetbrains.kotlin.utils[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T : Any> -> KotlinType
...
'reportIncompleteHierarchy' @ [203:44] ==> public abstract fun reportIncompleteHierarchy(@NotNull p0: ClassDescriptor, @NotNull p1: (MutableList<(String..String?)>..List<(String..String?)>)): Unit defined in org.jetbrains.kotlin.serialization.deserialization.ErrorReporter[JavaMethodDescriptor]
...
'builtIns' @ [208:82] ==> public abstract val builtIns: KotlinBuiltIns defined in org.jetbrains.kotlin.descriptors.ModuleDescriptor[DeserializedPropertyDescriptor]
...
'startsWith' @ [213:42] ==> public open fun startsWith(@NotNull p0: Name): Boolean defined in org.jetbrains.kotlin.name.FqName[JavaMethodDescriptor]
...
'fqNameSafe' @ [218:86] ==> public val DeclarationDescriptor.fqNameSafe: FqName defined in org.jetbrains.kotlin.resolve.descriptorUtil[DeserializedPropertyDescriptor]
...
'resolveTopLevelClass' @ [221:44] ==> public fun ModuleDescriptor.resolveTopLevelClass(topLevelClassFqName: FqName, location: LookupLocation): ClassDescriptor? defined in org.jetbrains.kotlin.resolve.descriptorUtil[DeserializedSimpleFunctionDescriptor]
...
'TypeProjectionImpl' @ [231:25] ==> public constructor TypeProjectionImpl(@NotNull p0: Variance, @NotNull p1: KotlinType) defined in org.jetbrains.kotlin.types.TypeProjectionImpl[JavaClassConstructorDescriptor]
...
'TypeProjectionImpl' @ [235:37] ==> public constructor TypeProjectionImpl(@NotNull p0: Variance, @NotNull p1: KotlinType) defined in org.jetbrains.kotlin.types.TypeProjectionImpl[JavaClassConstructorDescriptor]
...
'KotlinTypeFactory' @ [241:20] ==> public object KotlinTypeFactory defined in org.jetbrains.kotlin.types[FakeCallableDescriptorForObject]

'simpleNotNullType' @ [241:38] ==> @JvmStatic public final fun simpleNotNullType(annotations: Annotations, descriptor: ClassDescriptor, arguments: List<TypeProjection>): SimpleType defined in org.jetbrains.kotlin.types.KotlinTypeFactory[DeserializedSimpleFunctionDescriptor]

'EMPTY' @ [241:68] ==> public final val EMPTY: Annotations defined in org.jetbrains.kotlin.descriptors.annotations.Annotations.Companion[DeserializedPropertyDescriptor]
...
'findAnnotation' @ [246:62] ==> public open fun findAnnotation(fqName: FqName): AnnotationDescriptor? defined in org.jetbrains.kotlin.descriptors.annotations.Annotations[DeserializedSimpleFunctionDescriptor]
...
'allValueArguments' @ [249:44] ==> public abstract val allValueArguments: Map<Name, ConstantValue<*>> defined in org.jetbrains.kotlin.descriptors.annotations.AnnotationDescriptor[DeserializedPropertyDescriptor]
...
'value' @ [249:102] ==> public open val value: String defined in org.jetbrains.kotlin.resolve.constants.StringValue[DeserializedPropertyDescriptor]

'!' @ [250:17] ==> public final operator fun not(): Boolean defined in kotlin.Boolean[DeserializedSimpleFunctionDescriptor]

'isValidJavaFqName' @ [250:18] ==> public fun isValidJavaFqName(qualifiedName: String?): Boolean defined in org.jetbrains.kotlin.name[DeserializedSimpleFunctionDescriptor]
...
'FqName' @ [252:20] ==> public constructor FqName(@NotNull p0: String) defined in org.jetbrains.kotlin.name.FqName[JavaClassConstructorDescriptor]
...
'isFinalClass' @ [258:43] ==> public val ClassDescriptor.isFinalClass: Boolean defined in org.jetbrains.kotlin.descriptors[DeserializedPropertyDescriptor]
