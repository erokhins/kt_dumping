...
'createLazyValue' @ [126:56] ==> public abstract fun <T : Any> createLazyValue(computable: () -> Map<Name, ConstantValue<Any?>>): NotNullLazyValue<Map<Name, ConstantValue<Any?>>> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
...
'createLazyValue' @ [140:56] ==> public abstract fun <T : Any> createLazyValue(computable: () -> Map<Name, ConstantValue<Any?>>): NotNullLazyValue<Map<Name, ConstantValue<Any?>>> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T : Any> -> Map<Name, ConstantValue<Any?>>
