...
'createNullableLazyValue' @ [257:38] ==> public abstract fun <T : Any> createNullableLazyValue(computable: () -> ConstantValue<*>?): NullableLazyValue<ConstantValue<*>> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T : Any> -> ConstantValue<*>
