'MemberScopeImpl' @ [50:74] ==> public constructor MemberScopeImpl() defined in org.jetbrains.kotlin.resolve.scopes.MemberScopeImpl[DeserializedClassConstructorDescriptor]
...
'createRecursionTolerantLazyValue' @ [55:51] ==> public abstract fun <T : Any> createRecursionTolerantLazyValue(computable: () -> Collection<DeclarationDescriptor>, onRecursiveCall: Collection<DeclarationDescriptor>): NotNullLazyValue<Collection<DeclarationDescriptor>> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
...
'ALL' @ [56:55] ==> @field:JvmField public final val ALL: DescriptorKindFilter defined in org.jetbrains.kotlin.resolve.scopes.DescriptorKindFilter.Companion[DeserializedPropertyDescriptor]
...
'ALL_NAME_FILTER' @ [56:72] ==> public final val ALL_NAME_FILTER: (Name) -> Boolean defined in org.jetbrains.kotlin.resolve.scopes.MemberScope.Companion[DeserializedPropertyDescriptor]
...
'createLazyValue' @ [64:97] ==> public abstract fun <T : Any> createLazyValue(computable: () -> DeclaredMemberIndex): NotNullLazyValue<DeclaredMemberIndex> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
...
'createMemoizedFunction' @ [73:46] ==> public abstract fun <K, V : Any> createMemoizedFunction(compute: (Name) -> Collection<SimpleFunctionDescriptor>): MemoizedFunctionToNotNull<Name, Collection<SimpleFunctionDescriptor>> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <K> -> Name
...
'retainMostSpecificInEachOverridableGroup' @ [85:16] ==> public fun <D : CallableDescriptor> MutableCollection<SimpleFunctionDescriptor>.retainMostSpecificInEachOverridableGroup(): Unit defined in org.jetbrains.kotlin.resolve[DeserializedSimpleFunctionDescriptor]
Inferred types:
...
'convertFromFlags' @ [131:26] ==> public final fun convertFromFlags(abstract: Boolean, open: Boolean): Modality defined in org.jetbrains.kotlin.descriptors.Modality.Companion[DeserializedSimpleFunctionDescriptor]
...
'builtIns' @ [174:45] ==> public abstract val builtIns: KotlinBuiltIns defined in org.jetbrains.kotlin.descriptors.ModuleDescriptor[DeserializedPropertyDescriptor]

'getArrayElementType' @ [174:54] ==> @NotNull public open fun getArrayElementType(@NotNull p0: KotlinType): KotlinType defined in org.jetbrains.kotlin.builtins.KotlinBuiltIns[JavaMethodDescriptor]
...
'builtIns' @ [182:37] ==> public abstract val builtIns: KotlinBuiltIns defined in org.jetbrains.kotlin.descriptors.ModuleDescriptor[DeserializedPropertyDescriptor]
...
'identifier' @ [187:22] ==> @NotNull public open fun identifier(@NotNull p0: String): Name defined in org.jetbrains.kotlin.name.Name[JavaMethodDescriptor]
...
'identifier' @ [193:34] ==> @NotNull public open fun identifier(@NotNull p0: String): Name defined in org.jetbrains.kotlin.name.Name[JavaMethodDescriptor]
...
'createLazyValue' @ [213:55] ==> public abstract fun <T : Any> createLazyValue(computable: () -> Set<Name>): NotNullLazyValue<Set<Name>> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T : Any> -> Set<Name>
...
'FUNCTIONS' @ [213:115] ==> @field:JvmField public final val FUNCTIONS: DescriptorKindFilter defined in org.jetbrains.kotlin.resolve.scopes.DescriptorKindFilter.Companion[DeserializedPropertyDescriptor]
...
'createLazyValue' @ [214:55] ==> public abstract fun <T : Any> createLazyValue(computable: () -> Set<Name>): NotNullLazyValue<Set<Name>> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T : Any> -> Set<Name>
...
'VARIABLES' @ [214:115] ==> @field:JvmField public final val VARIABLES: DescriptorKindFilter defined in org.jetbrains.kotlin.resolve.scopes.DescriptorKindFilter.Companion[DeserializedPropertyDescriptor]
...
'createMemoizedFunction' @ [230:47] ==> public abstract fun <K, V : Any> createMemoizedFunction(compute: (Name) -> List<PropertyDescriptor>): MemoizedFunctionToNotNull<Name, List<PropertyDescriptor>> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <K> -> Name
...
'isAnnotationClass' @ [241:29] ==> public open fun isAnnotationClass(@Nullable p0: DeclarationDescriptor?): Boolean defined in org.jetbrains.kotlin.resolve.DescriptorUtils[JavaMethodDescriptor]
...
'initialize' @ [249:28] ==> public open fun initialize(@Nullable p0: PropertyGetterDescriptorImpl?, @Nullable p1: PropertySetterDescriptor?): Unit defined in org.jetbrains.kotlin.descriptors.impl.PropertyDescriptorImpl[JavaMethodDescriptor]
...
'setType' @ [253:28] ==> public open fun setType(@NotNull p0: KotlinType, @ReadOnly @NotNull p1: List<(TypeParameterDescriptor..TypeParameterDescriptor?)>, @Nullable p2: ReceiverParameterDescriptor?, @Nullable p3: KotlinType?): Unit defined in org.jetbrains.kotlin.descriptors.impl.PropertyDescriptorImpl[JavaMethodDescriptor]
...
'shouldRecordInitializerForProperty' @ [255:29] ==> public open fun shouldRecordInitializerForProperty(@NotNull p0: VariableDescriptor, @NotNull p1: KotlinType): Boolean defined in org.jetbrains.kotlin.resolve.DescriptorUtils[JavaMethodDescriptor]
...
'setCompileTimeInitializer' @ [256:32] ==> public open fun setCompileTimeInitializer(@NotNull p0: NullableLazyValue<(ConstantValue<*>..ConstantValue<*>?)>): Unit defined in org.jetbrains.kotlin.descriptors.impl.PropertyDescriptorImpl[JavaMethodDescriptor]
...
'createNullableLazyValue' @ [257:38] ==> public abstract fun <T : Any> createNullableLazyValue(computable: () -> ConstantValue<Any?>?): NullableLazyValue<ConstantValue<Any?>> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
...
'makeNotNullable' @ [289:30] ==> @NotNull public open fun makeNotNullable(@NotNull p0: KotlinType): KotlinType defined in org.jetbrains.kotlin.types.TypeUtils[JavaMethodDescriptor]
...
'acceptsKinds' @ [309:24] ==> public final fun acceptsKinds(kinds: Int): Boolean defined in org.jetbrains.kotlin.resolve.scopes.DescriptorKindFilter[DeserializedSimpleFunctionDescriptor]
...
'CLASSIFIERS_MASK' @ [309:58] ==> public final val CLASSIFIERS_MASK: Int defined in org.jetbrains.kotlin.resolve.scopes.DescriptorKindFilter.Companion[DeserializedPropertyDescriptor]
...
'addIfNotNull' @ [313:28] ==> public fun <T : Any> MutableCollection<DeclarationDescriptor>.addIfNotNull(t: DeclarationDescriptor?): Unit defined in org.jetbrains.kotlin.utils[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T : Any> -> DeclarationDescriptor

'getContributedClassifier' @ [313:41] ==> public open fun getContributedClassifier(name: Name, location: LookupLocation): ClassifierDescriptor? defined in org.jetbrains.kotlin.load.java.lazy.descriptors.LazyJavaScope[DeserializedSimpleFunctionDescriptor]
...
'acceptsKinds' @ [318:24] ==> public final fun acceptsKinds(kinds: Int): Boolean defined in org.jetbrains.kotlin.resolve.scopes.DescriptorKindFilter[DeserializedSimpleFunctionDescriptor]
...
'FUNCTIONS_MASK' @ [318:58] ==> public final val FUNCTIONS_MASK: Int defined in org.jetbrains.kotlin.resolve.scopes.DescriptorKindFilter.Companion[DeserializedPropertyDescriptor]
...
'excludes' @ [318:89] ==> public final val excludes: List<DescriptorKindExclude> defined in org.jetbrains.kotlin.resolve.scopes.DescriptorKindFilter[DeserializedPropertyDescriptor]
...
'acceptsKinds' @ [326:24] ==> public final fun acceptsKinds(kinds: Int): Boolean defined in org.jetbrains.kotlin.resolve.scopes.DescriptorKindFilter[DeserializedSimpleFunctionDescriptor]
...
'VARIABLES_MASK' @ [326:58] ==> public final val VARIABLES_MASK: Int defined in org.jetbrains.kotlin.resolve.scopes.DescriptorKindFilter.Companion[DeserializedPropertyDescriptor]
...
'excludes' @ [326:89] ==> public final val excludes: List<DescriptorKindExclude> defined in org.jetbrains.kotlin.resolve.scopes.DescriptorKindFilter[DeserializedPropertyDescriptor]
...
'println' @ [342:11] ==> @NotNull public open fun println(vararg p0: (Any..Any?)): Printer defined in org.jetbrains.kotlin.utils.Printer[JavaMethodDescriptor]
...
'println' @ [345:11] ==> @NotNull public open fun println(vararg p0: (Any..Any?)): Printer defined in org.jetbrains.kotlin.utils.Printer[JavaMethodDescriptor]
...
'println' @ [348:11] ==> @NotNull public open fun println(vararg p0: (Any..Any?)): Printer defined in org.jetbrains.kotlin.utils.Printer[JavaMethodDescriptor]
