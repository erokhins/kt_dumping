...
'createLazyValue' @ [36:79] ==> public abstract fun <T : Any> createLazyValue(computable: () -> List<PackageFragmentDescriptor>): NotNullLazyValue<List<PackageFragmentDescriptor>> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
...
'createLazyValue' @ [40:77] ==> public abstract fun <T : Any> createLazyValue(computable: () -> MemberScope): NotNullLazyValue<MemberScope> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T : Any> -> MemberScope
