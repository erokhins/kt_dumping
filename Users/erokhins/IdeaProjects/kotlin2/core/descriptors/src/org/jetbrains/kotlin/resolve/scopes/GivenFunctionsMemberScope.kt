...
'createLazyValue' @ [37:50] ==> public abstract fun <T : Any> createLazyValue(computable: () -> List<DeclarationDescriptor>): NotNullLazyValue<List<DeclarationDescriptor>> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
...
'DescriptorKindFilter' @ [45:38] ==> public companion object defined in org.jetbrains.kotlin.resolve.scopes.DescriptorKindFilter[FakeCallableDescriptorForObject]
...
'compact' @ [83:23] ==> public fun <T> ArrayList<DeclarationDescriptor>.compact(): List<DeclarationDescriptor> defined in org.jetbrains.kotlin.utils[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T> -> DeclarationDescriptor
