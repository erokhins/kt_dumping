...
'createMemoizedFunctionWithNullableValues' @ [33:44] ==> public abstract fun <K, V : Any> createMemoizedFunctionWithNullableValues(compute: (FqName) -> PackageFragmentDescriptor?): MemoizedFunctionToNullable<FqName, PackageFragmentDescriptor> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <K> -> FqName
