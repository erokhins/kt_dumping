...
'ifEmpty' @ [23:26] ==> public inline fun <T, C : Collection<(ProtoBuf.Type..ProtoBuf.Type?)>> List<ProtoBuf.Type>.ifEmpty(body: () -> List<ProtoBuf.Type>): List<ProtoBuf.Type> defined in org.jetbrains.kotlin.utils[DeserializedSimpleFunctionDescriptor]
Inferred types:
...
'ifEmpty' @ [43:27] ==> public inline fun <T, C : Collection<(ProtoBuf.Type..ProtoBuf.Type?)>> List<ProtoBuf.Type>.ifEmpty(body: () -> List<ProtoBuf.Type>): List<ProtoBuf.Type> defined in org.jetbrains.kotlin.utils[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T> -> (org.jetbrains.kotlin.serialization.ProtoBuf.Type..org.jetbrains.kotlin.serialization.ProtoBuf.Type?)
    <C : Collection<T>> -> List<Type>
