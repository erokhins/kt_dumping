...
'createMemoizedFunctionWithNullableValues' @ [28:39] ==> public abstract fun <K, V : Any> createMemoizedFunctionWithNullableValues(compute: (ClassDeserializer.ClassKey) -> ClassDescriptor?): MemoizedFunctionToNullable<ClassDeserializer.ClassKey, ClassDescriptor> defined in org.jetbrains.kotlin.storage.StorageManager[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <K> -> ClassKey
...
'createClass' @ [38:21] ==> public abstract fun createClass(classId: ClassId): ClassDescriptor? defined in org.jetbrains.kotlin.descriptors.deserialization.ClassDescriptorFactory[DeserializedSimpleFunctionDescriptor]
...
'getPackageFragments' @ [57:64] ==> public abstract fun getPackageFragments(fqName: FqName): List<PackageFragmentDescriptor> defined in org.jetbrains.kotlin.descriptors.PackageFragmentProvider[DeserializedSimpleFunctionDescriptor]
...
'hashCode' @ [81:43] ==> public open fun hashCode(): Int defined in org.jetbrains.kotlin.name.ClassId[JavaMethodDescriptor]
...
'topLevel' @ [92:25] ==> @NotNull public open fun topLevel(@NotNull p0: FqName): ClassId defined in org.jetbrains.kotlin.name.ClassId[JavaMethodDescriptor]
