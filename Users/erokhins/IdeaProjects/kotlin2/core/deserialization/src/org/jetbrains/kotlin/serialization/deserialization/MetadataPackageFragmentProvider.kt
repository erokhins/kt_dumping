...
'findMetadataPackageParts' @ [91:48] ==> public abstract fun findMetadataPackageParts(packageFqName: String): List<String> defined in org.jetbrains.kotlin.descriptors.PackagePartProvider[DeserializedSimpleFunctionDescriptor]

'fqName' @ [91:73] ==> public final val fqName: FqName defined in org.jetbrains.kotlin.serialization.deserialization.MetadataPackageFragment[DeserializedPropertyDescriptor]
...
'ClassId' @ [94:46] ==> public constructor ClassId(@NotNull p0: FqName, @NotNull p1: Name) defined in org.jetbrains.kotlin.name.ClassId[JavaClassConstructorDescriptor]

'fqName' @ [94:54] ==> public final val fqName: FqName defined in org.jetbrains.kotlin.serialization.deserialization.MetadataPackageFragment[DeserializedPropertyDescriptor]

'identifier' @ [94:67] ==> @NotNull public open fun identifier(@NotNull p0: String): Name defined in org.jetbrains.kotlin.name.Name[JavaMethodDescriptor]
...
'create' @ [111:35] ==> public final fun create(debugName: String, scopes: List<MemberScope>): MemberScope defined in org.jetbrains.kotlin.resolve.scopes.ChainedMemberScope.Companion[DeserializedSimpleFunctionDescriptor]
...
'readFrom' @ [120:45] ==> public final fun readFrom(stream: InputStream): BuiltInsBinaryVersion defined in org.jetbrains.kotlin.builtins.BuiltInsBinaryVersion.Companion[DeserializedSimpleFunctionDescriptor]
...
'isCompatible' @ [122:22] ==> public open fun isCompatible(): Boolean defined in org.jetbrains.kotlin.builtins.BuiltInsBinaryVersion[DeserializedSimpleFunctionDescriptor]
...
'INSTANCE' @ [126:55] ==> @field:JvmField public final val INSTANCE: BuiltInsBinaryVersion defined in org.jetbrains.kotlin.builtins.BuiltInsBinaryVersion.Companion[DeserializedPropertyDescriptor]
