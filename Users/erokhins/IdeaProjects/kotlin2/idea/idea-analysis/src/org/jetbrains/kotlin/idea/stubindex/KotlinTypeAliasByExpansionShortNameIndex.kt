'StringStubIndexExtension<KtTypeAlias>' @ [26:50] ==> public constructor StringStubIndexExtension<Psi : (PsiElement..PsiElement?)>() defined in com.intellij.psi.stubs.StringStubIndexExtension[JavaClassConstructorDescriptor]
Inferred types:
...
'key' @ [30:40] ==> value-parameter key: String defined in org.jetbrains.kotlin.idea.stubindex.KotlinTypeAliasByExpansionShortNameIndex.get[ValueParameterDescriptorImpl]

'project' @ [30:45] ==> value-parameter project: Project defined in org.jetbrains.kotlin.idea.stubindex.KotlinTypeAliasByExpansionShortNameIndex.get[ValueParameterDescriptorImpl]

'scope' @ [30:54] ==> value-parameter scope: GlobalSearchScope defined in org.jetbrains.kotlin.idea.stubindex.KotlinTypeAliasByExpansionShortNameIndex.get[ValueParameterDescriptorImpl]

'java' @ [30:80] ==> public val <T> KClass<KtTypeAlias>.java: Class<KtTypeAlias> defined in kotlin.jvm[DeserializedPropertyDescriptor]
Inferred types:
    <T> -> KtTypeAlias
...
'java' @ [33:98] ==> public val <T> KClass<KotlinTypeAliasByExpansionShortNameIndex>.java: Class<KotlinTypeAliasByExpansionShortNameIndex> defined in kotlin.jvm[DeserializedPropertyDescriptor]
Inferred types:
    <T> -> KotlinTypeAliasByExpansionShortNameIndex

'KotlinTypeAliasByExpansionShortNameIndex' @ [34:24] ==> public constructor KotlinTypeAliasByExpansionShortNameIndex() defined in org.jetbrains.kotlin.idea.stubindex.KotlinTypeAliasByExpansionShortNameIndex[ClassConstructorDescriptorImpl]

'JvmStatic' @ [36:9] ==> public constructor JvmStatic() defined in kotlin.jvm.JvmStatic[DeserializedClassConstructorDescriptor]

'INSTANCE' @ [36:40] ==> public final val INSTANCE: KotlinTypeAliasByExpansionShortNameIndex defined in org.jetbrains.kotlin.idea.stubindex.KotlinTypeAliasByExpansionShortNameIndex.Companion[PropertyDescriptorImpl]
