...
'getContainingKtFile' @ [144:44] ==> @NotNull public abstract fun getContainingKtFile(): KtFile defined in org.jetbrains.kotlin.psi.KtElement[JavaMethodDescriptor]
...
'listOf' @ [172:60] ==> public fun <T> listOf(vararg elements: ShortenReferences.ShorteningProcessor<*>): List<ShortenReferences.ShorteningProcessor<*>> defined in kotlin.collections[DeserializedSimpleFunctionDescriptor]
Inferred types:
