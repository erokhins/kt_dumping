...
'LIBRARY_DEPENDENCY' @ [34:104] ==> @NotNull public final val LIBRARY_DEPENDENCY: Key<(LibraryDependencyData..LibraryDependencyData?)> defined in com.intellij.openapi.externalSystem.model.ProjectKeys[JavaPropertyDescriptor]

'libraryIds' @ [35:31] ==> value-parameter libraryIds: List<String> defined in org.jetbrains.kotlin.idea.inspections.gradle.DefaultPlatformGradleDetector.getResolvedKotlinStdlibVersionByModuleData[ValueParameterDescriptorImpl]

'libraryId' @ [36:64] ==> val libraryId: String defined in org.jetbrains.kotlin.idea.inspections.gradle.DefaultPlatformGradleDetector.getResolvedKotlinStdlibVersionByModuleData[LocalVariableDescriptor]
...
'externalName' @ [37:48] ==> public final var LibraryDependencyData.externalName: String[MyPropertyDescriptor]

'startsWith' @ [37:61] ==> public fun String.startsWith(prefix: String, ignoreCase: Boolean = ...): Boolean defined in kotlin.text[DeserializedSimpleFunctionDescriptor]

'libraryNameMarker' @ [37:72] ==> val libraryNameMarker: String defined in org.jetbrains.kotlin.idea.inspections.gradle.DefaultPlatformGradleDetector.getResolvedKotlinStdlibVersionByModuleData[LocalVariableDescriptor]
...
'externalName' @ [38:55] ==> public final var LibraryDependencyData.externalName: String[MyPropertyDescriptor]

'substringAfter' @ [38:68] ==> public fun String.substringAfter(delimiter: String, missingDelimiterValue: String = ...): String defined in kotlin.text[DeserializedSimpleFunctionDescriptor]

'libraryNameMarker' @ [38:83] ==> val libraryNameMarker: String defined in org.jetbrains.kotlin.idea.inspections.gradle.DefaultPlatformGradleDetector.getResolvedKotlinStdlibVersionByModuleData[LocalVariableDescriptor]
