...
'getParentOfType' @ [61:42] ==> @SafeVarargs @Nullable @Contract public open fun <T : (PsiElement..PsiElement?)> getParentOfType(@Nullable p0: PsiElement?, @NotNull vararg p1: (Class<out (KtElement..KtElement?)>..Class<out (KtElement..KtElement?)>?)): KtElement? defined in com.intellij.psi.util.PsiTreeUtil[JavaMethodDescriptor]
Inferred types:
...
'when (annotationList) {
        ...
        }' @ [62:26] ==> public final fun <`<TYPE-PARAMETER-FOR-WHEN-RESOLVE>`> `<SPECIAL-FUNCTION-FOR-WHEN-RESOLVE>`(entry0: Any, entry1: Any, entry2: Any): Any[SimpleFunctionDescriptorImpl]
Inferred types:
    <`<TYPE-PARAMETER-FOR-WHEN-RESOLVE>`> -> Any

'annotationList' @ [62:32] ==> val annotationList: KtElement? defined in org.jetbrains.kotlin.idea.refactoring.rename.RenameJvmNameHandler.wrapDataContext[LocalVariableDescriptor]

'?:' @ [64:17] ==> public final fun <`<TYPE-PARAMETER-FOR-ELVIS-RESOLVE>`> `<SPECIAL-FUNCTION-FOR-ELVIS-RESOLVE>`(left: Any?, right: Any): Any[SimpleFunctionDescriptorImpl]
Inferred types:
    <`<TYPE-PARAMETER-FOR-ELVIS-RESOLVE>`> -> Any

'annotationList' @ [64:18] ==> val annotationList: KtElement? defined in org.jetbrains.kotlin.idea.refactoring.rename.RenameJvmNameHandler.wrapDataContext[LocalVariableDescriptor]
...
'annotationList' @ [66:40] ==> val annotationList: KtElement? defined in org.jetbrains.kotlin.idea.refactoring.rename.RenameJvmNameHandler.wrapDataContext[LocalVariableDescriptor]

'getContainingKtFile' @ [66:55] ==> @NotNull public abstract fun getContainingKtFile(): KtFile defined in org.jetbrains.kotlin.psi.KtElement[JavaMethodDescriptor]
...
'DataContext' @ [70:16] ==> public fun DataContext(function: ((String..String?)) -> Any?): DataContext defined in com.intellij.openapi.actionSystem[SamConstructorDescriptorImpl]
...
'newElement' @ [71:73] ==> val newElement: Any defined in org.jetbrains.kotlin.idea.refactoring.rename.RenameJvmNameHandler.wrapDataContext[LocalVariableDescriptor]
