'SurroundPostfixTemplateBase' @ [30:49] ==> protected/*protected and package*/ constructor SurroundPostfixTemplateBase(@NotNull p0: String, @NotNull p1: String, @NotNull p2: PostfixTemplatePsiInfo, @NotNull p3: PostfixTemplateExpressionSelector) defined in com.intellij.codeInsight.template.postfix.templates.SurroundPostfixTemplateBase[JavaClassConstructorDescriptor]
...
'isBoolean' @ [32:65] ==> public fun KotlinType.isBoolean(): Boolean defined in org.jetbrains.kotlin.types.typeUtil[DeserializedSimpleFunctionDescriptor]

'KotlinWithIfExpressionSurrounder' @ [34:36] ==> public constructor KotlinWithIfExpressionSurrounder(withElse: Boolean) defined in org.jetbrains.kotlin.idea.codeInsight.surroundWith.expression.KotlinWithIfExpressionSurrounder[ClassConstructorDescriptorImpl]

'SurroundPostfixTemplateBase' @ [37:51] ==> protected/*protected and package*/ constructor SurroundPostfixTemplateBase(@NotNull p0: String, @NotNull p1: String, @NotNull p2: PostfixTemplatePsiInfo, @NotNull p3: PostfixTemplateExpressionSelector) defined in com.intellij.codeInsight.template.postfix.templates.SurroundPostfixTemplateBase[JavaClassConstructorDescriptor]
...
'isBoolean' @ [39:65] ==> public fun KotlinType.isBoolean(): Boolean defined in org.jetbrains.kotlin.types.typeUtil[DeserializedSimpleFunctionDescriptor]

'KotlinWithIfExpressionSurrounder' @ [41:36] ==> public constructor KotlinWithIfExpressionSurrounder(withElse: Boolean) defined in org.jetbrains.kotlin.idea.codeInsight.surroundWith.expression.KotlinWithIfExpressionSurrounder[ClassConstructorDescriptorImpl]

'expression' @ [42:67] ==> value-parameter expression: PsiElement? defined in org.jetbrains.kotlin.idea.codeInsight.postfix.KtElseExpressionPostfixTemplate.getWrappedExpression[ValueParameterDescriptorImpl]

'negate' @ [42:95] ==> public fun KtExpression.negate(): KtExpression defined in org.jetbrains.kotlin.idea.intentions in file Utils.kt[SimpleFunctionDescriptorImpl]

'SurroundPostfixTemplateBase' @ [45:61] ==> protected/*protected and package*/ constructor SurroundPostfixTemplateBase(@NotNull p0: String, @NotNull p1: String, @NotNull p2: PostfixTemplatePsiInfo, @NotNull p3: PostfixTemplateExpressionSelector) defined in com.intellij.codeInsight.template.postfix.templates.SurroundPostfixTemplateBase[JavaClassConstructorDescriptor]

'name' @ [46:9] ==> value-parameter name: String defined in org.jetbrains.kotlin.idea.codeInsight.postfix.KtNotNullPostfixTemplate.<init>[ValueParameterDescriptorImpl]
...
'SurroundPostfixTemplateBase' @ [53:43] ==> protected/*protected and package*/ constructor SurroundPostfixTemplateBase(@NotNull p0: String, @NotNull p1: String, @NotNull p2: PostfixTemplatePsiInfo, @NotNull p3: PostfixTemplateExpressionSelector) defined in com.intellij.codeInsight.template.postfix.templates.SurroundPostfixTemplateBase[JavaClassConstructorDescriptor]
...
'SurroundPostfixTemplateBase' @ [61:51] ==> protected/*protected and package*/ constructor SurroundPostfixTemplateBase(@NotNull p0: String, @NotNull p1: String, @NotNull p2: PostfixTemplatePsiInfo, @NotNull p3: PostfixTemplateExpressionSelector) defined in com.intellij.codeInsight.template.postfix.templates.SurroundPostfixTemplateBase[JavaClassConstructorDescriptor]
...
'SurroundPostfixTemplateBase' @ [68:40] ==> protected/*protected and package*/ constructor SurroundPostfixTemplateBase(@NotNull p0: String, @NotNull p1: String, @NotNull p2: PostfixTemplatePsiInfo, @NotNull p3: PostfixTemplateExpressionSelector) defined in com.intellij.codeInsight.template.postfix.templates.SurroundPostfixTemplateBase[JavaClassConstructorDescriptor]
