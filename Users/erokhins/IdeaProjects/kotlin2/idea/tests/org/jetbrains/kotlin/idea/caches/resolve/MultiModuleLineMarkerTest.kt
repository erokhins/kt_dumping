'AbstractMultiModuleHighlightingTest' @ [23:35] ==> public constructor AbstractMultiModuleHighlightingTest() defined in org.jetbrains.kotlin.idea.caches.resolve.AbstractMultiModuleHighlightingTest[ClassConstructorDescriptorImpl]

'+' @ [25:38] ==> public final operator fun plus(other: Any?): String defined in kotlin.String[DeserializedSimpleFunctionDescriptor]

'getTestDataPathBase' @ [25:57] ==> @NotNull public open fun getTestDataPathBase(): String defined in org.jetbrains.kotlin.idea.test.PluginTestCaseBase[JavaMethodDescriptor]

'doMultiPlatformTest' @ [34:9] ==> protected final fun doMultiPlatformTest(vararg platforms: TargetPlatformKind<*>, withStdlibCommon: Boolean, configureModule: (Module, TargetPlatformKind<*>) -> Unit, jdk: TestJdkKind): Unit defined in org.jetbrains.kotlin.idea.caches.resolve.MultiModuleLineMarkerTest[SimpleFunctionDescriptorImpl]

'TargetPlatformKind' @ [34:29] ==> public companion object defined in org.jetbrains.kotlin.config.TargetPlatformKind[FakeCallableDescriptorForObject]
...
'doMultiPlatformTest' @ [42:9] ==> protected final fun doMultiPlatformTest(vararg platforms: TargetPlatformKind<*>, withStdlibCommon: Boolean, configureModule: (Module, TargetPlatformKind<*>) -> Unit, jdk: TestJdkKind): Unit defined in org.jetbrains.kotlin.idea.caches.resolve.MultiModuleLineMarkerTest[SimpleFunctionDescriptorImpl]

'TargetPlatformKind' @ [42:29] ==> public companion object defined in org.jetbrains.kotlin.config.TargetPlatformKind[FakeCallableDescriptorForObject]
...
'doMultiPlatformTest' @ [50:9] ==> protected final fun doMultiPlatformTest(vararg platforms: TargetPlatformKind<*>, withStdlibCommon: Boolean, configureModule: (Module, TargetPlatformKind<*>) -> Unit, jdk: TestJdkKind): Unit defined in org.jetbrains.kotlin.idea.caches.resolve.MultiModuleLineMarkerTest[SimpleFunctionDescriptorImpl]

'TargetPlatformKind' @ [50:29] ==> public companion object defined in org.jetbrains.kotlin.config.TargetPlatformKind[FakeCallableDescriptorForObject]
