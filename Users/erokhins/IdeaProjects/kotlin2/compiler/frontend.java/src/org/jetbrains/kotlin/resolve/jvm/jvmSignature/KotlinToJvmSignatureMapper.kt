...
'substring' @ [29:56] ==> @InlineOnly public inline fun String.substring(startIndex: Int, endIndex: Int): String defined in kotlin.text[DeserializedSimpleFunctionDescriptor]

'descriptor' @ [29:69] ==> public final val Method.descriptor: (String..String?)[MyPropertyDescriptor]

'lastIndexOf' @ [29:80] ==> public fun CharSequence.lastIndexOf(string: String, startIndex: Int = ..., ignoreCase: Boolean = ...): Int defined in kotlin.text[DeserializedSimpleFunctionDescriptor]
