...
'JvmBindingContextSlices' @ [34:48] ==> public object JvmBindingContextSlices defined in org.jetbrains.kotlin.resolve.jvm in file JvmBindingContextSlices.kt[FakeCallableDescriptorForObject]

'java' @ [34:79] ==> public val <T> KClass<JvmBindingContextSlices>.java: Class<JvmBindingContextSlices> defined in kotlin.jvm[DeserializedPropertyDescriptor]
Inferred types:
    <T> -> JvmBindingContextSlices
