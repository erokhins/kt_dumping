'JvmField' @ [26:9] ==> public constructor JvmField() defined in kotlin.jvm.JvmField[DeserializedClassConstructorDescriptor]

'create' @ [27:23] ==> @NotNull public open fun <T : (Any..Any?)> create(@NotNull @NonNls p0: String): Key<(MemberIndex..MemberIndex?)> defined in com.intellij.openapi.util.Key[JavaMethodDescriptor]
Inferred types:
    <T : (Any..Any?)> -> MemberIndex

'this' @ [32:15] ==> <this> defined in org.jetbrains.kotlin.asJava.builder.memberIndex[ReceiverParameterDescriptorImpl]
