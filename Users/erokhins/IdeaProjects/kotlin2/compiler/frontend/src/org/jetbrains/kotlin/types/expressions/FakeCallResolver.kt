...
'fakeBindingTrace' @ [59:64] ==> val fakeBindingTrace: (ResolutionContext<out (ResolutionContext<out (ResolutionContext<out (ResolutionContext<out (ResolutionContext<out Any?>..ResolutionContext<out Any?>?)>..ResolutionContext<out (ResolutionContext<out Any?>..ResolutionContext<out Any?>?)>?)>..ResolutionContext<out (ResolutionContext<out (ResolutionContext<out Any?>..ResolutionContext<out Any?>?)>..ResolutionContext<out (ResolutionContext<out Any?>..ResolutionContext<out Any?>?)>?)>?)>..ResolutionContext<out (ResolutionContext<out (ResolutionContext<out (ResolutionContext<out Any?>..ResolutionContext<out Any?>?)>..ResolutionContext<out (ResolutionContext<out Any?>..ResolutionContext<out Any?>?)>?)>..ResolutionContext<out (ResolutionContext<out (ResolutionContext<out Any?>..ResolutionContext<out Any?>?)>..ResolutionContext<out (ResolutionContext<out Any?>..ResolutionContext<out Any?>?)>?)>?)>?)>..ResolutionContext<out (ResolutionContext<out (ResolutionContext<out (ResolutionContext<out (ResolutionContext<out Any?>..ResolutionContext<out Any?>?)>..ResolutionContext<out (ResolutionContext<out Any?>..ResolutionContext<out Any?>?)>?)>..ResolutionContext<out (ResolutionContext<out (ResolutionContext<out Any?>..ResolutionContext<out Any?>?)>..ResolutionContext<out (ResolutionContext<out Any?>..ResolutionContext<out Any?>?)>?)>?)>..ResolutionContext<out (ResolutionContext<out (ResolutionContext<out (ResolutionContext<out Any?>..ResolutionContext<out Any?>?)>..ResolutionContext<out (ResolutionContext<out Any?>..ResolutionContext<out Any?>?)>?)>..ResolutionContext<out (ResolutionContext<out (ResolutionContext<out Any?>..ResolutionContext<out Any?>?)>..ResolutionContext<out (ResolutionContext<out Any?>..ResolutionContext<out Any?>?)>?)>?)>?)>?) defined in org.jetbrains.kotlin.types.expressions.FakeCallResolver.resolveFakeCall[LocalVariableDescriptor]
