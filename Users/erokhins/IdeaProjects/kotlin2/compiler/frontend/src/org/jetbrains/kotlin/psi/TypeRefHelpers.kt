...
'siblings' @ [29:37] ==> public fun PsiElement.siblings(forward: Boolean = ..., withItself: Boolean = ...): Sequence<PsiElement> defined in org.jetbrains.kotlin.psi.psiUtil[SimpleFunctionDescriptorImpl]
...
'siblings' @ [42:57] ==> public fun PsiElement.siblings(forward: Boolean = ..., withItself: Boolean = ...): Sequence<PsiElement> defined in org.jetbrains.kotlin.psi.psiUtil[SimpleFunctionDescriptorImpl]
...
'dotSibling' @ [86:23] ==> val dotSibling: KtElementImplStub<out (KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>..KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>..KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>?)>?)>..KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>..KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>..KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>?)>?)>?)> defined in org.jetbrains.kotlin.psi.typeRefHelpers.doSetReceiverTypeReference[LocalVariableDescriptor]

'siblings' @ [86:34] ==> public fun PsiElement.siblings(forward: Boolean = ..., withItself: Boolean = ...): Sequence<PsiElement> defined in org.jetbrains.kotlin.psi.psiUtil[SimpleFunctionDescriptorImpl]
...
'dotSibling' @ [87:30] ==> val dotSibling: KtElementImplStub<out (KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>..KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>..KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>?)>?)>..KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>..KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>..KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>?)>?)>?)> defined in org.jetbrains.kotlin.psi.typeRefHelpers.doSetReceiverTypeReference[LocalVariableDescriptor]
...
'dotSibling' @ [87:49] ==> val dotSibling: KtElementImplStub<out (KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>..KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>..KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>?)>?)>..KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>..KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>..KotlinPlaceHolderStub<out (KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>..KtElementImplStub<out (KotlinPlaceHolderStub<*>..KotlinPlaceHolderStub<*>?)>?)>?)>?)>?)> defined in org.jetbrains.kotlin.psi.typeRefHelpers.doSetReceiverTypeReference[LocalVariableDescriptor]
