...
'initializeBlockInfo' @ [68:13] ==> public fun initializeBlockInfo(blockExpression: KtBlockExpression, trace: BindingTrace): NewInferenceLastBlockExpressionHelper.AdditionalBlockInfo defined in org.jetbrains.kotlin.resolve.calls.tower in file NewInferenceLastBlockExpressionHelper.kt[SimpleFunctionDescriptorImpl]
...
'replaceContextDependency' @ [75:38] ==> @NotNull public open fun replaceContextDependency(@NotNull newContextDependency: ContextDependency): (ResolutionContext<*>..ResolutionContext<*>?) defined in org.jetbrains.kotlin.resolve.calls.context.ResolutionContext[JavaMethodDescriptor]
...
'replaceExpectedType' @ [75:82] ==> @NotNull public open fun replaceExpectedType(@Nullable newExpectedType: KotlinType?): (ResolutionContext<*>..ResolutionContext<*>?) defined in org.jetbrains.kotlin.resolve.calls.context.ResolutionContext[JavaMethodDescriptor]
...
'replaceBindingTrace' @ [75:128] ==> @NotNull public open fun replaceBindingTrace(@NotNull trace: BindingTrace): (ResolutionContext<*>..ResolutionContext<*>?) defined in org.jetbrains.kotlin.resolve.calls.context.ResolutionContext[JavaMethodDescriptor]
...
'newContext' @ [77:69] ==> val newContext: (ResolutionContext<*>..ResolutionContext<*>?) defined in org.jetbrains.kotlin.resolve.calls.tower.KotlinResolutionCallbacksImpl.analyzeAndGetLambdaResultArguments.createCallArgument[LocalVariableDescriptor]
...
'newContext' @ [79:59] ==> val newContext: (ResolutionContext<*>..ResolutionContext<*>?) defined in org.jetbrains.kotlin.resolve.calls.tower.KotlinResolutionCallbacksImpl.analyzeAndGetLambdaResultArguments.createCallArgument[LocalVariableDescriptor]
...
'replaceBindingTrace' @ [90:18] ==> @NotNull public open fun replaceBindingTrace(@NotNull trace: BindingTrace): (ResolutionContext<*>..ResolutionContext<*>?) defined in org.jetbrains.kotlin.resolve.calls.context.ResolutionContext[JavaMethodDescriptor]
...
'replaceContextDependency' @ [91:18] ==> @NotNull public open fun replaceContextDependency(@NotNull newContextDependency: ContextDependency): (ResolutionContext<*>..ResolutionContext<*>?) defined in org.jetbrains.kotlin.resolve.calls.context.ResolutionContext[JavaMethodDescriptor]
...
'replaceExpectedType' @ [92:18] ==> @NotNull public open fun replaceExpectedType(@Nullable newExpectedType: KotlinType?): (ResolutionContext<*>..ResolutionContext<*>?) defined in org.jetbrains.kotlin.resolve.calls.context.ResolutionContext[JavaMethodDescriptor]
...
'replaceDataFlowInfo' @ [93:18] ==> @NotNull public open fun replaceDataFlowInfo(@NotNull newDataFlowInfo: DataFlowInfo): (ResolutionContext<*>..ResolutionContext<*>?) defined in org.jetbrains.kotlin.resolve.calls.context.ResolutionContext[JavaMethodDescriptor]
...
'actualContext' @ [96:74] ==> val actualContext: (ResolutionContext<*>..ResolutionContext<*>?) defined in org.jetbrains.kotlin.resolve.calls.tower.KotlinResolutionCallbacksImpl.analyzeAndGetLambdaResultArguments[LocalVariableDescriptor]
...
'lastExpressionContext' @ [116:52] ==> val lastExpressionContext: ResolutionContext<*> defined in org.jetbrains.kotlin.resolve.calls.tower.KotlinResolutionCallbacksImpl.analyzeAndGetLambdaResultArguments[LocalVariableDescriptor]
