'KtExpressionImpl' @ [24:54] ==> public constructor KtExpressionImpl(node: ASTNode) defined in org.jetbrains.kotlin.psi.KtExpressionImpl[ClassConstructorDescriptorImpl]

'node' @ [24:71] ==> value-parameter node: ASTNode defined in org.jetbrains.kotlin.psi.KtCollectionLiteralExpression.<init>[ValueParameterDescriptorImpl]

'visitor' @ [26:16] ==> value-parameter visitor: KtVisitor<R, D> defined in org.jetbrains.kotlin.psi.KtCollectionLiteralExpression.accept[ValueParameterDescriptorImpl]

'visitCollectionLiteralExpression' @ [26:24] ==> public open fun visitCollectionLiteralExpression(@NotNull expression: KtCollectionLiteralExpression, data: (D..D?)): (R..R?) defined in org.jetbrains.kotlin.psi.KtVisitor[JavaMethodDescriptor]

'this' @ [26:57] ==> <this> defined in org.jetbrains.kotlin.psi.KtCollectionLiteralExpression[LazyClassReceiverParameterDescriptor]

'data' @ [26:63] ==> value-parameter data: D defined in org.jetbrains.kotlin.psi.KtCollectionLiteralExpression.accept[ValueParameterDescriptorImpl]
...
'java' @ [36:78] ==> public val <T> KClass<KtExpression>.java: Class<KtExpression> defined in kotlin.jvm[DeserializedPropertyDescriptor]
Inferred types:
    <T> -> KtExpression
