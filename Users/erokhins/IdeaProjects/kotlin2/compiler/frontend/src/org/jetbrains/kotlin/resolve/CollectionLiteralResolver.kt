...
Inferred types:
    <K : (Any..Any?)> -> (org.jetbrains.kotlin.psi.KtCollectionLiteralExpression..org.jetbrains.kotlin.psi.KtCollectionLiteralExpression?)
...
'resultingDescriptor' @ [91:49] ==> public final val <D : (CallableDescriptor..CallableDescriptor?)> OverloadResolutionResults<(FunctionDescriptor..FunctionDescriptor?)>.resultingDescriptor: FunctionDescriptor[MyPropertyDescriptor]
Inferred types:
    <D : (CallableDescriptor..CallableDescriptor?)> -> (org.jetbrains.kotlin.descriptors.FunctionDescriptor..org.jetbrains.kotlin.descriptors.FunctionDescriptor?)
...
'getParentOfType' @ [110:34] ==> @SafeVarargs @Nullable @Contract public open fun <T : (PsiElement..PsiElement?)> getParentOfType(@Nullable p0: PsiElement?, @NotNull vararg p1: (Class<out (KtElementImplStub<out (StubElement<out (KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>..KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>?)>..StubElement<out (KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>..KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>?)>?)>..KtElementImplStub<out (StubElement<out (KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>..KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>?)>..StubElement<out (KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>..KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>?)>?)>?)>..Class<out (KtElementImplStub<out (StubElement<out (KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>..KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>?)>..StubElement<out (KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>..KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>?)>?)>..KtElementImplStub<out (StubElement<out (KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>..KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>?)>..StubElement<out (KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>..KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>?)>?)>?)>?)): KtElementImplStub<out (StubElement<out (KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>..KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>?)>..StubElement<out (KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>..KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>?)>?)>? defined in com.intellij.psi.util.PsiTreeUtil[JavaMethodDescriptor]
Inferred types:
...
'parent' @ [111:16] ==> val parent: KtElementImplStub<out (StubElement<out (KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>..KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>?)>..StubElement<out (KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>..KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>?)>?)>? defined in org.jetbrains.kotlin.resolve.CollectionLiteralResolver.isInsideAnnotationEntryOrClass[LocalVariableDescriptor]

'parent' @ [111:48] ==> val parent: KtElementImplStub<out (StubElement<out (KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>..KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>?)>..StubElement<out (KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>..KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>?)>?)>? defined in org.jetbrains.kotlin.resolve.CollectionLiteralResolver.isInsideAnnotationEntryOrClass[LocalVariableDescriptor]

'parent' @ [111:69] ==> val parent: KtElementImplStub<out (StubElement<out (KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>..KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>?)>..StubElement<out (KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>..KtElementImplStub<out (StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>..StubElement<out (KtElementImplStub<*>..KtElementImplStub<*>?)>?)>?)>?)>? defined in org.jetbrains.kotlin.resolve.CollectionLiteralResolver.isInsideAnnotationEntryOrClass[LocalVariableDescriptor]
