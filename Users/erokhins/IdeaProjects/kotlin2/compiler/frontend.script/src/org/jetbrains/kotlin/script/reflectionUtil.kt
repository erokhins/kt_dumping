...
'when (parameter.type.classifier) {
        ...
        }' @ [145:31] ==> public final fun <`<TYPE-PARAMETER-FOR-WHEN-RESOLVE>`> `<SPECIAL-FUNCTION-FOR-WHEN-RESOLVE>`(entry0: {Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & String & Int}> & java.io.Serializable}?, entry1: {Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & String & Int}> & java.io.Serializable}?, entry2: {Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & String & Int}> & java.io.Serializable}?, entry3: {Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & String & Int}> & java.io.Serializable}?, entry4: {Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & String & Int}> & java.io.Serializable}?, entry5: {Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & String & Int}> & java.io.Serializable}?, entry6: {Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & String & Int}> & java.io.Serializable}?, entry7: {Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & String & Int}> & java.io.Serializable}?, entry8: {Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & String & Int}> & java.io.Serializable}?, entry9: {Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & String & Int}> & java.io.Serializable}?): {Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & String & Int}> & java.io.Serializable}?[SimpleFunctionDescriptorImpl]
Inferred types:
    <`<TYPE-PARAMETER-FOR-WHEN-RESOLVE>`> -> {Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & String & Int}> & java.io.Serializable}?
...
'when (type.classifier) {
                ...
                }' @ [176:17] ==> public final fun <`<TYPE-PARAMETER-FOR-WHEN-RESOLVE>`> `<SPECIAL-FUNCTION-FOR-WHEN-RESOLVE>`(entry0: Sequence<{Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & Int}> & java.io.Serializable}?>?, entry1: Sequence<{Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & Int}> & java.io.Serializable}?>?, entry2: Sequence<{Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & Int}> & java.io.Serializable}?>?, entry3: Sequence<{Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & Int}> & java.io.Serializable}?>?, entry4: Sequence<{Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & Int}> & java.io.Serializable}?>?, entry5: Sequence<{Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & Int}> & java.io.Serializable}?>?, entry6: Sequence<{Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & Int}> & java.io.Serializable}?>?, entry7: Sequence<{Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & Int}> & java.io.Serializable}?>?, entry8: Sequence<{Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & Int}> & java.io.Serializable}?>?): Sequence<{Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & Int}> & java.io.Serializable}?>?[SimpleFunctionDescriptorImpl]
Inferred types:
    <`<TYPE-PARAMETER-FOR-WHEN-RESOLVE>`> -> Sequence<{Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & Int}> & java.io.Serializable}?>?
...
'toList' @ [186:20] ==> public fun <T> Sequence<{Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & Int}>? & java.io.Serializable?}>.toList(): List<{Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & Int}>? & java.io.Serializable?}> defined in kotlin.sequences[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T> -> {Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & Int}>? & java.io.Serializable?}

'takeUnless' @ [186:30] ==> @InlineOnly @SinceKotlin public inline fun <T> List<{Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & Int}>? & java.io.Serializable?}>.takeUnless(predicate: (List<{Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & Int}>? & java.io.Serializable?}>) -> Boolean): List<{Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & Int}>? & java.io.Serializable?}>? defined in kotlin[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T> -> List<{Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & Int}>? & java.io.Serializable?}>

'in' @ [186:43] ==> public abstract fun contains(element: {Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & Int}>? & java.io.Serializable?}): Boolean defined in kotlin.collections.List[DeserializedSimpleFunctionDescriptor]

'it' @ [186:51] ==> value-parameter it: List<{Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & Int}>? & java.io.Serializable?}> defined in org.jetbrains.kotlin.script.StringArgsConverter.tryConvertVararg.convertPrimitivesArray.<anonymous>[ValueParameterDescriptorImpl]

'toTypedArray' @ [186:57] ==> public inline fun <reified T> Collection<{Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & Int}>? & java.io.Serializable?}>.toTypedArray(): Array<{Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & Int}>? & java.io.Serializable?}> defined in kotlin.collections[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <reified T> -> {Comparable<{Long & Boolean & Byte & Char & Short & Double & Float & Int}>? & java.io.Serializable?}
