...
Inferred types:
    <P : (JpsElement..JpsElement?)> -> JpsSimpleElement<(org.jetbrains.jps.android.model.JpsAndroidSdkProperties..org.jetbrains.jps.android.model.JpsAndroidSdkProperties?)>
...
Inferred types:
    <D : (Any..Any?)> -> JpsAndroidSdkProperties
...
'properties' @ [48:24] ==> public final val <P : (JpsElement..JpsElement?)> JpsTypedLibrary<(JpsSdk<(JpsSimpleElement<(JpsAndroidSdkProperties..JpsAndroidSdkProperties?)>..JpsSimpleElement<(JpsAndroidSdkProperties..JpsAndroidSdkProperties?)>?)>..JpsSdk<(JpsSimpleElement<(JpsAndroidSdkProperties..JpsAndroidSdkProperties?)>..JpsSimpleElement<(JpsAndroidSdkProperties..JpsAndroidSdkProperties?)>?)>?)>.properties: (JpsSdk<(JpsSimpleElement<(JpsAndroidSdkProperties..JpsAndroidSdkProperties?)>..JpsSimpleElement<(JpsAndroidSdkProperties..JpsAndroidSdkProperties?)>?)>..JpsSdk<(JpsSimpleElement<(JpsAndroidSdkProperties..JpsAndroidSdkProperties?)>..JpsSimpleElement<(JpsAndroidSdkProperties..JpsAndroidSdkProperties?)>?)>?)[MyPropertyDescriptor]
Inferred types:
