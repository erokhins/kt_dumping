...
'getInstance' @ [53:37] ==> @NotNull public open fun getInstance(@NotNull p0: Project): PsiManager defined in com.intellij.psi.PsiManager[JavaMethodDescriptor]
...
'getInstance' @ [54:46] ==> @NotNull public open fun getInstance(): VirtualFileManager defined in com.intellij.openapi.vfs.VirtualFileManager[JavaMethodDescriptor]
...
Inferred types:
    <reified @PureReifiable T> -> (com.intellij.openapi.vfs.VirtualFile..com.intellij.openapi.vfs.VirtualFile?)
...
'findFileByUrl' @ [70:71] ==> @Nullable public abstract fun findFileByUrl(@NonNls @NotNull p0: String): VirtualFile? defined in com.intellij.openapi.vfs.VirtualFileManager[JavaMethodDescriptor]
...
'findFile' @ [75:38] ==> @Nullable public abstract fun findFile(@NotNull p0: VirtualFile): PsiFile? defined in com.intellij.psi.PsiManager[JavaMethodDescriptor]
...
'getService' @ [146:48] ==> @Nullable public open fun <T : (Any..Any?)> getService(@NotNull p0: Module, @NotNull p1: Class<(AndroidLayoutXmlFileManager..AndroidLayoutXmlFileManager?)>): AndroidLayoutXmlFileManager? defined in com.intellij.openapi.module.ModuleServiceManager[JavaMethodDescriptor]
Inferred types:
...
'getComponent' @ [147:38] ==> public abstract fun <T : (Any..Any?)> getComponent(@NotNull p0: Class<(AndroidLayoutXmlFileManager..AndroidLayoutXmlFileManager?)>): (AndroidLayoutXmlFileManager..AndroidLayoutXmlFileManager?) defined in com.intellij.openapi.module.Module[JavaMethodDescriptor]
Inferred types:
    <T : (Any..Any?)> -> (org.jetbrains.kotlin.android.synthetic.res.AndroidLayoutXmlFileManager..org.jetbrains.kotlin.android.synthetic.res.AndroidLayoutXmlFileManager?)
