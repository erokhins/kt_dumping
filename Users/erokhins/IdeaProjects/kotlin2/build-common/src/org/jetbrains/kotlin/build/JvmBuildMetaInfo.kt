'JvmBuildMetaInfo' @ [44:31] ==> public companion object defined in org.jetbrains.kotlin.build.JvmBuildMetaInfo[FakeCallableDescriptorForObject]

'OWN_VERSION' @ [44:48] ==> public const final val OWN_VERSION: Int defined in org.jetbrains.kotlin.build.JvmBuildMetaInfo.Companion[PropertyDescriptorImpl]

'JvmBuildMetaInfo' @ [45:38] ==> public companion object defined in org.jetbrains.kotlin.build.JvmBuildMetaInfo[FakeCallableDescriptorForObject]

'COROUTINES_VERSION' @ [45:55] ==> public const final val COROUTINES_VERSION: Int defined in org.jetbrains.kotlin.build.JvmBuildMetaInfo.Companion[PropertyDescriptorImpl]

'JvmBuildMetaInfo' @ [46:41] ==> public companion object defined in org.jetbrains.kotlin.build.JvmBuildMetaInfo[FakeCallableDescriptorForObject]

'MULTIPLATFORM_VERSION' @ [46:58] ==> public const final val MULTIPLATFORM_VERSION: Int defined in org.jetbrains.kotlin.build.JvmBuildMetaInfo.Companion[PropertyDescriptorImpl]

'serializeToPlainText' @ [54:17] ==> public inline fun <reified T : Any> serializeToPlainText(instance: JvmBuildMetaInfo): String defined in org.jetbrains.kotlin.build[SimpleFunctionDescriptorImpl]
Inferred types:
    <reified T : Any> -> JvmBuildMetaInfo

'info' @ [54:38] ==> value-parameter info: JvmBuildMetaInfo defined in org.jetbrains.kotlin.build.JvmBuildMetaInfo.Companion.serializeToString[ValueParameterDescriptorImpl]

'deserializeFromPlainText' @ [57:17] ==> public inline fun <reified T : Any> deserializeFromPlainText(str: String): JvmBuildMetaInfo? defined in org.jetbrains.kotlin.build[SimpleFunctionDescriptorImpl]
Inferred types:
    <reified T : Any> -> JvmBuildMetaInfo

'str' @ [57:42] ==> value-parameter str: String defined in org.jetbrains.kotlin.build.JvmBuildMetaInfo.Companion.deserializeFromString[ValueParameterDescriptorImpl]

'JvmBuildMetaInfo' @ [62:9] ==> public constructor JvmBuildMetaInfo(isEAP: Boolean, compilerBuildVersion: String, languageVersionString: String, apiVersionString: String, coroutinesEnable: Boolean, coroutinesWarn: Boolean, coroutinesError: Boolean, multiplatformEnable: Boolean, metadataVersionMajor: Int, metadataVersionMinor: Int, metadataVersionPatch: Int, bytecodeVersionMajor: Int, bytecodeVersionMinor: Int, bytecodeVersionPatch: Int, ownVersion: Int = ..., coroutinesVersion: Int = ..., multiplatformVersion: Int = ...) defined in org.jetbrains.kotlin.build.JvmBuildMetaInfo[ClassConstructorDescriptorImpl]

'isPreRelease' @ [62:56] ==> public open fun isPreRelease(): Boolean defined in org.jetbrains.kotlin.config.KotlinCompilerVersion[JavaMethodDescriptor]

'VERSION' @ [63:71] ==> public const final val VERSION: String defined in org.jetbrains.kotlin.config.KotlinCompilerVersion[JavaPropertyDescriptor]

'args' @ [64:50] ==> value-parameter args: CommonCompilerArguments defined in org.jetbrains.kotlin.build.JvmBuildMetaInfo[ValueParameterDescriptorImpl]
...
'versionString' @ [65:89] ==> public final val versionString: String defined in org.jetbrains.kotlin.config.ApiVersion[DeserializedPropertyDescriptor]

'args' @ [66:45] ==> value-parameter args: CommonCompilerArguments defined in org.jetbrains.kotlin.build.JvmBuildMetaInfo[ValueParameterDescriptorImpl]
...
'args' @ [68:44] ==> value-parameter args: CommonCompilerArguments defined in org.jetbrains.kotlin.build.JvmBuildMetaInfo[ValueParameterDescriptorImpl]
...
'patch' @ [75:83] ==> public final val patch: Int defined in org.jetbrains.kotlin.load.java.JvmBytecodeBinaryVersion[DeserializedPropertyDescriptor]
