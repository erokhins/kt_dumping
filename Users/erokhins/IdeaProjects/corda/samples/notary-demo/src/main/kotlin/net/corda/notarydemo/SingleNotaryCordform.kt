...
'setOf' @ [20:45] ==> public fun <T> setOf(vararg elements: String): Set<String> defined in kotlin.collections[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <T> -> String

'startFlowPermission' @ [20:51] ==> public inline fun <reified P : FlowLogic<*>> startFlowPermission(): String defined in net.corda.node.services[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <reified P : FlowLogic<*>> -> DummyIssueAndMove

'startFlowPermission' @ [20:93] ==> public inline fun <reified P : FlowLogic<*>> startFlowPermission(): String defined in net.corda.node.services[DeserializedSimpleFunctionDescriptor]
Inferred types:
    <reified P : FlowLogic<*>> -> RPCStartableNotaryFlowClient

'CordformDefinition' @ [22:31] ==> public constructor CordformDefinition(p0: (Path..Path?), p1: (X500Name..X500Name?)) defined in net.corda.cordform.CordformDefinition[JavaClassConstructorDescriptor]

'/' @ [22:50] ==> public operator fun String.div(other: String): Path defined in net.corda.core.internal[DeserializedSimpleFunctionDescriptor]

'DUMMY_NOTARY' @ [22:81] ==> public val DUMMY_NOTARY: Party defined in net.corda.testing[DeserializedPropertyDescriptor]
...
'name' @ [25:24] ==> public final val name: X500Name defined in net.corda.core.identity.Party[DeserializedPropertyDescriptor]

'p2pPort' @ [26:13] ==> public open fun p2pPort(p0: (Int..Int?)): Unit defined in net.corda.cordform.CordformNode[JavaMethodDescriptor]
...
'name' @ [31:22] ==> public final val name: X500Name defined in net.corda.core.identity.Party[DeserializedPropertyDescriptor]
...
'name' @ [36:31] ==> public final val name: X500Name defined in net.corda.core.identity.Party[DeserializedPropertyDescriptor]

'p2pPort' @ [37:13] ==> public open fun p2pPort(p0: (Int..Int?)): Unit defined in net.corda.cordform.CordformNode[JavaMethodDescriptor]
