...
'createCoroutineUnchecked' @ [42:39] ==> @SinceKotlin public header fun <R, T> (suspend SequenceBuilderIterator<T>.() -> Unit).createCoroutineUnchecked(receiver: SequenceBuilderIterator<T>, completion: Continuation<Unit>): Continuation<Unit> defined in kotlin.coroutines.experimental.intrinsics[SimpleFunctionDescriptorImpl]
Inferred types:
...
'NoSuchElementException' @ [151:31] ==> public constructor NoSuchElementException() defined in kotlin.NoSuchElementException[ClassConstructorDescriptorImpl]
...
'NoSuchElementException' @ [155:23] ==> public constructor NoSuchElementException() defined in kotlin.NoSuchElementException[ClassConstructorDescriptorImpl]
