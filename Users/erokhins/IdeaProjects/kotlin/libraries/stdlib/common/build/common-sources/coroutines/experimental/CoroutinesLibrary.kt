...
'createCoroutineUnchecked' @ [35:5] ==> @SinceKotlin public header fun <R, T> (suspend R.() -> T).createCoroutineUnchecked(receiver: R, completion: Continuation<T>): Continuation<Unit> defined in kotlin.coroutines.experimental.intrinsics[SimpleFunctionDescriptorImpl]
Inferred types:
    <R> -> R
    <T> -> T
...
'Unit' @ [35:59] ==> public object Unit defined in kotlin[FakeCallableDescriptorForObject]
...
'createCoroutineUnchecked' @ [48:5] ==> @SinceKotlin public header fun <T> (suspend () -> T).createCoroutineUnchecked(completion: Continuation<T>): Continuation<Unit> defined in kotlin.coroutines.experimental.intrinsics[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> T
...
'Unit' @ [48:49] ==> public object Unit defined in kotlin[FakeCallableDescriptorForObject]
...
'createCoroutineUnchecked' @ [64:42] ==> @SinceKotlin public header fun <R, T> (suspend R.() -> T).createCoroutineUnchecked(receiver: R, completion: Continuation<T>): Continuation<Unit> defined in kotlin.coroutines.experimental.intrinsics[SimpleFunctionDescriptorImpl]
Inferred types:
    <R> -> R
    <T> -> T
...
'createCoroutineUnchecked' @ [78:42] ==> @SinceKotlin public header fun <T> (suspend () -> T).createCoroutineUnchecked(completion: Continuation<T>): Continuation<Unit> defined in kotlin.coroutines.experimental.intrinsics[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> T
...
'getResult' @ [93:18] ==> @PublishedApi internal final header fun getResult(): Any? defined in kotlin.coroutines.experimental.SafeContinuation[SimpleFunctionDescriptorImpl]
