...
'checkRadix' @ [216:5] ==> @PublishedApi internal header fun checkRadix(radix: Int): Int defined in kotlin.text in file TextH.kt[SimpleFunctionDescriptorImpl]
...
'digitOf' @ [249:21] ==> internal header fun digitOf(char: Char, radix: Int): Int defined in kotlin.text in file TextH.kt[SimpleFunctionDescriptorImpl]
...
'checkRadix' @ [279:5] ==> @PublishedApi internal header fun checkRadix(radix: Int): Int defined in kotlin.text in file TextH.kt[SimpleFunctionDescriptorImpl]
...
'digitOf' @ [312:21] ==> internal header fun digitOf(char: Char, radix: Int): Int defined in kotlin.text in file TextH.kt[SimpleFunctionDescriptorImpl]
