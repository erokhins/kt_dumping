...
'isWhitespace' @ [33:63] ==> public header fun Char.isWhitespace(): Boolean defined in kotlin.text in file TextH.kt[SimpleFunctionDescriptorImpl]
...
'startsWith' @ [37:18] ==> public fun CharSequence.startsWith(prefix: CharSequence, startIndex: Int, ignoreCase: Boolean = ...): Boolean defined in kotlin.text in file Strings.kt[SimpleFunctionDescriptorImpl]
...
'substring' @ [37:76] ==> @InlineOnly public inline fun CharSequence.substring(startIndex: Int, endIndex: Int = ...): String defined in kotlin.text in file Strings.kt[SimpleFunctionDescriptorImpl]
...
'filter' @ [67:14] ==> public header inline fun <T> Iterable<String>.filter(predicate: (String) -> Boolean): List<String> defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> String
...
'drop' @ [71:112] ==> public header fun String.drop(n: Int): String defined in kotlin.text in file _Strings.kt[SimpleFunctionDescriptorImpl]
...
'isBlank' @ [83:16] ==> public header fun CharSequence.isBlank(): Boolean defined in kotlin.text in file TextH.kt[SimpleFunctionDescriptorImpl]
...
'isWhitespace' @ [94:60] ==> public header fun Char.isWhitespace(): Boolean defined in kotlin.text in file TextH.kt[SimpleFunctionDescriptorImpl]
...
'mapIndexedNotNull' @ [103:12] ==> public header inline fun <T, R : Any> Iterable<String>.mapIndexedNotNull(transform: (index: Int, String) -> String?): List<String> defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> String
    <R : Any> -> String
...
'isBlank' @ [104:61] ==> public header fun CharSequence.isBlank(): Boolean defined in kotlin.text in file TextH.kt[SimpleFunctionDescriptorImpl]
...
'StringBuilder' @ [109:17] ==> public constructor StringBuilder(capacity: Int) defined in kotlin.text.StringBuilder[ClassConstructorDescriptorImpl]
...
'toString' @ [110:10] ==> public open fun toString(): String defined in kotlin.text.StringBuilder[DeserializedSimpleFunctionDescriptor]
