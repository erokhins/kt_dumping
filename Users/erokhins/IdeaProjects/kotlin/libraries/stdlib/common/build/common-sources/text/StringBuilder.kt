...
'StringBuilder' @ [12:9] ==> public constructor StringBuilder() defined in kotlin.text.StringBuilder[ClassConstructorDescriptorImpl]
...
'toString' @ [12:46] ==> public open fun toString(): String defined in kotlin.text.StringBuilder[DeserializedSimpleFunctionDescriptor]
...
'StringBuilder' @ [21:9] ==> public constructor StringBuilder(capacity: Int) defined in kotlin.text.StringBuilder[ClassConstructorDescriptorImpl]
...
'toString' @ [21:54] ==> public open fun toString(): String defined in kotlin.text.StringBuilder[DeserializedSimpleFunctionDescriptor]

'value' @ [27:18] ==> value-parameter vararg value: CharSequence? defined in kotlin.text.append[ValueParameterDescriptorImpl]

'append' @ [28:9] ==> public abstract header fun append(csq: CharSequence?): Appendable defined in kotlin.text.Appendable[SimpleFunctionDescriptorImpl]
...
'append' @ [37:9] ==> public open header fun append(csq: CharSequence?): StringBuilder defined in kotlin.text.StringBuilder[SimpleFunctionDescriptorImpl]
...
'append' @ [46:9] ==> public final header fun append(obj: Any?): StringBuilder defined in kotlin.text.StringBuilder[SimpleFunctionDescriptorImpl]
...
'append' @ [60:30] ==> public abstract header fun append(csq: CharSequence?): Appendable defined in kotlin.text.Appendable[SimpleFunctionDescriptorImpl]
...
'append' @ [61:37] ==> public abstract header fun append(csq: CharSequence?): Appendable defined in kotlin.text.Appendable[SimpleFunctionDescriptorImpl]
...
'append' @ [62:28] ==> public abstract header fun append(c: Char): Appendable defined in kotlin.text.Appendable[SimpleFunctionDescriptorImpl]

'element' @ [62:35] ==> value-parameter element: T defined in kotlin.text.appendElement[ValueParameterDescriptorImpl]

'append' @ [63:17] ==> public abstract header fun append(csq: CharSequence?): Appendable defined in kotlin.text.Appendable[SimpleFunctionDescriptorImpl]
