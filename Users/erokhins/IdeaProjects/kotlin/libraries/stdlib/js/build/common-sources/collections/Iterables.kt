...
'size' @ [42:93] ==> public abstract val size: Int defined in kotlin.collections.Collection[PropertyDescriptorImpl]
...
'size' @ [48:107] ==> public abstract val size: Int defined in kotlin.collections.Collection[PropertyDescriptorImpl]
...
'size' @ [51:54] ==> public abstract val size: Int defined in kotlin.collections.Collection[PropertyDescriptorImpl]
...
'size' @ [59:52] ==> public abstract val size: Int defined in kotlin.collections.Collection[PropertyDescriptorImpl]
...
'toHashSet' @ [60:60] ==> public fun <T> Iterable<T>.toHashSet(): HashSet<T> defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> T

'this' @ [60:77] ==> <this> defined in kotlin.collections.convertToSetForSetOperationWith[ReceiverParameterDescriptorImpl]

'toHashSet' @ [62:21] ==> public fun <T> Iterable<T>.toHashSet(): HashSet<T> defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> T
...
'toHashSet' @ [69:61] ==> public fun <T> Iterable<T>.toHashSet(): HashSet<T> defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> T

'this' @ [69:78] ==> <this> defined in kotlin.collections.convertToSetForSetOperation[ReceiverParameterDescriptorImpl]

'toHashSet' @ [70:21] ==> public fun <T> Iterable<T>.toHashSet(): HashSet<T> defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> T

'ArrayList' @ [78:18] ==> public constructor ArrayList<E>(@Suppress capacity: Int = ...) defined in kotlin.collections.ArrayList[ClassConstructorDescriptorImpl]
Inferred types:
    <E> -> T
...
'ArrayList' @ [92:17] ==> public constructor ArrayList<E>(@Suppress capacity: Int = ...) defined in kotlin.collections.ArrayList[ClassConstructorDescriptorImpl]
Inferred types:
    <E> -> T

'expectedSize' @ [92:30] ==> val expectedSize: Int defined in kotlin.collections.unzip[LocalVariableDescriptor]

'ArrayList' @ [93:17] ==> public constructor ArrayList<E>(@Suppress capacity: Int = ...) defined in kotlin.collections.ArrayList[ClassConstructorDescriptorImpl]
Inferred types:
    <E> -> R
...
'add' @ [95:15] ==> public open fun add(element: T): Boolean defined in kotlin.collections.ArrayList[SimpleFunctionDescriptorImpl]
...
'add' @ [96:15] ==> public open fun add(element: R): Boolean defined in kotlin.collections.ArrayList[SimpleFunctionDescriptorImpl]
