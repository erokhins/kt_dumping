...
'copyToArrayImpl' @ [48:65] ==> @JsName internal fun <T> copyToArrayImpl(collection: Collection<*>, array: Array<T>): Array<T> defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> T
