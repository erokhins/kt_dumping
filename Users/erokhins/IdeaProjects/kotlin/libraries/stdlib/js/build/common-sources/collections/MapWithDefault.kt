...
'size' @ [69:40] ==> public abstract val size: Int defined in kotlin.collections.Map[PropertyDescriptorImpl]

'map' @ [70:39] ==> public open val map: Map<K, V> defined in kotlin.collections.MapWithDefaultImpl[PropertyDescriptorImpl]

'isEmpty' @ [70:43] ==> public abstract fun isEmpty(): Boolean defined in kotlin.collections.Map[SimpleFunctionDescriptorImpl]

'map' @ [71:49] ==> public open val map: Map<K, V> defined in kotlin.collections.MapWithDefaultImpl[PropertyDescriptorImpl]

'containsKey' @ [71:53] ==> public abstract fun containsKey(key: K): Boolean defined in kotlin.collections.Map[SimpleFunctionDescriptorImpl]
...
'containsValue' @ [72:73] ==> public abstract fun containsValue(value: V): Boolean defined in kotlin.collections.Map[SimpleFunctionDescriptorImpl]
...
'get' @ [73:40] ==> public abstract operator fun get(key: K): V? defined in kotlin.collections.Map[SimpleFunctionDescriptorImpl]
...
'keys' @ [74:43] ==> public abstract val keys: Set<K> defined in kotlin.collections.Map[PropertyDescriptorImpl]

'map' @ [75:48] ==> public open val map: Map<K, V> defined in kotlin.collections.MapWithDefaultImpl[PropertyDescriptorImpl]

'values' @ [75:52] ==> public abstract val values: Collection<V> defined in kotlin.collections.Map[PropertyDescriptorImpl]

'map' @ [76:56] ==> public open val map: Map<K, V> defined in kotlin.collections.MapWithDefaultImpl[PropertyDescriptorImpl]

'entries' @ [76:60] ==> public abstract val entries: Set<Map.Entry<K, V>> defined in kotlin.collections.Map[PropertyDescriptorImpl]
...
'size' @ [85:40] ==> public abstract val size: Int defined in kotlin.collections.MutableMap[PropertyDescriptorImpl]
...
'isEmpty' @ [86:43] ==> public abstract fun isEmpty(): Boolean defined in kotlin.collections.MutableMap[SimpleFunctionDescriptorImpl]
...
'containsKey' @ [87:53] ==> public abstract fun containsKey(key: K): Boolean defined in kotlin.collections.MutableMap[SimpleFunctionDescriptorImpl]
...
'containsValue' @ [88:73] ==> public abstract fun containsValue(value: V): Boolean defined in kotlin.collections.MutableMap[SimpleFunctionDescriptorImpl]
...
'get' @ [89:40] ==> public abstract fun get(key: K): V? defined in kotlin.collections.MutableMap[SimpleFunctionDescriptorImpl]
...
'keys' @ [90:50] ==> public abstract val keys: MutableSet<K> defined in kotlin.collections.MutableMap[PropertyDescriptorImpl]
...
'values' @ [91:59] ==> public abstract val values: MutableCollection<V> defined in kotlin.collections.MutableMap[PropertyDescriptorImpl]
...
'entries' @ [92:81] ==> public abstract val entries: MutableSet<MutableMap.MutableEntry<K, V>> defined in kotlin.collections.MutableMap[PropertyDescriptorImpl]
...
'put' @ [94:50] ==> public abstract fun put(key: K, value: V): V? defined in kotlin.collections.MutableMap[SimpleFunctionDescriptorImpl]
...
'remove' @ [95:43] ==> public abstract fun remove(key: K): V? defined in kotlin.collections.MutableMap[SimpleFunctionDescriptorImpl]
...
'putAll' @ [96:52] ==> public abstract fun putAll(from: Map<out K, V>): Unit defined in kotlin.collections.MutableMap[SimpleFunctionDescriptorImpl]
...
'clear' @ [97:32] ==> public abstract fun clear(): Unit defined in kotlin.collections.MutableMap[SimpleFunctionDescriptorImpl]
