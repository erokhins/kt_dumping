...
'synchronized' @ [124:20] ==> @InlineOnly public inline fun <R> synchronized(@Suppress lock: Any, crossinline block: () -> T): T defined in kotlin[SimpleFunctionDescriptorImpl]
Inferred types:
    <R> -> T
