...
'indexOfFirst' @ [33:44] ==> public inline fun CharSequence.indexOfFirst(predicate: (Char) -> Boolean): Int defined in kotlin.text in file _StringsJs.kt[SimpleFunctionDescriptorImpl]
...
'indexOfFirst' @ [94:41] ==> public inline fun CharSequence.indexOfFirst(predicate: (Char) -> Boolean): Int defined in kotlin.text in file _StringsJs.kt[SimpleFunctionDescriptorImpl]
