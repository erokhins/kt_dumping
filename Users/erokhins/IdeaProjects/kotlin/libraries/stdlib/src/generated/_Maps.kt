...
'size' @ [18:9] ==> public abstract val size: Int defined in kotlin.collections.Map[DeserializedPropertyDescriptor]

'emptyList' @ [19:16] ==> public fun <T> emptyList(): List<Pair<K, V>> defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> Pair<K, V>

'entries' @ [20:20] ==> public abstract val entries: Set<Map.Entry<K, V>> defined in kotlin.collections.Map[DeserializedPropertyDescriptor]

'iterator' @ [20:28] ==> public abstract fun iterator(): Iterator<Map.Entry<K, V>> defined in kotlin.collections.Set[DeserializedSimpleFunctionDescriptor]
...
'hasNext' @ [21:19] ==> public abstract operator fun hasNext(): Boolean defined in kotlin.collections.Iterator[DeserializedSimpleFunctionDescriptor]
...
'next' @ [23:26] ==> public abstract operator fun next(): Map.Entry<K, V> defined in kotlin.collections.Iterator[DeserializedSimpleFunctionDescriptor]
...
'hasNext' @ [24:19] ==> public abstract operator fun hasNext(): Boolean defined in kotlin.collections.Iterator[DeserializedSimpleFunctionDescriptor]

'listOf' @ [25:16] ==> @JvmVersion public fun <T> listOf(element: Pair<K, V>): List<Pair<K, V>> defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> Pair<K, V>
...
'ArrayList' @ [26:18] ==> public final fun <E> <init>(p0: Int): ArrayList<Pair<K, V>> /* = ArrayList<Pair<K, V>> */ defined in kotlin.collections.ArrayList[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <E> -> Pair<K, V>

'size' @ [26:40] ==> public abstract val size: Int defined in kotlin.collections.Map[DeserializedPropertyDescriptor]

'result' @ [27:5] ==> val result: ArrayList<Pair<K, V>> /* = ArrayList<Pair<K, V>> */ defined in kotlin.collections.toList[LocalVariableDescriptor]

'add' @ [27:12] ==> public open fun add(element: Pair<K, V>): Boolean defined in java.util.ArrayList[JavaMethodDescriptor]
...
'result' @ [29:9] ==> val result: ArrayList<Pair<K, V>> /* = ArrayList<Pair<K, V>> */ defined in kotlin.collections.toList[LocalVariableDescriptor]

'add' @ [29:16] ==> public open fun add(element: Pair<K, V>): Boolean defined in java.util.ArrayList[JavaMethodDescriptor]

'iterator' @ [29:20] ==> val iterator: Iterator<Map.Entry<K, V>> defined in kotlin.collections.toList[LocalVariableDescriptor]

'next' @ [29:29] ==> public abstract operator fun next(): Map.Entry<K, V> defined in kotlin.collections.Iterator[DeserializedSimpleFunctionDescriptor]
...
'hasNext' @ [30:23] ==> public abstract operator fun hasNext(): Boolean defined in kotlin.collections.Iterator[DeserializedSimpleFunctionDescriptor]

'result' @ [31:12] ==> val result: ArrayList<Pair<K, V>> /* = ArrayList<Pair<K, V>> */ defined in kotlin.collections.toList[LocalVariableDescriptor]

'flatMapTo' @ [38:12] ==> public inline fun <K, V, R, C : MutableCollection<in R>> Map<out K, V>.flatMapTo(destination: ArrayList<R> /* = ArrayList<R> */, transform: (Map.Entry<K, V>) -> Iterable<R>): ArrayList<R> /* = ArrayList<R> */ defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
    <R> -> R
...
'ArrayList' @ [38:22] ==> public final fun <E> <init>(): ArrayList<R> /* = ArrayList<R> */ defined in kotlin.collections.ArrayList[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <E> -> R
...
'mapTo' @ [57:12] ==> public inline fun <K, V, R, C : MutableCollection<in R>> Map<out K, V>.mapTo(destination: ArrayList<R> /* = ArrayList<R> */, transform: (Map.Entry<K, V>) -> R): ArrayList<R> /* = ArrayList<R> */ defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
    <R> -> R
...
'ArrayList' @ [57:18] ==> public final fun <E> <init>(p0: Int): ArrayList<R> /* = ArrayList<R> */ defined in kotlin.collections.ArrayList[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <E> -> R

'size' @ [57:31] ==> public abstract val size: Int defined in kotlin.collections.Map[DeserializedPropertyDescriptor]

'transform' @ [57:38] ==> value-parameter transform: (Map.Entry<K, V>) -> R defined in kotlin.collections.map[ValueParameterDescriptorImpl]

'mapNotNullTo' @ [65:12] ==> public inline fun <K, V, R : Any, C : MutableCollection<in R>> Map<out K, V>.mapNotNullTo(destination: ArrayList<R> /* = ArrayList<R> */, transform: (Map.Entry<K, V>) -> R?): ArrayList<R> /* = ArrayList<R> */ defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
    <R : Any> -> R
...
'ArrayList' @ [65:25] ==> public final fun <E> <init>(): ArrayList<R> /* = ArrayList<R> */ defined in kotlin.collections.ArrayList[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <E> -> R
...
'add' @ [73:64] ==> public abstract fun add(element: R): Boolean defined in kotlin.collections.MutableCollection[DeserializedSimpleFunctionDescriptor]
...
'add' @ [83:21] ==> public abstract fun add(element: R): Boolean defined in kotlin.collections.MutableCollection[DeserializedSimpleFunctionDescriptor]
...
'isEmpty' @ [91:9] ==> public abstract fun isEmpty(): Boolean defined in kotlin.collections.Map[DeserializedSimpleFunctionDescriptor]
...
'isEmpty' @ [100:13] ==> public abstract fun isEmpty(): Boolean defined in kotlin.collections.Map[DeserializedSimpleFunctionDescriptor]

'isEmpty' @ [107:9] ==> public abstract fun isEmpty(): Boolean defined in kotlin.collections.Map[DeserializedSimpleFunctionDescriptor]
...
'size' @ [117:12] ==> public abstract val size: Int defined in kotlin.collections.Map[DeserializedPropertyDescriptor]

'isEmpty' @ [124:9] ==> public abstract fun isEmpty(): Boolean defined in kotlin.collections.Map[DeserializedSimpleFunctionDescriptor]
...
'entries' @ [143:12] ==> public abstract val entries: Set<Map.Entry<K, V>> defined in kotlin.collections.Map[DeserializedPropertyDescriptor]
...
'entries' @ [151:12] ==> public abstract val entries: Set<Map.Entry<K, V>> defined in kotlin.collections.Map[DeserializedPropertyDescriptor]

'maxWith' @ [151:20] ==> public fun <T> Iterable<Map.Entry<K, V>>.maxWith(comparator: Comparator<in Map.Entry<K, V>> /* = Comparator<in Map.Entry<K, V>> */): Map.Entry<K, V>? defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> Entry<K, V>

'comparator' @ [151:28] ==> value-parameter comparator: Comparator<in Map.Entry<K, V>> /* = Comparator<in Map.Entry<K, V>> */ defined in kotlin.collections.maxWith[ValueParameterDescriptorImpl]

'entries' @ [158:12] ==> public abstract val entries: Set<Map.Entry<K, V>> defined in kotlin.collections.Map[DeserializedPropertyDescriptor]
...
'entries' @ [165:12] ==> public abstract val entries: Set<Map.Entry<K, V>> defined in kotlin.collections.Map[DeserializedPropertyDescriptor]

'minWith' @ [165:20] ==> public fun <T> Iterable<Map.Entry<K, V>>.minWith(comparator: Comparator<in Map.Entry<K, V>> /* = Comparator<in Map.Entry<K, V>> */): Map.Entry<K, V>? defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> Entry<K, V>

'comparator' @ [165:28] ==> value-parameter comparator: Comparator<in Map.Entry<K, V>> /* = Comparator<in Map.Entry<K, V>> */ defined in kotlin.collections.minWith[ValueParameterDescriptorImpl]

'isEmpty' @ [172:12] ==> public abstract fun isEmpty(): Boolean defined in kotlin.collections.Map[DeserializedSimpleFunctionDescriptor]

'isEmpty' @ [179:9] ==> public abstract fun isEmpty(): Boolean defined in kotlin.collections.Map[DeserializedSimpleFunctionDescriptor]
...
'entries' @ [197:12] ==> public abstract val entries: Set<Map.Entry<K, V>> defined in kotlin.collections.Map[DeserializedPropertyDescriptor]

'entries' @ [204:12] ==> public abstract val entries: Set<Map.Entry<K, V>> defined in kotlin.collections.Map[DeserializedPropertyDescriptor]
