...
'isEmpty' @ [9:76] ==> public abstract fun isEmpty(): Boolean defined in kotlin.collections.Map[DeserializedSimpleFunctionDescriptor]

'EmptySet' @ [19:65] ==> internal object EmptySet : Set<Nothing>, Serializable /* = Serializable */ defined in kotlin.collections in file Sets.kt[FakeCallableDescriptorForObject]

'EmptySet' @ [20:42] ==> internal object EmptySet : Set<Nothing>, Serializable /* = Serializable */ defined in kotlin.collections in file Sets.kt[FakeCallableDescriptorForObject]

'EmptyList' @ [21:54] ==> internal object EmptyList : List<Nothing>, Serializable /* = Serializable */, RandomAccess /* = RandomAccess */ defined in kotlin.collections in file Collections.kt[FakeCallableDescriptorForObject]

'EmptyMap' @ [23:38] ==> private object EmptyMap : Map<Any?, Nothing>, Serializable /* = Serializable */ defined in kotlin.collections in file Maps.kt[FakeCallableDescriptorForObject]
...
'EmptyMap' @ [32:72] ==> private object EmptyMap : Map<Any?, Nothing>, Serializable /* = Serializable */ defined in kotlin.collections in file Maps.kt[FakeCallableDescriptorForObject]
...
'toMap' @ [46:90] ==> public fun <K, V, M : MutableMap<in K, in V>> Array<out Pair<K, V>>.toMap(destination: LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
    <M : MutableMap<in K, in V>> -> LinkedHashMap<K, V>

'LinkedHashMap' @ [46:96] ==> public final fun <K, V> <init>(p0: Int): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections.LinkedHashMap[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'JvmVersion' @ [65:1] ==> public constructor JvmVersion(minimum: Int = ..., maximum: Int = ...) defined in kotlin.jvm.JvmVersion[ClassConstructorDescriptorImpl]
...
'first' @ [66:96] ==> public final val first: K defined in kotlin.Pair[PropertyDescriptorImpl]

'pair' @ [66:103] ==> value-parameter pair: Pair<K, V> defined in kotlin.collections.mapOf[ValueParameterDescriptorImpl]

'second' @ [66:108] ==> public final val second: V defined in kotlin.Pair[PropertyDescriptorImpl]
...
'LinkedHashMap' @ [76:61] ==> public final fun <K, V> <init>(): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections.LinkedHashMap[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V

'LinkedHashMap' @ [90:11] ==> public final fun <K, V> <init>(p0: Int): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections.LinkedHashMap[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'apply' @ [90:56] ==> @InlineOnly public inline fun <T> LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */.apply(block: LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */.() -> Unit): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> LinkedHashMap<K, V>
...
'HashMap' @ [97:55] ==> public final fun <K, V> <init>(): HashMap<K, V> /* = HashMap<K, V> */ defined in kotlin.collections.HashMap[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V

'HashMap' @ [106:11] ==> public final fun <K, V> <init>(p0: Int): HashMap<K, V> /* = HashMap<K, V> */ defined in kotlin.collections.HashMap[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'apply' @ [106:50] ==> @InlineOnly public inline fun <T> HashMap<K, V> /* = HashMap<K, V> */.apply(block: HashMap<K, V> /* = HashMap<K, V> */.() -> Unit): HashMap<K, V> /* = HashMap<K, V> */ defined in kotlin[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> HashMap<K, V>
...
'LinkedHashMap' @ [113:63] ==> public final fun <K, V> <init>(): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections.LinkedHashMap[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'toMap' @ [126:17] ==> public fun <K, V, M : MutableMap<in K, in V>> Array<out Pair<K, V>>.toMap(destination: LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
    <M : MutableMap<in K, in V>> -> LinkedHashMap<K, V>

'LinkedHashMap' @ [126:23] ==> public final fun <K, V> <init>(p0: Int): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections.LinkedHashMap[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'isEmpty' @ [148:65] ==> public abstract fun isEmpty(): Boolean defined in kotlin.collections.Map[DeserializedSimpleFunctionDescriptor]
...
'get' @ [169:59] ==> public abstract operator fun get(key: K): V? defined in kotlin.collections.Map[DeserializedSimpleFunctionDescriptor]
...
'put' @ [176:5] ==> public abstract fun put(key: K, value: V): V? defined in kotlin.collections.MutableMap[DeserializedSimpleFunctionDescriptor]
...
'containsKey' @ [186:59] ==> public abstract fun containsKey(key: K): Boolean defined in kotlin.collections.Map[DeserializedSimpleFunctionDescriptor]
...
'containsValue' @ [195:108] ==> public abstract fun containsValue(value: V): Boolean defined in kotlin.collections.Map[DeserializedSimpleFunctionDescriptor]
...
'remove' @ [207:66] ==> public abstract fun remove(key: K): V? defined in kotlin.collections.MutableMap[DeserializedSimpleFunctionDescriptor]
...
'key' @ [220:69] ==> public abstract val key: K defined in kotlin.collections.Map.Entry[DeserializedPropertyDescriptor]
...
'value' @ [233:69] ==> public abstract val value: V defined in kotlin.collections.Map.Entry[DeserializedPropertyDescriptor]
...
'key' @ [239:70] ==> public abstract val key: K defined in kotlin.collections.Map.Entry[DeserializedPropertyDescriptor]

'value' @ [239:75] ==> public abstract val value: V defined in kotlin.collections.Map.Entry[DeserializedPropertyDescriptor]
...
'get' @ [247:82] ==> public abstract operator fun get(key: K): V? defined in kotlin.collections.Map[DeserializedSimpleFunctionDescriptor]
...
'get' @ [251:17] ==> public abstract operator fun get(key: K): V? defined in kotlin.collections.Map[DeserializedSimpleFunctionDescriptor]
...
'containsKey' @ [252:27] ==> public abstract fun containsKey(key: K): Boolean defined in kotlin.collections.Map[DeserializedSimpleFunctionDescriptor]
...
'get' @ [279:17] ==> public abstract fun get(key: K): V? defined in kotlin.collections.MutableMap[DeserializedSimpleFunctionDescriptor]
...
'put' @ [282:9] ==> public abstract fun put(key: K, value: V): V? defined in kotlin.collections.MutableMap[DeserializedSimpleFunctionDescriptor]
...
'entries' @ [295:89] ==> public abstract val entries: Set<Map.Entry<K, V>> defined in kotlin.collections.Map[DeserializedPropertyDescriptor]

'iterator' @ [295:97] ==> public abstract fun iterator(): Iterator<Map.Entry<K, V>> defined in kotlin.collections.Set[DeserializedSimpleFunctionDescriptor]

'kotlin.jvm.JvmName' @ [301:1] ==> public constructor JvmName(name: String) defined in kotlin.jvm.JvmName[DeserializedClassConstructorDescriptor]
...
'entries' @ [303:113] ==> public abstract val entries: MutableSet<MutableMap.MutableEntry<K, V>> defined in kotlin.collections.MutableMap[DeserializedPropertyDescriptor]

'iterator' @ [303:121] ==> public abstract fun iterator(): MutableIterator<MutableMap.MutableEntry<K, V>> defined in kotlin.collections.MutableSet[DeserializedSimpleFunctionDescriptor]

'entries' @ [310:12] ==> public abstract val entries: Set<Map.Entry<K, V>> defined in kotlin.collections.Map[DeserializedPropertyDescriptor]
...
'key' @ [310:52] ==> public abstract val key: K defined in kotlin.collections.Map.Entry[DeserializedPropertyDescriptor]
...
'entries' @ [321:12] ==> public abstract val entries: Set<Map.Entry<K, V>> defined in kotlin.collections.Map[DeserializedPropertyDescriptor]
...
'value' @ [321:63] ==> public abstract val value: V defined in kotlin.collections.Map.Entry[DeserializedPropertyDescriptor]
...
'put' @ [329:9] ==> public abstract fun put(key: K, value: V): Any? defined in kotlin.collections.MutableMap[DeserializedSimpleFunctionDescriptor]
...
'put' @ [338:9] ==> public abstract fun put(key: K, value: V): Any? defined in kotlin.collections.MutableMap[DeserializedSimpleFunctionDescriptor]
...
'put' @ [347:9] ==> public abstract fun put(key: K, value: V): Any? defined in kotlin.collections.MutableMap[DeserializedSimpleFunctionDescriptor]
...
'mapValuesTo' @ [360:12] ==> public inline fun <K, V, R, M : MutableMap<in K, in R>> Map<out K, V>.mapValuesTo(destination: LinkedHashMap<K, R> /* = LinkedHashMap<K, R> */, transform: (Map.Entry<K, V>) -> R): LinkedHashMap<K, R> /* = LinkedHashMap<K, R> */ defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
    <R> -> R
...
'LinkedHashMap' @ [360:24] ==> public final fun <K, V> <init>(p0: Int): LinkedHashMap<K, R> /* = LinkedHashMap<K, R> */ defined in kotlin.collections.LinkedHashMap[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> R
...
'size' @ [360:56] ==> public abstract val size: Int defined in kotlin.collections.Map[DeserializedPropertyDescriptor]
...
'mapKeysTo' @ [375:12] ==> public inline fun <K, V, R, M : MutableMap<in R, in V>> Map<out K, V>.mapKeysTo(destination: LinkedHashMap<R, V> /* = LinkedHashMap<R, V> */, transform: (Map.Entry<K, V>) -> R): LinkedHashMap<R, V> /* = LinkedHashMap<R, V> */ defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
    <R> -> R
...
'LinkedHashMap' @ [375:22] ==> public final fun <K, V> <init>(p0: Int): LinkedHashMap<R, V> /* = LinkedHashMap<R, V> */ defined in kotlin.collections.LinkedHashMap[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <K> -> R
    <V> -> V
...
'size' @ [375:54] ==> public abstract val size: Int defined in kotlin.collections.Map[DeserializedPropertyDescriptor]
...
'LinkedHashMap' @ [384:18] ==> public final fun <K, V> <init>(): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections.LinkedHashMap[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'key' @ [386:29] ==> public abstract val key: K defined in kotlin.collections.Map.Entry[DeserializedPropertyDescriptor]

'result' @ [387:13] ==> val result: LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections.filterKeys[LocalVariableDescriptor]

'put' @ [387:20] ==> public open fun put(key: K, value: V): V? defined in java.util.LinkedHashMap[JavaMethodDescriptor]

'entry' @ [387:24] ==> val entry: Map.Entry<K, V> defined in kotlin.collections.filterKeys[LocalVariableDescriptor]

'key' @ [387:30] ==> public abstract val key: K defined in kotlin.collections.Map.Entry[DeserializedPropertyDescriptor]

'entry' @ [387:35] ==> val entry: Map.Entry<K, V> defined in kotlin.collections.filterKeys[LocalVariableDescriptor]

'value' @ [387:41] ==> public abstract val value: V defined in kotlin.collections.Map.Entry[DeserializedPropertyDescriptor]

'result' @ [390:12] ==> val result: LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections.filterKeys[LocalVariableDescriptor]

'LinkedHashMap' @ [399:18] ==> public final fun <K, V> <init>(): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections.LinkedHashMap[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'value' @ [401:29] ==> public abstract val value: V defined in kotlin.collections.Map.Entry[DeserializedPropertyDescriptor]

'result' @ [402:13] ==> val result: LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections.filterValues[LocalVariableDescriptor]

'put' @ [402:20] ==> public open fun put(key: K, value: V): V? defined in java.util.LinkedHashMap[JavaMethodDescriptor]

'entry' @ [402:24] ==> val entry: Map.Entry<K, V> defined in kotlin.collections.filterValues[LocalVariableDescriptor]

'key' @ [402:30] ==> public abstract val key: K defined in kotlin.collections.Map.Entry[DeserializedPropertyDescriptor]

'entry' @ [402:35] ==> val entry: Map.Entry<K, V> defined in kotlin.collections.filterValues[LocalVariableDescriptor]

'value' @ [402:41] ==> public abstract val value: V defined in kotlin.collections.Map.Entry[DeserializedPropertyDescriptor]

'result' @ [405:12] ==> val result: LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections.filterValues[LocalVariableDescriptor]
...
'put' @ [417:25] ==> public abstract fun put(key: K, value: V): Any? defined in kotlin.collections.MutableMap[DeserializedSimpleFunctionDescriptor]

'element' @ [417:29] ==> val element: Map.Entry<K, V> defined in kotlin.collections.filterTo[LocalVariableDescriptor]

'key' @ [417:37] ==> public abstract val key: K defined in kotlin.collections.Map.Entry[DeserializedPropertyDescriptor]

'element' @ [417:42] ==> val element: Map.Entry<K, V> defined in kotlin.collections.filterTo[LocalVariableDescriptor]

'value' @ [417:50] ==> public abstract val value: V defined in kotlin.collections.Map.Entry[DeserializedPropertyDescriptor]

'destination' @ [420:12] ==> value-parameter destination: M defined in kotlin.collections.filterTo[ValueParameterDescriptorImpl]

'filterTo' @ [429:12] ==> public inline fun <K, V, M : MutableMap<in K, in V>> Map<out K, V>.filterTo(destination: LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */, predicate: (Map.Entry<K, V>) -> Boolean): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
    <M : MutableMap<in K, in V>> -> LinkedHashMap<K, V>

'LinkedHashMap' @ [429:21] ==> public final fun <K, V> <init>(): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections.LinkedHashMap[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'put' @ [440:25] ==> public abstract fun put(key: K, value: V): Any? defined in kotlin.collections.MutableMap[DeserializedSimpleFunctionDescriptor]

'element' @ [440:29] ==> val element: Map.Entry<K, V> defined in kotlin.collections.filterNotTo[LocalVariableDescriptor]

'key' @ [440:37] ==> public abstract val key: K defined in kotlin.collections.Map.Entry[DeserializedPropertyDescriptor]

'element' @ [440:42] ==> val element: Map.Entry<K, V> defined in kotlin.collections.filterNotTo[LocalVariableDescriptor]

'value' @ [440:50] ==> public abstract val value: V defined in kotlin.collections.Map.Entry[DeserializedPropertyDescriptor]

'destination' @ [443:12] ==> value-parameter destination: M defined in kotlin.collections.filterNotTo[ValueParameterDescriptorImpl]

'filterNotTo' @ [452:12] ==> public inline fun <K, V, M : MutableMap<in K, in V>> Map<out K, V>.filterNotTo(destination: LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */, predicate: (Map.Entry<K, V>) -> Boolean): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
    <M : MutableMap<in K, in V>> -> LinkedHashMap<K, V>

'LinkedHashMap' @ [452:24] ==> public final fun <K, V> <init>(): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections.LinkedHashMap[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'size' @ [462:22] ==> public abstract val size: Int defined in kotlin.collections.Collection[DeserializedPropertyDescriptor]
...
'mapOf' @ [464:18] ==> @JvmVersion public fun <K, V> mapOf(pair: Pair<K, V>): Map<K, V> defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'iterator' @ [464:55] ==> public abstract operator fun iterator(): Iterator<Pair<K, V>> defined in kotlin.collections.Iterable[DeserializedSimpleFunctionDescriptor]

'next' @ [464:66] ==> public abstract operator fun next(): Pair<K, V> defined in kotlin.collections.Iterator[DeserializedSimpleFunctionDescriptor]

'toMap' @ [465:21] ==> public fun <K, V, M : MutableMap<in K, in V>> Iterable<Pair<K, V>>.toMap(destination: LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
    <M : MutableMap<in K, in V>> -> LinkedHashMap<K, V>

'LinkedHashMap' @ [465:27] ==> public final fun <K, V> <init>(p0: Int): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections.LinkedHashMap[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'size' @ [465:59] ==> public abstract val size: Int defined in kotlin.collections.Collection[DeserializedPropertyDescriptor]

'toMap' @ [468:12] ==> public fun <K, V, M : MutableMap<in K, in V>> Iterable<Pair<K, V>>.toMap(destination: LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
    <M : MutableMap<in K, in V>> -> LinkedHashMap<K, V>

'LinkedHashMap' @ [468:18] ==> public final fun <K, V> <init>(): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections.LinkedHashMap[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'mapOf' @ [484:10] ==> @JvmVersion public fun <K, V> mapOf(pair: Pair<K, V>): Map<K, V> defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'toMap' @ [485:13] ==> public fun <K, V, M : MutableMap<in K, in V>> Array<out Pair<K, V>>.toMap(destination: LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
    <M : MutableMap<in K, in V>> -> LinkedHashMap<K, V>

'LinkedHashMap' @ [485:19] ==> public final fun <K, V> <init>(p0: Int): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections.LinkedHashMap[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'toMap' @ [499:61] ==> public fun <K, V, M : MutableMap<in K, in V>> Sequence<Pair<K, V>>.toMap(destination: LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
    <M : MutableMap<in K, in V>> -> LinkedHashMap<K, V>

'LinkedHashMap' @ [499:67] ==> public final fun <K, V> <init>(): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections.LinkedHashMap[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'size' @ [513:60] ==> public abstract val size: Int defined in kotlin.collections.Map[DeserializedPropertyDescriptor]
...
'toSingletonMap' @ [515:10] ==> @JvmVersion internal fun <K, V> Map<out K, V>.toSingletonMap(): Map<K, V> defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'LinkedHashMap' @ [525:68] ==> public final fun <K, V> <init>(p0: (MutableMap<out (K..K?), out (V..V?)>..Map<out (K..K?), (V..V?)>?)): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections.LinkedHashMap[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'putAll' @ [532:31] ==> public abstract fun putAll(from: Map<out K, V>): Unit defined in kotlin.collections.MutableMap[DeserializedSimpleFunctionDescriptor]
...
'isEmpty' @ [541:20] ==> public abstract fun isEmpty(): Boolean defined in kotlin.collections.Map[DeserializedSimpleFunctionDescriptor]

'mapOf' @ [541:31] ==> @JvmVersion public fun <K, V> mapOf(pair: Pair<K, V>): Map<K, V> defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'LinkedHashMap' @ [541:48] ==> public final fun <K, V> <init>(p0: (MutableMap<out (K..K?), out (V..V?)>..Map<out (K..K?), (V..V?)>?)): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections.LinkedHashMap[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'apply' @ [541:74] ==> @InlineOnly public inline fun <T> LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */.apply(block: LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */.() -> Unit): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> LinkedHashMap<K, V>

'put' @ [541:82] ==> public open fun put(key: K, value: V): V? defined in java.util.LinkedHashMap[JavaMethodDescriptor]
...
'isEmpty' @ [550:20] ==> public abstract fun isEmpty(): Boolean defined in kotlin.collections.Map[DeserializedSimpleFunctionDescriptor]
...
'LinkedHashMap' @ [550:50] ==> public final fun <K, V> <init>(p0: (MutableMap<out (K..K?), out (V..V?)>..Map<out (K..K?), (V..V?)>?)): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections.LinkedHashMap[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'apply' @ [550:76] ==> @InlineOnly public inline fun <T> LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */.apply(block: LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */.() -> Unit): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> LinkedHashMap<K, V>
...
'isEmpty' @ [559:20] ==> public abstract fun isEmpty(): Boolean defined in kotlin.collections.Map[DeserializedSimpleFunctionDescriptor]
...
'LinkedHashMap' @ [559:50] ==> public final fun <K, V> <init>(p0: (MutableMap<out (K..K?), out (V..V?)>..Map<out (K..K?), (V..V?)>?)): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections.LinkedHashMap[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'apply' @ [559:76] ==> @InlineOnly public inline fun <T> LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */.apply(block: LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */.() -> Unit): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> LinkedHashMap<K, V>
...
'LinkedHashMap' @ [568:11] ==> public final fun <K, V> <init>(p0: (MutableMap<out (K..K?), out (V..V?)>..Map<out (K..K?), (V..V?)>?)): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections.LinkedHashMap[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'apply' @ [568:37] ==> @InlineOnly public inline fun <T> LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */.apply(block: LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */.() -> Unit): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> LinkedHashMap<K, V>
...
'LinkedHashMap' @ [577:11] ==> public final fun <K, V> <init>(p0: (MutableMap<out (K..K?), out (V..V?)>..Map<out (K..K?), (V..V?)>?)): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin.collections.LinkedHashMap[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'apply' @ [577:37] ==> @InlineOnly public inline fun <T> LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */.apply(block: LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */.() -> Unit): LinkedHashMap<K, V> /* = LinkedHashMap<K, V> */ defined in kotlin[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> LinkedHashMap<K, V>

'putAll' @ [577:45] ==> public open fun putAll(from: Map<out K, V>): Unit defined in java.util.LinkedHashMap[JavaMethodDescriptor]
...
'put' @ [585:5] ==> public abstract fun put(key: K, value: V): Any? defined in kotlin.collections.MutableMap[DeserializedSimpleFunctionDescriptor]
...
'putAll' @ [617:5] ==> public abstract fun putAll(from: Map<out K, V>): Unit defined in kotlin.collections.MutableMap[DeserializedSimpleFunctionDescriptor]
...
'remove' @ [665:5] ==> public abstract fun remove(key: K): V? defined in kotlin.collections.MutableMap[DeserializedSimpleFunctionDescriptor]
...
'keys' @ [674:10] ==> public abstract val keys: MutableSet<K> defined in kotlin.collections.MutableMap[DeserializedPropertyDescriptor]
...
'keys' @ [683:10] ==> public abstract val keys: MutableSet<K> defined in kotlin.collections.MutableMap[DeserializedPropertyDescriptor]
...
'keys' @ [692:10] ==> public abstract val keys: MutableSet<K> defined in kotlin.collections.MutableMap[DeserializedPropertyDescriptor]
...
'size' @ [697:61] ==> public abstract val size: Int defined in kotlin.collections.Map[DeserializedPropertyDescriptor]
...
'toSingletonMapOrSelf' @ [699:10] ==> @JvmVersion @InlineOnly internal inline fun <K, V> Map<K, V>.toSingletonMapOrSelf(): Map<K, V> defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'kotlin.jvm.JvmVersion' @ [704:1] ==> public constructor JvmVersion(minimum: Int = ..., maximum: Int = ...) defined in kotlin.jvm.JvmVersion[ClassConstructorDescriptorImpl]

'kotlin.internal.InlineOnly' @ [705:1] ==> public constructor InlineOnly() defined in kotlin.internal.InlineOnly[ClassConstructorDescriptorImpl]

'toSingletonMap' @ [706:74] ==> @JvmVersion internal fun <K, V> Map<out K, V>.toSingletonMap(): Map<K, V> defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> K
    <V> -> V
...
'iterator' @ [711:21] ==> public abstract fun iterator(): Iterator<Map.Entry<K, V>> defined in kotlin.collections.Set[DeserializedSimpleFunctionDescriptor]

'next' @ [711:32] ==> public abstract operator fun next(): Map.Entry<K, V> defined in kotlin.collections.Iterator[DeserializedSimpleFunctionDescriptor]

'singletonMap' @ [711:64] ==> public open fun <K : (Any..Any?), V : (Any..Any?)> singletonMap(p0: (K..K?), p1: (V..V?)): (MutableMap<(K..K?), (V..V?)>..Map<(K..K?), (V..V?)>?) defined in java.util.Collections[JavaMethodDescriptor]
Inferred types:
    <K : (Any..Any?)> -> K
    <V : (Any..Any?)> -> V

'key' @ [711:83] ==> public abstract val key: K defined in kotlin.collections.Map.Entry[DeserializedPropertyDescriptor]

'value' @ [711:88] ==> public abstract val value: V defined in kotlin.collections.Map.Entry[DeserializedPropertyDescriptor]
