'kotlin.jvm.JvmMultifileClass' @ [16:1] ==> public constructor JvmMultifileClass() defined in kotlin.jvm.JvmMultifileClass[DeserializedClassConstructorDescriptor]
...
'toHashSet' @ [60:60] ==> public fun <T> Iterable<T>.toHashSet(): HashSet<T> /* = HashSet<T> */ defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> T

'this' @ [60:77] ==> <this> defined in kotlin.collections.convertToSetForSetOperationWith[ReceiverParameterDescriptorImpl]

'toHashSet' @ [62:21] ==> public fun <T> Iterable<T>.toHashSet(): HashSet<T> /* = HashSet<T> */ defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> T
...
'toHashSet' @ [69:61] ==> public fun <T> Iterable<T>.toHashSet(): HashSet<T> /* = HashSet<T> */ defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> T

'this' @ [69:78] ==> <this> defined in kotlin.collections.convertToSetForSetOperation[ReceiverParameterDescriptorImpl]

'toHashSet' @ [70:21] ==> public fun <T> Iterable<T>.toHashSet(): HashSet<T> /* = HashSet<T> */ defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> T

'ArrayList' @ [78:18] ==> public final fun <E> <init>(): ArrayList<T> /* = ArrayList<T> */ defined in kotlin.collections.ArrayList[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <E> -> T

'this' @ [79:21] ==> <this> defined in kotlin.collections.flatten[ReceiverParameterDescriptorImpl]

'result' @ [80:9] ==> val result: ArrayList<T> /* = ArrayList<T> */ defined in kotlin.collections.flatten[LocalVariableDescriptor]
...
'result' @ [82:12] ==> val result: ArrayList<T> /* = ArrayList<T> */ defined in kotlin.collections.flatten[LocalVariableDescriptor]
...
'ArrayList' @ [92:17] ==> public final fun <E> <init>(p0: Int): ArrayList<T> /* = ArrayList<T> */ defined in kotlin.collections.ArrayList[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <E> -> T

'expectedSize' @ [92:30] ==> val expectedSize: Int defined in kotlin.collections.unzip[LocalVariableDescriptor]

'ArrayList' @ [93:17] ==> public final fun <E> <init>(p0: Int): ArrayList<R> /* = ArrayList<R> */ defined in kotlin.collections.ArrayList[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <E> -> R
...
'listT' @ [95:9] ==> val listT: ArrayList<T> /* = ArrayList<T> */ defined in kotlin.collections.unzip[LocalVariableDescriptor]

'add' @ [95:15] ==> public open fun add(element: T): Boolean defined in java.util.ArrayList[JavaMethodDescriptor]
...
'listR' @ [96:9] ==> val listR: ArrayList<R> /* = ArrayList<R> */ defined in kotlin.collections.unzip[LocalVariableDescriptor]

'add' @ [96:15] ==> public open fun add(element: R): Boolean defined in java.util.ArrayList[JavaMethodDescriptor]
...
'listT' @ [98:12] ==> val listT: ArrayList<T> /* = ArrayList<T> */ defined in kotlin.collections.unzip[LocalVariableDescriptor]

'listR' @ [98:21] ==> val listR: ArrayList<R> /* = ArrayList<R> */ defined in kotlin.collections.unzip[LocalVariableDescriptor]
