...
'JvmField' @ [9:5] ==> public constructor JvmField() defined in kotlin.jvm.JvmField[DeserializedClassConstructorDescriptor]

'!!' @ [10:26] ==> public final fun <`<TYPE-PARAMETER-FOR-EXCLEXCL-RESOLVE>`> `<SPECIAL-FUNCTION-FOR-EXCLEXCL-RESOLVE>`(baseExpr: String?): String[SimpleFunctionDescriptorImpl]
Inferred types:
    <`<TYPE-PARAMETER-FOR-EXCLEXCL-RESOLVE>`> -> String

'getProperty' @ [10:33] ==> public open fun getProperty(p0: (String..String?)): (String..String?) defined in java.lang.System[JavaMethodDescriptor]
...
'append' @ [18:75] ==> public abstract fun append(p0: (CharSequence..CharSequence?)): (Appendable..Appendable?) defined in java.lang.Appendable[JavaMethodDescriptor]
...
'append' @ [22:66] ==> public abstract fun append(p0: Char): (Appendable..Appendable?) defined in java.lang.Appendable[JavaMethodDescriptor]
...
'append' @ [29:81] ==> public open fun append(p0: (StringBuffer..StringBuffer?)): (StringBuilder..StringBuilder?) defined in java.lang.StringBuilder[JavaMethodDescriptor]
...
'append' @ [33:81] ==> public open fun append(p0: (CharSequence..CharSequence?)): (StringBuilder..StringBuilder?) defined in java.lang.StringBuilder[JavaMethodDescriptor]
...
'append' @ [37:75] ==> public open fun append(p0: (String..String?)): (StringBuilder..StringBuilder?) defined in java.lang.StringBuilder[JavaMethodDescriptor]
...
'append' @ [41:72] ==> public open fun append(p0: (Any..Any?)): (StringBuilder..StringBuilder?) defined in java.lang.StringBuilder[JavaMethodDescriptor]
...
'append' @ [45:82] ==> public open fun append(p0: (CharSequence..CharSequence?)): (StringBuilder..StringBuilder?) defined in java.lang.StringBuilder[JavaMethodDescriptor]
...
'append' @ [49:77] ==> public open fun append(p0: (CharArray..CharArray?)): (StringBuilder..StringBuilder?) defined in java.lang.StringBuilder[JavaMethodDescriptor]
...
'append' @ [53:72] ==> public open fun append(p0: Char): (StringBuilder..StringBuilder?) defined in java.lang.StringBuilder[JavaMethodDescriptor]
...
'append' @ [57:75] ==> public open fun append(p0: Boolean): (StringBuilder..StringBuilder?) defined in java.lang.StringBuilder[JavaMethodDescriptor]
...
'append' @ [61:71] ==> public open fun append(p0: Int): (StringBuilder..StringBuilder?) defined in java.lang.StringBuilder[JavaMethodDescriptor]
...
'append' @ [65:73] ==> public open fun append(p0: Int): (StringBuilder..StringBuilder?) defined in java.lang.StringBuilder[JavaMethodDescriptor]

'value' @ [65:80] ==> value-parameter value: Short defined in kotlin.text.appendln[ValueParameterDescriptorImpl]
...
'append' @ [69:72] ==> public open fun append(p0: Int): (StringBuilder..StringBuilder?) defined in java.lang.StringBuilder[JavaMethodDescriptor]

'value' @ [69:79] ==> value-parameter value: Byte defined in kotlin.text.appendln[ValueParameterDescriptorImpl]
...
'append' @ [73:72] ==> public open fun append(p0: Long): (StringBuilder..StringBuilder?) defined in java.lang.StringBuilder[JavaMethodDescriptor]
...
'append' @ [77:73] ==> public open fun append(p0: Float): (StringBuilder..StringBuilder?) defined in java.lang.StringBuilder[JavaMethodDescriptor]
...
'append' @ [81:74] ==> public open fun append(p0: Double): (StringBuilder..StringBuilder?) defined in java.lang.StringBuilder[JavaMethodDescriptor]
