...
'size' @ [23:45] ==> public abstract val size: Int defined in kotlin.collections.List[DeserializedPropertyDescriptor]
...
'size' @ [28:45] ==> public abstract val size: Int defined in kotlin.collections.MutableList[DeserializedPropertyDescriptor]
...
'clear' @ [31:37] ==> public abstract fun clear(): Unit defined in kotlin.collections.MutableList[DeserializedSimpleFunctionDescriptor]
...
'removeAt' @ [32:53] ==> public abstract fun removeAt(index: Int): T defined in kotlin.collections.MutableList[DeserializedSimpleFunctionDescriptor]
...
'set' @ [34:60] ==> public abstract operator fun set(index: Int, element: T): T defined in kotlin.collections.MutableList[DeserializedSimpleFunctionDescriptor]
...
'add' @ [36:18] ==> public abstract fun add(index: Int, element: T): Unit defined in kotlin.collections.MutableList[DeserializedSimpleFunctionDescriptor]
...
'IndexOutOfBoundsException' @ [40:65] ==> public final fun <init>(p0: (String..String?)): IndexOutOfBoundsException /* = IndexOutOfBoundsException */ defined in kotlin.IndexOutOfBoundsException[TypeAliasConstructorDescriptorImpl]
...
'size' @ [43:25] ==> public abstract val size: Int defined in kotlin.collections.List[DeserializedPropertyDescriptor]
...
'IndexOutOfBoundsException' @ [43:55] ==> public final fun <init>(p0: (String..String?)): IndexOutOfBoundsException /* = IndexOutOfBoundsException */ defined in kotlin.IndexOutOfBoundsException[TypeAliasConstructorDescriptorImpl]
...
'size' @ [43:127] ==> public abstract val size: Int defined in kotlin.collections.List[DeserializedPropertyDescriptor]
...
'kotlin.jvm.JvmName' @ [56:1] ==> public constructor JvmName(name: String) defined in kotlin.jvm.JvmName[DeserializedClassConstructorDescriptor]
