...
'indexOfFirst' @ [33:44] ==> public inline fun CharSequence.indexOfFirst(predicate: (Char) -> Boolean): Int defined in kotlin.text in file _Strings.kt[SimpleFunctionDescriptorImpl]
...
'isWhitespace' @ [33:63] ==> public fun Char.isWhitespace(): Boolean defined in kotlin.text in file CharJVM.kt[SimpleFunctionDescriptorImpl]
...
'startsWith' @ [37:18] ==> public fun String.startsWith(prefix: String, startIndex: Int, ignoreCase: Boolean = ...): Boolean defined in kotlin.text in file StringsJVM.kt[SimpleFunctionDescriptorImpl]
...
'substring' @ [37:76] ==> @InlineOnly public inline fun String.substring(startIndex: Int): String defined in kotlin.text in file StringsJVM.kt[SimpleFunctionDescriptorImpl]
...
'drop' @ [71:112] ==> public fun String.drop(n: Int): String defined in kotlin.text in file _Strings.kt[SimpleFunctionDescriptorImpl]
...
'isBlank' @ [83:16] ==> public fun CharSequence.isBlank(): Boolean defined in kotlin.text in file StringsJVM.kt[SimpleFunctionDescriptorImpl]
...
'indexOfFirst' @ [94:41] ==> public inline fun CharSequence.indexOfFirst(predicate: (Char) -> Boolean): Int defined in kotlin.text in file _Strings.kt[SimpleFunctionDescriptorImpl]
...
'isWhitespace' @ [94:60] ==> public fun Char.isWhitespace(): Boolean defined in kotlin.text in file CharJVM.kt[SimpleFunctionDescriptorImpl]
...
'isBlank' @ [104:61] ==> public fun CharSequence.isBlank(): Boolean defined in kotlin.text in file StringsJVM.kt[SimpleFunctionDescriptorImpl]
...
'joinTo' @ [109:10] ==> public fun <T, A : Appendable /* = Appendable */> Iterable<String>.joinTo(buffer: StringBuilder /* = StringBuilder */, separator: CharSequence = ..., prefix: CharSequence = ..., postfix: CharSequence = ..., limit: Int = ..., truncated: CharSequence = ..., transform: ((String) -> CharSequence)? = ...): StringBuilder /* = StringBuilder */ defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> String
    <A : Appendable /* = Appendable */> -> StringBuilder

'StringBuilder' @ [109:17] ==> public final fun <init>(p0: Int): StringBuilder /* = StringBuilder */ defined in kotlin.text.StringBuilder[TypeAliasConstructorDescriptorImpl]
...
'toString' @ [110:10] ==> public open fun toString(): String defined in java.lang.StringBuilder[JavaMethodDescriptor]
