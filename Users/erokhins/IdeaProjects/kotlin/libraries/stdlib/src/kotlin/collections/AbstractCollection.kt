...
'any' @ [28:66] ==> public inline fun <T> Iterable<E>.any(predicate: (E) -> Boolean): Boolean defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> E
...
'all' @ [31:22] ==> public inline fun <T> Iterable<@UnsafeVariance E>.all(predicate: (@UnsafeVariance E) -> Boolean): Boolean defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
...
'copyToArrayImpl' @ [42:49] ==> @JvmVersion @InlineOnly internal inline fun copyToArrayImpl(collection: Collection<*>): Array<Any?> defined in kotlin.collections in file Collections.kt[SimpleFunctionDescriptorImpl]

'this' @ [42:65] ==> <this> defined in kotlin.collections.AbstractCollection[LazyClassReceiverParameterDescriptor]

'copyToArrayImpl' @ [48:65] ==> @JvmVersion @InlineOnly internal inline fun <T> copyToArrayImpl(collection: Collection<*>, array: Array<T>): Array<T> defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> T
