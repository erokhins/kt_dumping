...
'copyToArrayImpl' @ [42:49] ==> @JvmVersion @InlineOnly internal inline fun copyToArrayImpl(collection: Collection<*>): Array<Any?> defined in kotlin.collections[SimpleFunctionDescriptorImpl]
