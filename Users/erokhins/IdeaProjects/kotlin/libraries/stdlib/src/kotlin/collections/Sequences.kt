...
'kotlin.jvm.JvmVersion' @ [28:1] ==> public constructor JvmVersion(minimum: Int = ..., maximum: Int = ...) defined in kotlin.jvm.JvmVersion[ClassConstructorDescriptorImpl]
...
'this' @ [30:75] ==> <this> defined in kotlin.sequences.asSequence[ReceiverParameterDescriptorImpl]

'iterator' @ [30:80] ==> @JvmVersion public operator fun <T> Enumeration<T>.iterator(): Iterator<T> defined in kotlin.collections[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> T

'asSequence' @ [30:91] ==> public fun <T> Iterator<T>.asSequence(): Sequence<T> defined in kotlin.sequences[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> T
...
'kotlin.jvm.JvmName' @ [62:1] ==> public constructor JvmName(name: String) defined in kotlin.jvm.JvmName[DeserializedClassConstructorDescriptor]
...
'ArrayList' @ [80:17] ==> public final fun <E> <init>(): ArrayList<T> /* = ArrayList<T> */ defined in kotlin.collections.ArrayList[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <E> -> T

'ArrayList' @ [81:17] ==> public final fun <E> <init>(): ArrayList<R> /* = ArrayList<R> */ defined in kotlin.collections.ArrayList[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <E> -> R

'this' @ [82:18] ==> <this> defined in kotlin.sequences.unzip[ReceiverParameterDescriptorImpl]

'listT' @ [83:9] ==> val listT: ArrayList<T> /* = ArrayList<T> */ defined in kotlin.sequences.unzip[LocalVariableDescriptor]

'add' @ [83:15] ==> public open fun add(element: T): Boolean defined in java.util.ArrayList[JavaMethodDescriptor]
...
'listR' @ [84:9] ==> val listR: ArrayList<R> /* = ArrayList<R> */ defined in kotlin.sequences.unzip[LocalVariableDescriptor]

'add' @ [84:15] ==> public open fun add(element: R): Boolean defined in java.util.ArrayList[JavaMethodDescriptor]
...
'listT' @ [86:12] ==> val listT: ArrayList<T> /* = ArrayList<T> */ defined in kotlin.sequences.unzip[LocalVariableDescriptor]

'listR' @ [86:21] ==> val listR: ArrayList<R> /* = ArrayList<R> */ defined in kotlin.sequences.unzip[LocalVariableDescriptor]
...
'NoSuchElementException' @ [122:23] ==> public final fun <init>(): NoSuchElementException /* = NoSuchElementException */ defined in kotlin.NoSuchElementException[TypeAliasConstructorDescriptorImpl]
...
'NoSuchElementException' @ [235:23] ==> public final fun <init>(): NoSuchElementException /* = NoSuchElementException */ defined in kotlin.NoSuchElementException[TypeAliasConstructorDescriptorImpl]
...
'NoSuchElementException' @ [314:23] ==> public final fun <init>(): NoSuchElementException /* = NoSuchElementException */ defined in kotlin.NoSuchElementException[TypeAliasConstructorDescriptorImpl]
...
'NoSuchElementException' @ [343:23] ==> public final fun <init>(): NoSuchElementException /* = NoSuchElementException */ defined in kotlin.NoSuchElementException[TypeAliasConstructorDescriptorImpl]
...
'NoSuchElementException' @ [383:23] ==> public final fun <init>(): NoSuchElementException /* = NoSuchElementException */ defined in kotlin.NoSuchElementException[TypeAliasConstructorDescriptorImpl]
...
'HashSet' @ [493:28] ==> public final fun <E> <init>(): HashSet<K> /* = HashSet<K> */ defined in kotlin.collections.HashSet[TypeAliasConstructorDescriptorImpl]
Inferred types:
    <E> -> K
...
'observed' @ [500:17] ==> private final val observed: HashSet<K> /* = HashSet<K> */ defined in kotlin.sequences.DistinctIterator[PropertyDescriptorImpl]

'add' @ [500:26] ==> public open fun add(element: K): Boolean defined in java.util.HashSet[JavaMethodDescriptor]
...
'NoSuchElementException' @ [526:23] ==> public final fun <init>(): NoSuchElementException /* = NoSuchElementException */ defined in kotlin.NoSuchElementException[TypeAliasConstructorDescriptorImpl]
...
'kotlin.jvm.JvmVersion' @ [555:1] ==> public constructor JvmVersion(minimum: Int = ..., maximum: Int = ...) defined in kotlin.jvm.JvmVersion[ClassConstructorDescriptorImpl]
...
'IllegalStateException' @ [560:61] ==> public final fun <init>(p0: (String..String?)): IllegalStateException /* = IllegalStateException */ defined in kotlin.IllegalStateException[TypeAliasConstructorDescriptorImpl]

'sequence' @ [561:16] ==> val sequence: Sequence<T> defined in kotlin.sequences.ConstrainedOnceSequence.iterator[LocalVariableDescriptor]

'iterator' @ [561:25] ==> public abstract operator fun iterator(): Iterator<T> defined in kotlin.sequences.Sequence[SimpleFunctionDescriptorImpl]
