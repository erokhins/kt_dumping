...
'createCoroutineUnchecked' @ [42:39] ==> @SinceKotlin @JvmVersion public fun <R, T> (suspend SequenceBuilderIterator<T>.() -> Unit).createCoroutineUnchecked(receiver: SequenceBuilderIterator<T>, completion: Continuation<Unit>): Continuation<Unit> defined in kotlin.coroutines.experimental.intrinsics[SimpleFunctionDescriptorImpl]
Inferred types:
...
'isEmpty' @ [81:48] ==> public abstract fun isEmpty(): Boolean defined in kotlin.collections.Collection[DeserializedSimpleFunctionDescriptor]
...
'iterator' @ [82:34] ==> public abstract operator fun iterator(): Iterator<T> defined in kotlin.collections.Iterable[DeserializedSimpleFunctionDescriptor]
...
'hasNext' @ [114:40] ==> public abstract operator fun hasNext(): Boolean defined in kotlin.collections.Iterator[DeserializedSimpleFunctionDescriptor]
...
'Unit' @ [128:25] ==> public object Unit defined in kotlin[FakeCallableDescriptorForObject]
...
'next' @ [137:39] ==> public abstract operator fun next(): T defined in kotlin.collections.Iterator[DeserializedSimpleFunctionDescriptor]
...
'NoSuchElementException' @ [151:31] ==> public final fun <init>(): NoSuchElementException /* = NoSuchElementException */ defined in kotlin.NoSuchElementException[TypeAliasConstructorDescriptorImpl]
...
'NoSuchElementException' @ [155:23] ==> public final fun <init>(): NoSuchElementException /* = NoSuchElementException */ defined in kotlin.NoSuchElementException[TypeAliasConstructorDescriptorImpl]
...
'IllegalStateException' @ [156:25] ==> public final fun <init>(p0: (String..String?)): IllegalStateException /* = IllegalStateException */ defined in kotlin.IllegalStateException[TypeAliasConstructorDescriptorImpl]

'IllegalStateException' @ [157:17] ==> public final fun <init>(p0: (String..String?)): IllegalStateException /* = IllegalStateException */ defined in kotlin.IllegalStateException[TypeAliasConstructorDescriptorImpl]
...
'hasNext' @ [171:23] ==> public abstract operator fun hasNext(): Boolean defined in kotlin.collections.Iterator[DeserializedSimpleFunctionDescriptor]
