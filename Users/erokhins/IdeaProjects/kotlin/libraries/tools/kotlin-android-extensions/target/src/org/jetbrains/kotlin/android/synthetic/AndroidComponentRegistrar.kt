...
'DEFAULT' @ [98:41] ==> public final val DEFAULT: CacheImplementation defined in kotlinx.android.extensions.CacheImplementation.Companion[PropertyDescriptorImpl]
...
'registerService' @ [114:21] ==> public open fun <T : (Any..Any?)> registerService(@NotNull p0: Class<(AndroidLayoutXmlFileManager..AndroidLayoutXmlFileManager?)>, @NotNull p1: AndroidLayoutXmlFileManager): Unit defined in org.jetbrains.kotlin.com.intellij.mock.MockProject[JavaMethodDescriptor]
Inferred types:
