...
'guessByFirstCharacter' @ [33:45] ==> @NotNull public open fun guessByFirstCharacter(@NotNull name: String): Name defined in org.jetbrains.kotlin.name.Name[JavaMethodDescriptor]
...
'ClassId' @ [37:16] ==> public constructor ClassId(@NotNull packageFqName: FqName, @NotNull relativeClassName: FqName, local: Boolean) defined in org.jetbrains.kotlin.name.ClassId[JavaClassConstructorDescriptor]

'fromSegments' @ [37:31] ==> @NotNull public open fun fromSegments(@NotNull names: (MutableList<(String..String?)>..List<(String..String?)>)): FqName defined in org.jetbrains.kotlin.name.FqName[JavaMethodDescriptor]
...
'fromSegments' @ [37:75] ==> @NotNull public open fun fromSegments(@NotNull names: (MutableList<(String..String?)>..List<(String..String?)>)): FqName defined in org.jetbrains.kotlin.name.FqName[JavaMethodDescriptor]
...
'fromSegments' @ [42:23] ==> @NotNull public open fun fromSegments(@NotNull names: (MutableList<(String..String?)>..List<(String..String?)>)): FqName defined in org.jetbrains.kotlin.name.FqName[JavaMethodDescriptor]
