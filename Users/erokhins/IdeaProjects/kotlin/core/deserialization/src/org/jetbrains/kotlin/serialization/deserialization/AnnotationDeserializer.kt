...
'builtIns' @ [42:24] ==> public abstract val builtIns: KotlinBuiltIns defined in org.jetbrains.kotlin.descriptors.ModuleDescriptor[PropertyDescriptorImpl]

'ConstantValueFactory' @ [44:27] ==> public constructor ConstantValueFactory(builtins: KotlinBuiltIns) defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[ClassConstructorDescriptorImpl]
...
'isError' @ [50:53] ==> public open fun isError(@Nullable candidate: DeclarationDescriptor?): Boolean defined in org.jetbrains.kotlin.types.ErrorUtils[JavaMethodDescriptor]
...
'isAnnotationClass' @ [50:97] ==> public open fun isAnnotationClass(@Nullable descriptor: DeclarationDescriptor?): Boolean defined in org.jetbrains.kotlin.resolve.DescriptorUtils[JavaMethodDescriptor]
...
'AnnotationDescriptorImpl' @ [58:16] ==> public constructor AnnotationDescriptorImpl(@NotNull annotationType: KotlinType, @NotNull valueArguments: (MutableMap<(Name..Name?), (ConstantValue<*>..ConstantValue<*>?)>..Map<(Name..Name?), (ConstantValue<*>..ConstantValue<*>?)>), @NotNull source: SourceElement) defined in org.jetbrains.kotlin.descriptors.annotations.AnnotationDescriptorImpl[JavaClassConstructorDescriptor]
...
'createByteValue' @ [76:34] ==> public final fun createByteValue(value: Byte): ByteValue defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[SimpleFunctionDescriptorImpl]
...
'createCharValue' @ [77:34] ==> public final fun createCharValue(value: Char): CharValue defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[SimpleFunctionDescriptorImpl]
...
'createShortValue' @ [78:35] ==> public final fun createShortValue(value: Short): ShortValue defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[SimpleFunctionDescriptorImpl]
...
'createIntValue' @ [79:33] ==> public final fun createIntValue(value: Int): IntValue defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[SimpleFunctionDescriptorImpl]
...
'createLongValue' @ [80:34] ==> public final fun createLongValue(value: Long): LongValue defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[SimpleFunctionDescriptorImpl]
...
'createFloatValue' @ [81:35] ==> public final fun createFloatValue(value: Float): FloatValue defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[SimpleFunctionDescriptorImpl]
...
'createDoubleValue' @ [82:36] ==> public final fun createDoubleValue(value: Double): DoubleValue defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[SimpleFunctionDescriptorImpl]
...
'createBooleanValue' @ [83:37] ==> public final fun createBooleanValue(value: Boolean): BooleanValue defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[SimpleFunctionDescriptorImpl]
...
'createStringValue' @ [85:25] ==> public final fun createStringValue(value: String): StringValue defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[SimpleFunctionDescriptorImpl]
...
'AnnotationValue' @ [95:17] ==> public constructor AnnotationValue(value: AnnotationDescriptor) defined in org.jetbrains.kotlin.resolve.constants.AnnotationValue[ClassConstructorDescriptorImpl]
...
'isArray' @ [98:54] ==> public open fun isArray(@NotNull type: KotlinType): Boolean defined in org.jetbrains.kotlin.builtins.KotlinBuiltIns[JavaMethodDescriptor]
...
'isPrimitiveArray' @ [98:94] ==> public open fun isPrimitiveArray(@NotNull type: KotlinType): Boolean defined in org.jetbrains.kotlin.builtins.KotlinBuiltIns[JavaMethodDescriptor]
...
'getPrimitiveArrayKotlinTypeByPrimitiveKotlinType' @ [104:38] ==> @Nullable public open fun getPrimitiveArrayKotlinTypeByPrimitiveKotlinType(@NotNull kotlinType: KotlinType): SimpleType? defined in org.jetbrains.kotlin.builtins.KotlinBuiltIns[JavaMethodDescriptor]
...
'getArrayType' @ [105:38] ==> @NotNull public open fun getArrayType(@NotNull projectionType: Variance, @NotNull argument: KotlinType): SimpleType defined in org.jetbrains.kotlin.builtins.KotlinBuiltIns[JavaMethodDescriptor]
...
'getArrayType' @ [111:77] ==> @NotNull public open fun getArrayType(@NotNull projectionType: Variance, @NotNull argument: KotlinType): SimpleType defined in org.jetbrains.kotlin.builtins.KotlinBuiltIns[JavaMethodDescriptor]
...
'getArrayElementType' @ [114:52] ==> @NotNull public open fun getArrayElementType(@NotNull arrayType: KotlinType): KotlinType defined in org.jetbrains.kotlin.builtins.KotlinBuiltIns[JavaMethodDescriptor]
...
'createArrayValue' @ [116:25] ==> public final fun createArrayValue(value: List<ConstantValue<*>>, type: KotlinType): ArrayValue defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[SimpleFunctionDescriptorImpl]
...
'type' @ [126:27] ==> public abstract val type: KotlinType defined in org.jetbrains.kotlin.resolve.constants.ConstantValue[PropertyDescriptorImpl]

'isSubtypeOf' @ [126:32] ==> public fun KotlinType.isSubtypeOf(superType: KotlinType): Boolean defined in org.jetbrains.kotlin.types.typeUtil in file TypeUtils.kt[SimpleFunctionDescriptorImpl]
...
'createErrorValue' @ [131:21] ==> public final fun createErrorValue(message: String): ErrorValue defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[SimpleFunctionDescriptorImpl]
...
'getContributedClassifier' @ [139:70] ==> public abstract fun getContributedClassifier(name: Name, location: LookupLocation): ClassifierDescriptor? defined in org.jetbrains.kotlin.resolve.scopes.MemberScope[SimpleFunctionDescriptorImpl]
...
'createEnumValue' @ [141:32] ==> public final fun createEnumValue(enumEntryClass: ClassDescriptor): EnumValue defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[SimpleFunctionDescriptorImpl]
...
'createErrorValue' @ [144:24] ==> public final fun createErrorValue(message: String): ErrorValue defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[SimpleFunctionDescriptorImpl]
...
'findNonGenericClassAcrossDependencies' @ [168:23] ==> public fun ModuleDescriptor.findNonGenericClassAcrossDependencies(classId: ClassId, notFoundClasses: NotFoundClasses): ClassDescriptor defined in org.jetbrains.kotlin.descriptors in file findClassInModule.kt[SimpleFunctionDescriptorImpl]
