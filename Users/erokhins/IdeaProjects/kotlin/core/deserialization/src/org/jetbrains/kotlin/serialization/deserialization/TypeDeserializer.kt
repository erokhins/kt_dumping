...
'createMemoizedFunctionWithNullableValues' @ [38:80] ==> public abstract fun <K, V : Any> createMemoizedFunctionWithNullableValues(compute: (Int) -> ClassDescriptor?): MemoizedFunctionToNullable<Int, ClassDescriptor> defined in org.jetbrains.kotlin.storage.StorageManager[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> Int
...
'createMemoizedFunctionWithNullableValues' @ [42:89] ==> public abstract fun <K, V : Any> createMemoizedFunctionWithNullableValues(compute: (Int) -> ClassifierDescriptor?): MemoizedFunctionToNullable<Int, ClassifierDescriptor> defined in org.jetbrains.kotlin.storage.StorageManager[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> Int
...
'EMPTY' @ [62:85] ==> public final val EMPTY: Annotations defined in org.jetbrains.kotlin.descriptors.annotations.Annotations.Companion[PropertyDescriptorImpl]
...
'EMPTY' @ [73:91] ==> public final val EMPTY: Annotations defined in org.jetbrains.kotlin.descriptors.annotations.Annotations.Companion[PropertyDescriptorImpl]
...
'isError' @ [83:24] ==> public open fun isError(@Nullable candidate: DeclarationDescriptor?): Boolean defined in org.jetbrains.kotlin.types.ErrorUtils[JavaMethodDescriptor]
...
'createErrorTypeWithCustomConstructor' @ [84:31] ==> @NotNull public open fun createErrorTypeWithCustomConstructor(@NotNull debugName: String, @NotNull typeConstructor: TypeConstructor): SimpleType defined in org.jetbrains.kotlin.types.ErrorUtils[JavaMethodDescriptor]
...
'AnnotationWithTarget' @ [89:28] ==> public constructor AnnotationWithTarget(annotation: AnnotationDescriptor, target: AnnotationUseSiteTarget?) defined in org.jetbrains.kotlin.descriptors.annotations.AnnotationWithTarget[ClassConstructorDescriptorImpl]
...
'getAllAnnotations' @ [90:49] ==> public abstract fun getAllAnnotations(): List<AnnotationWithTarget> defined in org.jetbrains.kotlin.descriptors.annotations.Annotations[SimpleFunctionDescriptorImpl]
...
'withAbbreviation' @ [109:27] ==> public fun SimpleType.withAbbreviation(abbreviatedType: SimpleType): SimpleType defined in org.jetbrains.kotlin.types in file SpecialTypes.kt[SimpleFunctionDescriptorImpl]
...
'getClass' @ [120:49] ==> public final fun getClass(classId: ClassId, typeParametersCount: List<Int>): ClassDescriptor defined in org.jetbrains.kotlin.descriptors.NotFoundClasses[SimpleFunctionDescriptorImpl]
...
'createErrorTypeConstructor' @ [127:31] ==> @NotNull public open fun createErrorTypeConstructor(@NotNull debugMessage: String): TypeConstructor defined in org.jetbrains.kotlin.types.ErrorUtils[JavaMethodDescriptor]
...
'createErrorTypeConstructor' @ [132:58] ==> @NotNull public open fun createErrorTypeConstructor(@NotNull debugMessage: String): TypeConstructor defined in org.jetbrains.kotlin.types.ErrorUtils[JavaMethodDescriptor]
...
'createErrorTypeConstructor' @ [135:32] ==> @NotNull public open fun createErrorTypeConstructor(@NotNull debugMessage: String): TypeConstructor defined in org.jetbrains.kotlin.types.ErrorUtils[JavaMethodDescriptor]
...
'KotlinTypeFactory' @ [147:36] ==> public object KotlinTypeFactory defined in org.jetbrains.kotlin.types in file KotlinTypeFactory.kt[FakeCallableDescriptorForObject]

'simpleType' @ [147:54] ==> @JvmStatic public final fun simpleType(annotations: Annotations, constructor: TypeConstructor, arguments: List<TypeProjection>, nullable: Boolean): SimpleType defined in org.jetbrains.kotlin.types.KotlinTypeFactory[SimpleFunctionDescriptorImpl]
...
'isFunctionType' @ [148:42] ==> public val KotlinType.isFunctionType: Boolean defined in org.jetbrains.kotlin.builtins in file functionTypes.kt[PropertyDescriptorImpl]
...
'getSuspendFunction' @ [154:96] ==> @NotNull public open fun getSuspendFunction(parameterCount: Int): ClassDescriptor defined in org.jetbrains.kotlin.builtins.KotlinBuiltIns[JavaMethodDescriptor]
...
'createErrorTypeWithArguments' @ [162:37] ==> @NotNull public open fun createErrorTypeWithArguments(@NotNull debugMessage: String, @NotNull arguments: (MutableList<(TypeProjection..TypeProjection?)>..List<(TypeProjection..TypeProjection?)>)): SimpleType defined in org.jetbrains.kotlin.types.ErrorUtils[JavaMethodDescriptor]
...
'findClassAcrossModuleDependencies' @ [175:46] ==> public fun ModuleDescriptor.findClassAcrossModuleDependencies(classId: ClassId): ClassDescriptor? defined in org.jetbrains.kotlin.descriptors in file findClassInModule.kt[SimpleFunctionDescriptorImpl]
...
'findTypeAliasAcrossModuleDependencies' @ [192:43] ==> public fun ModuleDescriptor.findTypeAliasAcrossModuleDependencies(classId: ClassId): TypeAliasDescriptor? defined in org.jetbrains.kotlin.descriptors in file findClassInModule.kt[SimpleFunctionDescriptorImpl]
...
'TypeBasedStarProjectionImpl' @ [199:17] ==> public constructor TypeBasedStarProjectionImpl(_type: KotlinType) defined in org.jetbrains.kotlin.types.TypeBasedStarProjectionImpl[ClassConstructorDescriptorImpl]
...
'builtIns' @ [199:75] ==> public abstract val builtIns: KotlinBuiltIns defined in org.jetbrains.kotlin.descriptors.ModuleDescriptor[PropertyDescriptorImpl]

'nullableAnyType' @ [199:84] ==> public final val KotlinBuiltIns.nullableAnyType: SimpleType[MyPropertyDescriptor]

'StarProjectionImpl' @ [201:17] ==> public constructor StarProjectionImpl(typeParameter: TypeParameterDescriptor) defined in org.jetbrains.kotlin.types.StarProjectionImpl[ClassConstructorDescriptorImpl]
...
'TypeProjectionImpl' @ [206:24] ==> public constructor TypeProjectionImpl(@NotNull type: KotlinType) defined in org.jetbrains.kotlin.types.TypeProjectionImpl[JavaClassConstructorDescriptor]

'createErrorType' @ [206:54] ==> @NotNull public open fun createErrorType(@NotNull debugMessage: String): SimpleType defined in org.jetbrains.kotlin.types.ErrorUtils[JavaMethodDescriptor]

'TypeProjectionImpl' @ [208:16] ==> public constructor TypeProjectionImpl(@NotNull projection: Variance, @NotNull type: KotlinType) defined in org.jetbrains.kotlin.types.TypeProjectionImpl[JavaClassConstructorDescriptor]
