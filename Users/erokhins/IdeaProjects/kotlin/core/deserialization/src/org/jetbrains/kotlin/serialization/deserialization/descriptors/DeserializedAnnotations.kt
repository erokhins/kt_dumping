...
'createLazyValue' @ [30:47] ==> public abstract fun <T : Any> createLazyValue(computable: () -> List<AnnotationDescriptor>): NotNullLazyValue<List<AnnotationDescriptor>> defined in org.jetbrains.kotlin.storage.StorageManager[SimpleFunctionDescriptorImpl]
Inferred types:
...
'AnnotationWithTarget' @ [36:86] ==> public constructor AnnotationWithTarget(annotation: AnnotationDescriptor, target: AnnotationUseSiteTarget?) defined in org.jetbrains.kotlin.descriptors.annotations.AnnotationWithTarget[ClassConstructorDescriptorImpl]
...
'createLazyValue' @ [52:47] ==> public abstract fun <T : Any> createLazyValue(computable: () -> List<AnnotationWithTarget>): NotNullLazyValue<List<AnnotationWithTarget>> defined in org.jetbrains.kotlin.storage.StorageManager[SimpleFunctionDescriptorImpl]
Inferred types:
...
'component1' @ [57:40] ==> public final operator fun component1(): AnnotationDescriptor defined in org.jetbrains.kotlin.descriptors.annotations.AnnotationWithTarget[SimpleFunctionDescriptorImpl]

'component2' @ [57:52] ==> public final operator fun component2(): AnnotationUseSiteTarget? defined in org.jetbrains.kotlin.descriptors.annotations.AnnotationWithTarget[SimpleFunctionDescriptorImpl]
...
'fqName' @ [57:92] ==> public open val fqName: FqName? defined in org.jetbrains.kotlin.descriptors.annotations.AnnotationDescriptor[PropertyDescriptorImpl]
...
'annotation' @ [57:112] ==> public final val annotation: AnnotationDescriptor defined in org.jetbrains.kotlin.descriptors.annotations.AnnotationWithTarget[PropertyDescriptorImpl]
...
'target' @ [59:104] ==> public final val target: AnnotationUseSiteTarget? defined in org.jetbrains.kotlin.descriptors.annotations.AnnotationWithTarget[PropertyDescriptorImpl]
...
'target' @ [64:53] ==> public final val target: AnnotationUseSiteTarget? defined in org.jetbrains.kotlin.descriptors.annotations.AnnotationWithTarget[PropertyDescriptorImpl]
...
'annotation' @ [64:79] ==> public final val annotation: AnnotationDescriptor defined in org.jetbrains.kotlin.descriptors.annotations.AnnotationWithTarget[PropertyDescriptorImpl]
