...
'fqName' @ [45:51] ==> public abstract val fqName: FqName defined in org.jetbrains.kotlin.descriptors.PackageFragmentDescriptor[PropertyDescriptorImpl]
...
'getAllContributedClassesIfPossible' @ [49:76] ==> public abstract fun getAllContributedClassesIfPossible(packageFqName: FqName): Collection<ClassDescriptor> defined in org.jetbrains.kotlin.descriptors.deserialization.ClassDescriptorFactory[SimpleFunctionDescriptorImpl]
...
'shouldCreateClass' @ [52:94] ==> public abstract fun shouldCreateClass(packageFqName: FqName, name: Name): Boolean defined in org.jetbrains.kotlin.descriptors.deserialization.ClassDescriptorFactory[SimpleFunctionDescriptorImpl]
...
'ClassId' @ [54:46] ==> public constructor ClassId(@NotNull packageFqName: FqName, @NotNull topLevelName: Name) defined in org.jetbrains.kotlin.name.ClassId[JavaClassConstructorDescriptor]
...
'record' @ [58:36] ==> public fun LookupTracker.record(from: LookupLocation, scopeOwner: PackageFragmentDescriptor, name: Name): Unit defined in org.jetbrains.kotlin.incremental in file utils.kt[SimpleFunctionDescriptorImpl]
