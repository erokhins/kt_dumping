'MemberScopeImpl' @ [41:5] ==> public constructor MemberScopeImpl() defined in org.jetbrains.kotlin.resolve.scopes.MemberScopeImpl[ClassConstructorDescriptorImpl]
...
'createLazyValue' @ [44:30] ==> public abstract fun <T : Any> createLazyValue(computable: () -> Map<Name, List<ProtoBuf.Function>>): NotNullLazyValue<Map<Name, List<ProtoBuf.Function>>> defined in org.jetbrains.kotlin.storage.StorageManager[SimpleFunctionDescriptorImpl]
Inferred types:
...
'createLazyValue' @ [48:30] ==> public abstract fun <T : Any> createLazyValue(computable: () -> Map<Name, List<ProtoBuf.Property>>): NotNullLazyValue<Map<Name, List<ProtoBuf.Property>>> defined in org.jetbrains.kotlin.storage.StorageManager[SimpleFunctionDescriptorImpl]
Inferred types:
...
'createLazyValue' @ [52:30] ==> public abstract fun <T : Any> createLazyValue(computable: () -> Map<Name, List<ProtoBuf.TypeAlias>>): NotNullLazyValue<Map<Name, List<ProtoBuf.TypeAlias>>> defined in org.jetbrains.kotlin.storage.StorageManager[SimpleFunctionDescriptorImpl]
Inferred types:
...
'createMemoizedFunction' @ [59:30] ==> public abstract fun <K, V : Any> createMemoizedFunction(compute: (Name) -> Collection<SimpleFunctionDescriptor>): MemoizedFunctionToNotNull<Name, Collection<SimpleFunctionDescriptor>> defined in org.jetbrains.kotlin.storage.StorageManager[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> Name
...
'createMemoizedFunction' @ [61:30] ==> public abstract fun <K, V : Any> createMemoizedFunction(compute: (Name) -> Collection<PropertyDescriptor>): MemoizedFunctionToNotNull<Name, Collection<PropertyDescriptor>> defined in org.jetbrains.kotlin.storage.StorageManager[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> Name
...
'createMemoizedFunctionWithNullableValues' @ [63:30] ==> public abstract fun <K, V : Any> createMemoizedFunctionWithNullableValues(compute: (Name) -> TypeAliasDescriptor?): MemoizedFunctionToNullable<Name, TypeAliasDescriptor> defined in org.jetbrains.kotlin.storage.StorageManager[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> Name
...
'createLazyValue' @ [65:55] ==> public abstract fun <T : Any> createLazyValue(computable: () -> Set<Name>): NotNullLazyValue<Set<Name>> defined in org.jetbrains.kotlin.storage.StorageManager[SimpleFunctionDescriptorImpl]
Inferred types:
    <T : Any> -> Set<Name>
...
'createLazyValue' @ [69:55] ==> public abstract fun <T : Any> createLazyValue(computable: () -> Set<Name>): NotNullLazyValue<Set<Name>> defined in org.jetbrains.kotlin.storage.StorageManager[SimpleFunctionDescriptorImpl]
Inferred types:
    <T : Any> -> Set<Name>
...
'createLazyValue' @ [75:49] ==> public abstract fun <T : Any> createLazyValue(computable: () -> Set<Name>): NotNullLazyValue<Set<Name>> defined in org.jetbrains.kotlin.storage.StorageManager[SimpleFunctionDescriptorImpl]
Inferred types:
    <T : Any> -> Set<Name>
...
'compact' @ [103:28] ==> public fun <T> ArrayList<D>.compact(): List<D> defined in org.jetbrains.kotlin.utils[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> D
...
'addIfNotNull' @ [153:28] ==> public fun <T : Any> MutableCollection<DeclarationDescriptor>.addIfNotNull(t: DeclarationDescriptor?): Unit defined in org.jetbrains.kotlin.utils[SimpleFunctionDescriptorImpl]
Inferred types:
...
'addIfNotNull' @ [161:28] ==> public fun <T : Any> MutableCollection<DeclarationDescriptor>.addIfNotNull(t: DeclarationDescriptor?): Unit defined in org.jetbrains.kotlin.utils[SimpleFunctionDescriptorImpl]
Inferred types:
    <T : Any> -> DeclarationDescriptor
...
'compact' @ [166:23] ==> public fun <T> ArrayList<DeclarationDescriptor>.compact(): List<DeclarationDescriptor> defined in org.jetbrains.kotlin.utils[SimpleFunctionDescriptorImpl]
Inferred types:
...
'println' @ [230:11] ==> @NotNull public open fun println(vararg objects: (Any..Any?)): Printer defined in org.jetbrains.kotlin.utils.Printer[JavaMethodDescriptor]
...
'println' @ [233:11] ==> @NotNull public open fun println(vararg objects: (Any..Any?)): Printer defined in org.jetbrains.kotlin.utils.Printer[JavaMethodDescriptor]
...
'println' @ [236:11] ==> @NotNull public open fun println(vararg objects: (Any..Any?)): Printer defined in org.jetbrains.kotlin.utils.Printer[JavaMethodDescriptor]
