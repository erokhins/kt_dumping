...
'createMemoizedFunction' @ [61:43] ==> public abstract fun <K, V : Any> createMemoizedFunction(compute: (FqName) -> PackageViewDescriptor): MemoizedFunctionToNotNull<FqName, PackageViewDescriptor> defined in org.jetbrains.kotlin.storage.StorageManager[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> FqName
...
'sure' @ [69:35] ==> public inline fun <T : Any> ModuleDependencies?.sure(message: () -> String): ModuleDependencies defined in org.jetbrains.kotlin.utils[SimpleFunctionDescriptorImpl]
Inferred types:
...
'sure' @ [72:35] ==> public inline fun <T : Any> ModuleDependencies?.sure(message: () -> String): ModuleDependencies defined in org.jetbrains.kotlin.utils[SimpleFunctionDescriptorImpl]
Inferred types:
    <T : Any> -> ModuleDependencies
...
'sure' @ [85:47] ==> public inline fun <T : Any> ModuleDependencies?.sure(message: () -> String): ModuleDependencies defined in org.jetbrains.kotlin.utils[SimpleFunctionDescriptorImpl]
Inferred types:
    <T : Any> -> ModuleDependencies
