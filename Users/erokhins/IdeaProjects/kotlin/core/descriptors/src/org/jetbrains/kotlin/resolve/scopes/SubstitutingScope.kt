...
'sure' @ [47:75] ==> public inline fun <T : Any> DeclarationDescriptorNonRoot?.sure(message: () -> String): DeclarationDescriptorNonRoot defined in org.jetbrains.kotlin.utils[SimpleFunctionDescriptorImpl]
Inferred types:
...
'newHashSetWithExpectedSize' @ [63:22] ==> public fun <E> newHashSetWithExpectedSize(expectedSize: Int): HashSet<D> defined in org.jetbrains.kotlin.utils[SimpleFunctionDescriptorImpl]
Inferred types:
    <E> -> D
...
'println' @ [86:11] ==> @NotNull public open fun println(vararg objects: (Any..Any?)): Printer defined in org.jetbrains.kotlin.utils.Printer[JavaMethodDescriptor]
...
'println' @ [89:11] ==> @NotNull public open fun println(vararg objects: (Any..Any?)): Printer defined in org.jetbrains.kotlin.utils.Printer[JavaMethodDescriptor]
...
'print' @ [94:11] ==> @NotNull public open fun print(vararg objects: (Any..Any?)): Printer defined in org.jetbrains.kotlin.utils.Printer[JavaMethodDescriptor]
...
'println' @ [98:11] ==> @NotNull public open fun println(vararg objects: (Any..Any?)): Printer defined in org.jetbrains.kotlin.utils.Printer[JavaMethodDescriptor]
