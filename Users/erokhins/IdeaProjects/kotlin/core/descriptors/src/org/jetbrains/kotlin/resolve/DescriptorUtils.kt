...
'ifAny' @ [193:16] ==> public open fun <N : (Any..Any?)> ifAny(@NotNull nodes: (MutableCollection<(ValueParameterDescriptor..ValueParameterDescriptor?)>..Collection<(ValueParameterDescriptor..ValueParameterDescriptor?)>), @NotNull neighbors: DFS.Neighbors<(ValueParameterDescriptor..ValueParameterDescriptor?)>, @NotNull predicate: ((ValueParameterDescriptor..ValueParameterDescriptor?)) -> (Boolean..Boolean?)): (Boolean..Boolean?) defined in org.jetbrains.kotlin.utils.DFS[JavaMethodDescriptor]
Inferred types:
...
'ifAny' @ [202:81] ==> public final fun <N : (Any..Any?)> ifAny(@NotNull nodes: (MutableCollection<(FunctionDescriptor..FunctionDescriptor?)>..Collection<(FunctionDescriptor..FunctionDescriptor?)>), @NotNull neighbors: (current: (FunctionDescriptor..FunctionDescriptor?)) -> (MutableIterable<(FunctionDescriptor..FunctionDescriptor?)>..Iterable<(FunctionDescriptor..FunctionDescriptor?)>), @NotNull predicate: ((FunctionDescriptor..FunctionDescriptor?)) -> (Boolean..Boolean?)): (Boolean..Boolean?) defined in org.jetbrains.kotlin.utils.DFS[SamAdapterFunctionDescriptor]
Inferred types:
