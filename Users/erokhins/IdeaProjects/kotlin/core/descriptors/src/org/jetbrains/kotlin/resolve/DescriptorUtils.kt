...
'ifAny' @ [202:81] ==> public final fun <N : (Any..Any?)> ifAny(@NotNull nodes: (MutableCollection<(FunctionDescriptor..FunctionDescriptor?)>..Collection<(FunctionDescriptor..FunctionDescriptor?)>), @NotNull neighbors: ((FunctionDescriptor..FunctionDescriptor?)) -> (MutableIterable<(FunctionDescriptor..FunctionDescriptor?)>..Iterable<(FunctionDescriptor..FunctionDescriptor?)>), @NotNull predicate: ((FunctionDescriptor..FunctionDescriptor?)) -> (Boolean..Boolean?)): (Boolean..Boolean?) defined in org.jetbrains.kotlin.utils.DFS[SamAdapterFunctionDescriptor]
Inferred types:
