...
'create' @ [54:27] ==> @JvmStatic public final fun <T> create(): SmartSet<H> defined in org.jetbrains.kotlin.utils.SmartSet.Companion[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> H
...
'create' @ [59:42] ==> @JvmStatic public final fun <T> create(): SmartSet<H> defined in org.jetbrains.kotlin.utils.SmartSet.Companion[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> H
...
'add' @ [62:127] ==> public open fun add(element: H): Boolean defined in org.jetbrains.kotlin.utils.SmartSet[SimpleFunctionDescriptorImpl]
...
'add' @ [65:20] ==> public open fun add(element: H): Boolean defined in org.jetbrains.kotlin.utils.SmartSet[SimpleFunctionDescriptorImpl]
...
'add' @ [80:16] ==> public open fun add(element: H): Boolean defined in org.jetbrains.kotlin.utils.SmartSet[SimpleFunctionDescriptorImpl]
