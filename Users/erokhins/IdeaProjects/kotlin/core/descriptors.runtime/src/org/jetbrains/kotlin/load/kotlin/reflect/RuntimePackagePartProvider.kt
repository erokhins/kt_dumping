...
'MAPPING_FILE_EXT' @ [29:70] ==> @JvmField public final val MAPPING_FILE_EXT: String defined in org.jetbrains.kotlin.load.kotlin.ModuleMapping.Companion[PropertyDescriptorImpl]
...
'create' @ [31:31] ==> public final fun create(bytes: ByteArray?, debugName: String, configuration: DeserializationConfiguration): ModuleMapping defined in org.jetbrains.kotlin.load.kotlin.ModuleMapping.Companion[SimpleFunctionDescriptorImpl]
...
'findPackageParts' @ [42:54] ==> public final fun findPackageParts(packageFqName: String): PackageParts? defined in org.jetbrains.kotlin.load.kotlin.ModuleMapping[SimpleFunctionDescriptorImpl]
...
'parts' @ [42:101] ==> public final val parts: Set<String> defined in org.jetbrains.kotlin.load.kotlin.PackageParts[PropertyDescriptorImpl]
