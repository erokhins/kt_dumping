...
'annotations' @ [47:11] ==> public abstract val annotations: Annotations defined in org.jetbrains.kotlin.types.KotlinType[PropertyDescriptorImpl]

'findAnnotation' @ [47:23] ==> public open fun findAnnotation(fqName: FqName): AnnotationDescriptor? defined in org.jetbrains.kotlin.descriptors.annotations.Annotations[SimpleFunctionDescriptorImpl]
...
'isError' @ [62:9] ==> public val KotlinType.isError: Boolean defined in org.jetbrains.kotlin.types in file KotlinType.kt[PropertyDescriptorImpl]
...
'lowerBound' @ [69:28] ==> public final val lowerBound: SimpleType defined in org.jetbrains.kotlin.types.FlexibleType[PropertyDescriptorImpl]
...
'upperBound' @ [70:28] ==> public final val upperBound: SimpleType defined in org.jetbrains.kotlin.types.FlexibleType[PropertyDescriptorImpl]
...
'getEnhancement' @ [74:48] ==> public fun KotlinType.getEnhancement(): KotlinType? defined in org.jetbrains.kotlin.types in file TypeWithEnhancement.kt[SimpleFunctionDescriptorImpl]
...
'getEnhancement' @ [74:85] ==> public fun KotlinType.getEnhancement(): KotlinType? defined in org.jetbrains.kotlin.types in file TypeWithEnhancement.kt[SimpleFunctionDescriptorImpl]
...
'wrapEnhancement' @ [79:19] ==> public fun UnwrappedType.wrapEnhancement(enhancement: KotlinType?): UnwrappedType defined in org.jetbrains.kotlin.types in file TypeWithEnhancement.kt[SimpleFunctionDescriptorImpl]
...
'arguments' @ [93:27] ==> public abstract val arguments: List<TypeProjection> defined in org.jetbrains.kotlin.types.SimpleType[PropertyDescriptorImpl]
...
'constructor' @ [95:25] ==> public abstract val constructor: TypeConstructor defined in org.jetbrains.kotlin.types.SimpleType[PropertyDescriptorImpl]
...
'arguments' @ [105:29] ==> public abstract val arguments: List<TypeProjection> defined in org.jetbrains.kotlin.types.SimpleType[PropertyDescriptorImpl]
...
'makeStarProjection' @ [109:23] ==> @NotNull public open fun makeStarProjection(@NotNull parameterDescriptor: TypeParameterDescriptor): TypeProjection defined in org.jetbrains.kotlin.types.TypeUtils[JavaMethodDescriptor]
...
'createProjection' @ [115:13] ==> public fun createProjection(type: KotlinType, projectionKind: Variance, typeParameterDescriptor: TypeParameterDescriptor?): TypeProjection defined in org.jetbrains.kotlin.types.typeUtil in file TypeUtils.kt[SimpleFunctionDescriptorImpl]
...
'annotations' @ [126:13] ==> public abstract val annotations: Annotations defined in org.jetbrains.kotlin.types.SimpleType[PropertyDescriptorImpl]
...
'simpleType' @ [131:42] ==> @JvmStatic public final fun simpleType(annotations: Annotations, constructor: TypeConstructor, arguments: List<TypeProjection>, nullable: Boolean): SimpleType defined in org.jetbrains.kotlin.types.KotlinTypeFactory[SimpleFunctionDescriptorImpl]
...
'wrapEnhancement' @ [140:45] ==> public fun UnwrappedType.wrapEnhancement(enhancement: KotlinType?): UnwrappedType defined in org.jetbrains.kotlin.types in file TypeWithEnhancement.kt[SimpleFunctionDescriptorImpl]
...
'CompositeAnnotations' @ [148:13] ==> public constructor CompositeAnnotations(delegates: List<Annotations>) defined in org.jetbrains.kotlin.descriptors.annotations.CompositeAnnotations[ClassConstructorDescriptorImpl]
...
'isMarkedNullable' @ [181:48] ==> public abstract val isMarkedNullable: Boolean defined in org.jetbrains.kotlin.types.KotlinType[PropertyDescriptorImpl]
...
'isMarkedNullable' @ [186:22] ==> public abstract val isMarkedNullable: Boolean defined in org.jetbrains.kotlin.types.KotlinType[PropertyDescriptorImpl]
...
'AnnotationWithTarget' @ [201:51] ==> public constructor AnnotationWithTarget(annotation: AnnotationDescriptor, target: AnnotationUseSiteTarget?) defined in org.jetbrains.kotlin.descriptors.annotations.AnnotationWithTarget[ClassConstructorDescriptorImpl]
...
'DelegatingSimpleType' @ [218:94] ==> public constructor DelegatingSimpleType() defined in org.jetbrains.kotlin.types.DelegatingSimpleType[ClassConstructorDescriptorImpl]
...
'unwrap' @ [224:41] ==> public abstract fun unwrap(): UnwrappedType defined in org.jetbrains.kotlin.types.KotlinType[SimpleFunctionDescriptorImpl]

'!' @ [225:13] ==> public final operator fun not(): Boolean defined in kotlin.Boolean[DeserializedSimpleFunctionDescriptor]

'isNullableType' @ [225:24] ==> public open fun isNullableType(@NotNull type: KotlinType): Boolean defined in org.jetbrains.kotlin.types.TypeUtils[JavaMethodDescriptor]
...
'isTypeParameter' @ [225:72] ==> public fun KotlinType.isTypeParameter(): Boolean defined in org.jetbrains.kotlin.types.typeUtil in file TypeUtils.kt[SimpleFunctionDescriptorImpl]
...
'lowerBound' @ [230:35] ==> public final val lowerBound: SimpleType defined in org.jetbrains.kotlin.types.FlexibleType[PropertyDescriptorImpl]
...
'upperBound' @ [231:35] ==> public final val upperBound: SimpleType defined in org.jetbrains.kotlin.types.FlexibleType[PropertyDescriptorImpl]
...
'wrapEnhancement' @ [232:15] ==> public fun UnwrappedType.wrapEnhancement(enhancement: KotlinType?): UnwrappedType defined in org.jetbrains.kotlin.types in file TypeWithEnhancement.kt[SimpleFunctionDescriptorImpl]
...
'getEnhancement' @ [232:45] ==> public fun KotlinType.getEnhancement(): KotlinType? defined in org.jetbrains.kotlin.types in file TypeWithEnhancement.kt[SimpleFunctionDescriptorImpl]
...
'makeNullableAsSpecified' @ [241:22] ==> public abstract fun makeNullableAsSpecified(newNullability: Boolean): SimpleType defined in org.jetbrains.kotlin.types.SimpleType[SimpleFunctionDescriptorImpl]
...
'isTypeParameter' @ [242:19] ==> public fun KotlinType.isTypeParameter(): Boolean defined in org.jetbrains.kotlin.types.typeUtil in file TypeUtils.kt[SimpleFunctionDescriptorImpl]
...
'replaceAnnotations' @ [247:98] ==> public abstract fun replaceAnnotations(newAnnotations: Annotations): SimpleType defined in org.jetbrains.kotlin.types.SimpleType[SimpleFunctionDescriptorImpl]
...
'makeNullableAsSpecified' @ [249:38] ==> public abstract fun makeNullableAsSpecified(newNullability: Boolean): SimpleType defined in org.jetbrains.kotlin.types.SimpleType[SimpleFunctionDescriptorImpl]
