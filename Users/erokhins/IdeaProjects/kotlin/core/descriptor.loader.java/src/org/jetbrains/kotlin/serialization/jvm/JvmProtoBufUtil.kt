...
'parseFrom' @ [40:41] ==> public open fun parseFrom(input: (InputStream..InputStream?), extensionRegistry: (ExtensionRegistryLite..ExtensionRegistryLite?)): (ProtoBuf.Class..ProtoBuf.Class?) defined in org.jetbrains.kotlin.serialization.ProtoBuf.Class[JavaMethodDescriptor]
...
'ClassData' @ [41:16] ==> public constructor ClassData(nameResolver: NameResolver, classProto: ProtoBuf.Class) defined in org.jetbrains.kotlin.serialization.ClassData[ClassConstructorDescriptorImpl]
...
'parseFrom' @ [50:45] ==> public open fun parseFrom(input: (InputStream..InputStream?), extensionRegistry: (ExtensionRegistryLite..ExtensionRegistryLite?)): (ProtoBuf.Package..ProtoBuf.Package?) defined in org.jetbrains.kotlin.serialization.ProtoBuf.Package[JavaMethodDescriptor]
...
'PackageData' @ [51:16] ==> public constructor PackageData(nameResolver: NameResolver, packageProto: ProtoBuf.Package) defined in org.jetbrains.kotlin.serialization.PackageData[ClassConstructorDescriptorImpl]
...
'getString' @ [64:26] ==> @NotNull public abstract fun getString(index: Int): String defined in org.jetbrains.kotlin.serialization.deserialization.NameResolver[JavaMethodDescriptor]
...
'receiverType' @ [67:54] ==> public fun ProtoBuf.Function.receiverType(typeTable: TypeTable): ProtoBuf.Type? defined in org.jetbrains.kotlin.serialization.deserialization in file protoTypeTableUtil.kt[SimpleFunctionDescriptorImpl]
...
'type' @ [67:115] ==> public fun ProtoBuf.ValueParameter.type(typeTable: TypeTable): ProtoBuf.Type defined in org.jetbrains.kotlin.serialization.deserialization in file protoTypeTableUtil.kt[SimpleFunctionDescriptorImpl]
...
'returnType' @ [70:55] ==> public fun ProtoBuf.Function.returnType(typeTable: TypeTable): ProtoBuf.Type defined in org.jetbrains.kotlin.serialization.deserialization in file protoTypeTableUtil.kt[SimpleFunctionDescriptorImpl]
...
'getString' @ [74:29] ==> @NotNull public abstract fun getString(index: Int): String defined in org.jetbrains.kotlin.serialization.deserialization.NameResolver[JavaMethodDescriptor]
...
'getString' @ [85:26] ==> @NotNull public abstract fun getString(index: Int): String defined in org.jetbrains.kotlin.serialization.deserialization.NameResolver[JavaMethodDescriptor]
...
'type' @ [89:35] ==> public fun ProtoBuf.ValueParameter.type(typeTable: TypeTable): ProtoBuf.Type defined in org.jetbrains.kotlin.serialization.deserialization in file protoTypeTableUtil.kt[SimpleFunctionDescriptorImpl]
...
'getString' @ [107:68] ==> @NotNull public abstract fun getString(index: Int): String defined in org.jetbrains.kotlin.serialization.deserialization.NameResolver[JavaMethodDescriptor]
...
'returnType' @ [108:43] ==> public fun ProtoBuf.Property.returnType(typeTable: TypeTable): ProtoBuf.Type defined in org.jetbrains.kotlin.serialization.deserialization in file protoTypeTableUtil.kt[SimpleFunctionDescriptorImpl]
...
'getString' @ [110:47] ==> @NotNull public abstract fun getString(index: Int): String defined in org.jetbrains.kotlin.serialization.deserialization.NameResolver[JavaMethodDescriptor]
...
'getClassId' @ [116:79] ==> @NotNull public abstract fun getClassId(index: Int): ClassId defined in org.jetbrains.kotlin.serialization.deserialization.NameResolver[JavaMethodDescriptor]
