...
'getVariableNames' @ [55:75] ==> public abstract fun getVariableNames(): Set<Name> defined in org.jetbrains.kotlin.resolve.scopes.MemberScope[SimpleFunctionDescriptorImpl]
...
'createEnumValueOfMethod' @ [71:61] ==> @NotNull public open fun createEnumValueOfMethod(@NotNull enumClass: ClassDescriptor): SimpleFunctionDescriptor defined in org.jetbrains.kotlin.resolve.DescriptorFactory[JavaMethodDescriptor]
...
'createEnumValuesMethod' @ [72:59] ==> @NotNull public open fun createEnumValuesMethod(@NotNull enumClass: ClassDescriptor): SimpleFunctionDescriptor defined in org.jetbrains.kotlin.resolve.DescriptorFactory[JavaMethodDescriptor]
...
'getContributedVariables' @ [79:16] ==> public abstract fun getContributedVariables(name: Name, location: LookupLocation): Collection<PropertyDescriptor> defined in org.jetbrains.kotlin.resolve.scopes.MemberScope[SimpleFunctionDescriptorImpl]
...
'constructor' @ [109:48] ==> public abstract val constructor: TypeConstructor defined in org.jetbrains.kotlin.types.KotlinType[PropertyDescriptorImpl]
