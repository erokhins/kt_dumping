...
'AnnotationDeserializer' @ [47:42] ==> public constructor AnnotationDeserializer(module: ModuleDescriptor, notFoundClasses: NotFoundClasses) defined in org.jetbrains.kotlin.serialization.deserialization.AnnotationDeserializer[ClassConstructorDescriptorImpl]
...
'ConstantValueFactory' @ [48:27] ==> public constructor ConstantValueFactory(builtins: KotlinBuiltIns) defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[ClassConstructorDescriptorImpl]
...
'builtIns' @ [48:55] ==> public abstract val builtIns: KotlinBuiltIns defined in org.jetbrains.kotlin.descriptors.ModuleDescriptor[PropertyDescriptorImpl]
...
'deserializeAnnotation' @ [51:36] ==> public final fun deserializeAnnotation(proto: ProtoBuf.Annotation, nameResolver: NameResolver): AnnotationDescriptor defined in org.jetbrains.kotlin.serialization.deserialization.AnnotationDeserializer[SimpleFunctionDescriptorImpl]
...
'createConstantValue' @ [68:24] ==> public final fun createConstantValue(value: Any?): ConstantValue<*>? defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[SimpleFunctionDescriptorImpl]
...
'AnnotationWithTarget' @ [76:42] ==> public constructor AnnotationWithTarget(annotation: AnnotationDescriptor, target: AnnotationUseSiteTarget?) defined in org.jetbrains.kotlin.descriptors.annotations.AnnotationWithTarget[ClassConstructorDescriptorImpl]
...
'AnnotationWithTarget' @ [77:39] ==> public constructor AnnotationWithTarget(annotation: AnnotationDescriptor, target: AnnotationUseSiteTarget?) defined in org.jetbrains.kotlin.descriptors.annotations.AnnotationWithTarget[ClassConstructorDescriptorImpl]
...
'AnnotationWithTarget' @ [81:34] ==> public constructor AnnotationWithTarget(annotation: AnnotationDescriptor, target: AnnotationUseSiteTarget?) defined in org.jetbrains.kotlin.descriptors.annotations.AnnotationWithTarget[ClassConstructorDescriptorImpl]
...
'createArrayValue' @ [119:55] ==> public final fun createArrayValue(value: List<ConstantValue<*>>, type: KotlinType): ArrayValue defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[SimpleFunctionDescriptorImpl]
...
'compact' @ [119:81] ==> public fun <T> ArrayList<ConstantValue<*>>.compact(): List<ConstantValue<*>> defined in org.jetbrains.kotlin.utils[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> ConstantValue<*>
...
'AnnotationValue' @ [131:43] ==> public constructor AnnotationValue(value: AnnotationDescriptor) defined in org.jetbrains.kotlin.resolve.constants.AnnotationValue[ClassConstructorDescriptorImpl]
...
'getContributedClassifier' @ [140:79] ==> public abstract fun getContributedClassifier(name: Name, location: LookupLocation): ClassifierDescriptor? defined in org.jetbrains.kotlin.resolve.scopes.MemberScope[SimpleFunctionDescriptorImpl]
...
'createEnumValue' @ [142:40] ==> public final fun createEnumValue(enumEntryClass: ClassDescriptor): EnumValue defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[SimpleFunctionDescriptorImpl]
...
'createErrorValue' @ [145:32] ==> public final fun createErrorValue(message: String): ErrorValue defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[SimpleFunctionDescriptorImpl]
...
'createConstantValue' @ [153:32] ==> public final fun createConstantValue(value: Any?): ConstantValue<*>? defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[SimpleFunctionDescriptorImpl]
...
'createErrorValue' @ [154:32] ==> public final fun createErrorValue(message: String): ErrorValue defined in org.jetbrains.kotlin.resolve.constants.ConstantValueFactory[SimpleFunctionDescriptorImpl]
...
'findNonGenericClassAcrossDependencies' @ [160:23] ==> public fun ModuleDescriptor.findNonGenericClassAcrossDependencies(classId: ClassId, notFoundClasses: NotFoundClasses): ClassDescriptor defined in org.jetbrains.kotlin.descriptors in file findClassInModule.kt[SimpleFunctionDescriptorImpl]
