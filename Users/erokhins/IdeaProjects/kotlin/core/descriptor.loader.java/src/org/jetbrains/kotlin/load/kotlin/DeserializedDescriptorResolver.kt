...
'configuration' @ [42:28] ==> public final val configuration: DeserializationConfiguration defined in org.jetbrains.kotlin.serialization.deserialization.DeserializationComponents[PropertyDescriptorImpl]

'skipMetadataVersionCheck' @ [42:42] ==> public open val skipMetadataVersionCheck: Boolean defined in org.jetbrains.kotlin.serialization.deserialization.DeserializationConfiguration[PropertyDescriptorImpl]
...
'classDeserializer' @ [46:27] ==> public final val classDeserializer: ClassDeserializer defined in org.jetbrains.kotlin.serialization.deserialization.DeserializationComponents[PropertyDescriptorImpl]

'deserializeClass' @ [46:45] ==> public final fun deserializeClass(classId: ClassId, classDataWithSource: ClassDataWithSource? = ...): ClassDescriptor? defined in org.jetbrains.kotlin.serialization.deserialization.ClassDeserializer[SimpleFunctionDescriptorImpl]
...
'ClassDataWithSource' @ [56:16] ==> public constructor ClassDataWithSource(classData: ClassData, sourceElement: SourceElement) defined in org.jetbrains.kotlin.serialization.ClassDataWithSource[ClassConstructorDescriptorImpl]
...
'component1' @ [62:14] ==> public final operator fun component1(): NameResolver defined in org.jetbrains.kotlin.serialization.PackageData[SimpleFunctionDescriptorImpl]

'component2' @ [62:28] ==> public final operator fun component2(): ProtoBuf.Package defined in org.jetbrains.kotlin.serialization.PackageData[SimpleFunctionDescriptorImpl]
...
'IncompatibleVersionErrorData' @ [75:20] ==> public constructor IncompatibleVersionErrorData<out T : BinaryVersion>(actualVersion: JvmMetadataVersion, expectedVersion: JvmMetadataVersion, filePath: String, classId: ClassId) defined in org.jetbrains.kotlin.serialization.deserialization.IncompatibleVersionErrorData[ClassConstructorDescriptorImpl]
Inferred types:
