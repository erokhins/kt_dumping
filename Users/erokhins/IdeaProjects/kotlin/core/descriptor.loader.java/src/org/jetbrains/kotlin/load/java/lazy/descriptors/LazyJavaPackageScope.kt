...
'createNullableLazyValue' @ [46:93] ==> public abstract fun <T : Any> createNullableLazyValue(computable: () -> Set<(String..String?)>?): NullableLazyValue<Set<(String..String?)>> defined in org.jetbrains.kotlin.storage.StorageManager[SimpleFunctionDescriptorImpl]
Inferred types:
...
'fqName' @ [47:70] ==> public final val fqName: FqName defined in org.jetbrains.kotlin.load.java.lazy.descriptors.LazyJavaPackageFragment[PropertyDescriptorImpl]
...
'createMemoizedFunctionWithNullableValues' @ [50:44] ==> public abstract fun <K, V : Any> createMemoizedFunctionWithNullableValues(compute: (LazyJavaPackageScope.FindClassRequest) -> ClassDescriptor?): MemoizedFunctionToNullable<LazyJavaPackageScope.FindClassRequest, ClassDescriptor> defined in org.jetbrains.kotlin.storage.StorageManager[SimpleFunctionDescriptorImpl]
Inferred types:
    <K> -> FindClassRequest
    <V : Any> -> ClassDescriptor

'ClassId' @ [51:30] ==> public constructor ClassId(@NotNull packageFqName: FqName, @NotNull topLevelName: Name) defined in org.jetbrains.kotlin.name.ClassId[JavaClassConstructorDescriptor]
...
'fqName' @ [51:54] ==> public final val fqName: FqName defined in org.jetbrains.kotlin.load.java.lazy.descriptors.LazyJavaPackageFragment[PropertyDescriptorImpl]
...
'fqName' @ [84:109] ==> public final val fqName: FqName defined in org.jetbrains.kotlin.load.java.lazy.descriptors.LazyJavaPackageFragment[PropertyDescriptorImpl]
...
'hashCode' @ [117:40] ==> @Override public open fun hashCode(): Int defined in org.jetbrains.kotlin.name.Name[JavaMethodDescriptor]
...
'isSafeIdentifier' @ [123:27] ==> public open fun isSafeIdentifier(@NotNull name: Name): Boolean defined in org.jetbrains.kotlin.name.SpecialNames[JavaMethodDescriptor]
...
'acceptsKinds' @ [141:25] ==> public final fun acceptsKinds(kinds: Int): Boolean defined in org.jetbrains.kotlin.resolve.scopes.DescriptorKindFilter[SimpleFunctionDescriptorImpl]
...
'NON_SINGLETON_CLASSIFIERS_MASK' @ [141:59] ==> public final val NON_SINGLETON_CLASSIFIERS_MASK: Int defined in org.jetbrains.kotlin.resolve.scopes.DescriptorKindFilter.Companion[PropertyDescriptorImpl]
...
'identifier' @ [144:103] ==> @NotNull public open fun identifier(@NotNull name: String): Name defined in org.jetbrains.kotlin.name.Name[JavaMethodDescriptor]
...
'alwaysTrue' @ [146:50] ==> public fun <T> alwaysTrue(): (Name) -> Boolean defined in org.jetbrains.kotlin.utils[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> Name
