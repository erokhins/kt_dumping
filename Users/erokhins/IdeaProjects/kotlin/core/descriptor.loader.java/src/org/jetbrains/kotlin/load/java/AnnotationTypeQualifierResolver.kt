'FqName' @ [32:46] ==> public constructor FqName(@NotNull fqName: String) defined in org.jetbrains.kotlin.name.FqName[JavaClassConstructorDescriptor]

'FqName' @ [33:37] ==> public constructor FqName(@NotNull fqName: String) defined in org.jetbrains.kotlin.name.FqName[JavaClassConstructorDescriptor]

'FqName' @ [34:45] ==> public constructor FqName(@NotNull fqName: String) defined in org.jetbrains.kotlin.name.FqName[JavaClassConstructorDescriptor]
...
'annotations' @ [55:30] ==> public abstract val annotations: Annotations defined in org.jetbrains.kotlin.descriptors.ClassDescriptor[PropertyDescriptorImpl]

'hasAnnotation' @ [55:42] ==> public open fun hasAnnotation(fqName: FqName): Boolean defined in org.jetbrains.kotlin.descriptors.annotations.Annotations[SimpleFunctionDescriptorImpl]
...
'annotations' @ [57:32] ==> public abstract val annotations: Annotations defined in org.jetbrains.kotlin.descriptors.ClassDescriptor[PropertyDescriptorImpl]

'firstNotNullResult' @ [57:44] ==> public inline fun <T, R : Any> Iterable<AnnotationDescriptor>.firstNotNullResult(transform: (AnnotationDescriptor) -> AnnotationDescriptor?): AnnotationDescriptor? defined in org.jetbrains.kotlin.utils.addToStdlib[SimpleFunctionDescriptorImpl]
Inferred types:
...
'isIgnored' @ [67:25] ==> public final fun isIgnored(): Boolean defined in org.jetbrains.kotlin.utils.Jsr305State[SimpleFunctionDescriptorImpl]
...
'annotationClass' @ [71:52] ==> public val AnnotationDescriptor.annotationClass: ClassDescriptor? defined in org.jetbrains.kotlin.resolve.descriptorUtil in file DescriptorUtils.kt[PropertyDescriptorImpl]
...
'isIgnored' @ [78:25] ==> public final fun isIgnored(): Boolean defined in org.jetbrains.kotlin.utils.Jsr305State[SimpleFunctionDescriptorImpl]
...
'annotationClass' @ [83:38] ==> public val AnnotationDescriptor.annotationClass: ClassDescriptor? defined in org.jetbrains.kotlin.resolve.descriptorUtil in file DescriptorUtils.kt[PropertyDescriptorImpl]
...
'annotations' @ [83:67] ==> public abstract val annotations: Annotations defined in org.jetbrains.kotlin.descriptors.ClassDescriptor[PropertyDescriptorImpl]

'hasAnnotation' @ [83:79] ==> public open fun hasAnnotation(fqName: FqName): Boolean defined in org.jetbrains.kotlin.descriptors.annotations.Annotations[SimpleFunctionDescriptorImpl]
...
'annotationClass' @ [87:38] ==> public val AnnotationDescriptor.annotationClass: ClassDescriptor? defined in org.jetbrains.kotlin.resolve.descriptorUtil in file DescriptorUtils.kt[PropertyDescriptorImpl]

'annotations' @ [88:26] ==> public abstract val annotations: Annotations defined in org.jetbrains.kotlin.descriptors.ClassDescriptor[PropertyDescriptorImpl]

'findAnnotation' @ [88:38] ==> public open fun findAnnotation(fqName: FqName): AnnotationDescriptor? defined in org.jetbrains.kotlin.descriptors.annotations.Annotations[SimpleFunctionDescriptorImpl]
...
'allValueArguments' @ [89:26] ==> public abstract val allValueArguments: Map<Name, ConstantValue<*>> defined in org.jetbrains.kotlin.descriptors.annotations.AnnotationDescriptor[PropertyDescriptorImpl]
...
'annotations' @ [99:52] ==> public abstract val annotations: Annotations defined in org.jetbrains.kotlin.descriptors.ClassDescriptor[PropertyDescriptorImpl]

'firstNotNullResult' @ [99:64] ==> public inline fun <T, R : Any> Iterable<AnnotationDescriptor>.firstNotNullResult(transform: (AnnotationDescriptor) -> AnnotationDescriptor?): AnnotationDescriptor? defined in org.jetbrains.kotlin.utils.addToStdlib[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> AnnotationDescriptor
    <R : Any> -> AnnotationDescriptor
...
'value' @ [106:30] ==> public open val value: List<ConstantValue<*>> defined in org.jetbrains.kotlin.resolve.constants.ArrayValue[PropertyDescriptorImpl]
...
'value' @ [108:27] ==> public open val value: ClassDescriptor defined in org.jetbrains.kotlin.resolve.constants.EnumValue[PropertyDescriptorImpl]
...
'fqNameSafe' @ [123:13] ==> public val DeclarationDescriptor.fqNameSafe: FqName defined in org.jetbrains.kotlin.resolve.descriptorUtil in file DescriptorUtils.kt[PropertyDescriptorImpl]
...
'annotations' @ [123:63] ==> public abstract val annotations: Annotations defined in org.jetbrains.kotlin.descriptors.ClassDescriptor[PropertyDescriptorImpl]

'hasAnnotation' @ [123:75] ==> public open fun hasAnnotation(fqName: FqName): Boolean defined in org.jetbrains.kotlin.descriptors.annotations.Annotations[SimpleFunctionDescriptorImpl]
