...
'createLazyValue' @ [42:50] ==> public abstract fun <T : Any> createLazyValue(computable: () -> List<MemberScope>): NotNullLazyValue<List<MemberScope>> defined in org.jetbrains.kotlin.storage.StorageManager[SimpleFunctionDescriptorImpl]
Inferred types:
...
'getFirstClassifierDiscriminateHeaders' @ [54:16] ==> public inline fun <Scope, T : ClassifierDescriptor> getFirstClassifierDiscriminateHeaders(scopes: List<MemberScope>, callback: (MemberScope) -> ClassifierDescriptor?): ClassifierDescriptor? defined in org.jetbrains.kotlin.util.collectionUtils[SimpleFunctionDescriptorImpl]
Inferred types:
    <Scope> -> MemberScope
...
'getContributedClassifier' @ [54:73] ==> public abstract fun getContributedClassifier(name: Name, location: LookupLocation): ClassifierDescriptor? defined in org.jetbrains.kotlin.resolve.scopes.MemberScope[SimpleFunctionDescriptorImpl]
...
'getFromAllScopes' @ [59:16] ==> public inline fun <Scope, T> getFromAllScopes(firstScope: MemberScope, restScopes: List<MemberScope>, callback: (MemberScope) -> Collection<PropertyDescriptor>): Collection<PropertyDescriptor> defined in org.jetbrains.kotlin.util.collectionUtils[SimpleFunctionDescriptorImpl]
Inferred types:
    <Scope> -> MemberScope
...
'getContributedVariables' @ [59:63] ==> public abstract fun getContributedVariables(name: Name, location: LookupLocation): Collection<PropertyDescriptor> defined in org.jetbrains.kotlin.resolve.scopes.MemberScope[SimpleFunctionDescriptorImpl]
...
'getFromAllScopes' @ [64:16] ==> public inline fun <Scope, T> getFromAllScopes(firstScope: MemberScope, restScopes: List<MemberScope>, callback: (MemberScope) -> Collection<SimpleFunctionDescriptor>): Collection<SimpleFunctionDescriptor> defined in org.jetbrains.kotlin.util.collectionUtils[SimpleFunctionDescriptorImpl]
Inferred types:
    <Scope> -> MemberScope
...
'getContributedFunctions' @ [64:63] ==> public abstract fun getContributedFunctions(name: Name, location: LookupLocation): Collection<SimpleFunctionDescriptor> defined in org.jetbrains.kotlin.resolve.scopes.MemberScope[SimpleFunctionDescriptorImpl]
...
'getFromAllScopes' @ [70:13] ==> public inline fun <Scope, T> getFromAllScopes(firstScope: MemberScope, restScopes: List<MemberScope>, callback: (MemberScope) -> Collection<DeclarationDescriptor>): Collection<DeclarationDescriptor> defined in org.jetbrains.kotlin.util.collectionUtils[SimpleFunctionDescriptorImpl]
Inferred types:
    <Scope> -> MemberScope
...
'getContributedDescriptors' @ [70:60] ==> public abstract fun getContributedDescriptors(kindFilter: DescriptorKindFilter, nameFilter: (Name) -> Boolean): Collection<DeclarationDescriptor> defined in org.jetbrains.kotlin.resolve.scopes.MemberScope[SimpleFunctionDescriptorImpl]
...
'getFunctionNames' @ [72:83] ==> public abstract fun getFunctionNames(): Set<Name> defined in org.jetbrains.kotlin.resolve.scopes.MemberScope[SimpleFunctionDescriptorImpl]
...
'getVariableNames' @ [75:83] ==> public abstract fun getVariableNames(): Set<Name> defined in org.jetbrains.kotlin.resolve.scopes.MemberScope[SimpleFunctionDescriptorImpl]
...
'println' @ [80:11] ==> @NotNull public open fun println(vararg objects: (Any..Any?)): Printer defined in org.jetbrains.kotlin.utils.Printer[JavaMethodDescriptor]
...
'println' @ [83:11] ==> @NotNull public open fun println(vararg objects: (Any..Any?)): Printer defined in org.jetbrains.kotlin.utils.Printer[JavaMethodDescriptor]
...
'printScopeStructure' @ [87:25] ==> public abstract fun printScopeStructure(p: Printer): Unit defined in org.jetbrains.kotlin.resolve.scopes.MemberScope[SimpleFunctionDescriptorImpl]
...
'println' @ [91:11] ==> @NotNull public open fun println(vararg objects: (Any..Any?)): Printer defined in org.jetbrains.kotlin.utils.Printer[JavaMethodDescriptor]
...
'record' @ [95:36] ==> public fun LookupTracker.record(from: LookupLocation, scopeOwner: PackageFragmentDescriptor, name: Name): Unit defined in org.jetbrains.kotlin.incremental in file utils.kt[SimpleFunctionDescriptorImpl]
