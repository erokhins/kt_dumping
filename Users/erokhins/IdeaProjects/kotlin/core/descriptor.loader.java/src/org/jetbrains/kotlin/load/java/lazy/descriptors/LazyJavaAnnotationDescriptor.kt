...
'createLazyValue' @ [62:56] ==> public abstract fun <T : Any> createLazyValue(computable: () -> Map<(Name..Name?), ConstantValue<Any?>>): NotNullLazyValue<Map<(Name..Name?), ConstantValue<Any?>>> defined in org.jetbrains.kotlin.storage.StorageManager[SimpleFunctionDescriptorImpl]
Inferred types:
