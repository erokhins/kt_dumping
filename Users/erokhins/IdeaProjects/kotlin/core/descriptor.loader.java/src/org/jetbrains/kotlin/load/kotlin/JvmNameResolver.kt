...
'guessByFirstCharacter' @ [86:45] ==> @NotNull public open fun guessByFirstCharacter(@NotNull name: String): Name defined in org.jetbrains.kotlin.name.Name[JavaMethodDescriptor]
...
'FqName' @ [93:22] ==> public constructor FqName(@NotNull fqName: String) defined in org.jetbrains.kotlin.name.FqName[JavaClassConstructorDescriptor]
...
'FqName' @ [94:25] ==> public constructor FqName(@NotNull fqName: String) defined in org.jetbrains.kotlin.name.FqName[JavaClassConstructorDescriptor]
...
'ClassId' @ [95:16] ==> public constructor ClassId(@NotNull packageFqName: FqName, @NotNull relativeClassName: FqName, local: Boolean) defined in org.jetbrains.kotlin.name.ClassId[JavaClassConstructorDescriptor]
