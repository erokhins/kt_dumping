'TypeSubstitution' @ [26:75] ==> public constructor TypeSubstitution() defined in org.jetbrains.kotlin.types.TypeSubstitution[ClassConstructorDescriptorImpl]

'AnnotationsImpl' @ [27:45] ==> public constructor AnnotationsImpl(annotations: List<AnnotationDescriptor>) defined in org.jetbrains.kotlin.descriptors.annotations.AnnotationsImpl[ClassConstructorDescriptorImpl]
...
'BuiltInAnnotationDescriptor' @ [28:13] ==> public constructor BuiltInAnnotationDescriptor(builtIns: KotlinBuiltIns, fqName: FqName, allValueArguments: Map<Name, ConstantValue<*>>) defined in org.jetbrains.kotlin.descriptors.annotations.BuiltInAnnotationDescriptor[ClassConstructorDescriptorImpl]
...
'unwrap' @ [42:29] ==> public abstract fun unwrap(): UnwrappedType defined in org.jetbrains.kotlin.types.KotlinType[SimpleFunctionDescriptorImpl]
...
'upperBound' @ [50:25] ==> public final val upperBound: SimpleType defined in org.jetbrains.kotlin.types.FlexibleType[PropertyDescriptorImpl]
...
'inheritEnhancement' @ [51:23] ==> public fun UnwrappedType.inheritEnhancement(origin: KotlinType): UnwrappedType defined in org.jetbrains.kotlin.types in file TypeWithEnhancement.kt[SimpleFunctionDescriptorImpl]
...
'TypeProjectionImpl' @ [67:13] ==> public constructor TypeProjectionImpl(@NotNull projection: Variance, @NotNull type: KotlinType) defined in org.jetbrains.kotlin.types.TypeProjectionImpl[JavaClassConstructorDescriptor]
...
'unwrap' @ [69:35] ==> public abstract fun unwrap(): UnwrappedType defined in org.jetbrains.kotlin.types.KotlinType[SimpleFunctionDescriptorImpl]
...
'isFlexible' @ [80:22] ==> public fun KotlinType.isFlexible(): Boolean defined in org.jetbrains.kotlin.types in file flexibleTypes.kt[SimpleFunctionDescriptorImpl]
...
'lowerIfFlexible' @ [82:48] ==> public fun KotlinType.lowerIfFlexible(): SimpleType defined in org.jetbrains.kotlin.types in file flexibleTypes.kt[SimpleFunctionDescriptorImpl]
...
'upperIfFlexible' @ [83:48] ==> public fun KotlinType.upperIfFlexible(): SimpleType defined in org.jetbrains.kotlin.types in file flexibleTypes.kt[SimpleFunctionDescriptorImpl]
...
'arguments' @ [87:26] ==> public abstract val arguments: List<TypeProjection> defined in org.jetbrains.kotlin.types.KotlinType[PropertyDescriptorImpl]
...
'constructor' @ [94:38] ==> public abstract val constructor: TypeConstructor defined in org.jetbrains.kotlin.types.KotlinType[PropertyDescriptorImpl]
