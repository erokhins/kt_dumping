...
'createLazyValue' @ [80:50] ==> public abstract fun <T : Any> createLazyValue(computable: () -> List<(ClassConstructorDescriptor..ClassConstructorDescriptor?)>): NotNullLazyValue<List<(ClassConstructorDescriptor..ClassConstructorDescriptor?)>> defined in org.jetbrains.kotlin.storage.StorageManager[SimpleFunctionDescriptorImpl]
Inferred types:
...
'if (isAnnotation) createAnnotationConstructorParameters(constructorDescriptor)
                              else Collections.emptyList<ValueParameterDescriptor>()' @ [541:31] ==> public final fun <`<TYPE-PARAMETER-FOR-IF-RESOLVE>`> `<SPECIAL-FUNCTION-FOR-IF-RESOLVE>`(thenBranch: (List<ValueParameterDescriptor>..List<(ValueParameterDescriptor..ValueParameterDescriptor?)>?), elseBranch: (List<ValueParameterDescriptor>..List<(ValueParameterDescriptor..ValueParameterDescriptor?)>?)): (List<ValueParameterDescriptor>..List<(ValueParameterDescriptor..ValueParameterDescriptor?)>?)[SimpleFunctionDescriptorImpl]
Inferred types:
    <`<TYPE-PARAMETER-FOR-IF-RESOLVE>`> -> (kotlin.collections.List<org.jetbrains.kotlin.descriptors.ValueParameterDescriptor>..kotlin.collections.List<(org.jetbrains.kotlin.descriptors.ValueParameterDescriptor..org.jetbrains.kotlin.descriptors.ValueParameterDescriptor?)>?)
...
'valueParameters' @ [545:42] ==> val valueParameters: (List<ValueParameterDescriptor>..List<(ValueParameterDescriptor..ValueParameterDescriptor?)>?) defined in org.jetbrains.kotlin.load.java.lazy.descriptors.LazyJavaClassMemberScope.createDefaultConstructor[LocalVariableDescriptor]
