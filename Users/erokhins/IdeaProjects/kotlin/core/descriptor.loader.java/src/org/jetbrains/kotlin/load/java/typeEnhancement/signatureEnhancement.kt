...
'fqName' @ [70:53] ==> public open val fqName: FqName? defined in org.jetbrains.kotlin.descriptors.annotations.AnnotationDescriptor[PropertyDescriptorImpl]
...
'isWarning' @ [77:78] ==> public final fun isWarning(): Boolean defined in org.jetbrains.kotlin.utils.Jsr305State[SimpleFunctionDescriptorImpl]
...
'fqName' @ [81:39] ==> public open val fqName: FqName? defined in org.jetbrains.kotlin.descriptors.annotations.AnnotationDescriptor[PropertyDescriptorImpl]
...
'annotations' @ [105:70] ==> public abstract val annotations: Annotations defined in org.jetbrains.kotlin.descriptors.CallableMemberDescriptor[PropertyDescriptorImpl]
...
'safeAs' @ [118:58] ==> public inline fun <reified T : Any> Any?.safeAs(): FunctionDescriptor? defined in org.jetbrains.kotlin.utils.addToStdlib[SimpleFunctionDescriptorImpl]
Inferred types:
...
'index' @ [147:38] ==> public abstract val index: Int defined in org.jetbrains.kotlin.descriptors.ValueParameterDescriptor[PropertyDescriptorImpl]
...
'index' @ [148:85] ==> public abstract val index: Int defined in org.jetbrains.kotlin.descriptors.ValueParameterDescriptor[PropertyDescriptorImpl]
...
'safeAs' @ [156:46] ==> public inline fun <reified T : Any> Any?.safeAs(): PropertyDescriptor? defined in org.jetbrains.kotlin.utils.addToStdlib[SimpleFunctionDescriptorImpl]
Inferred types:
...
'isFlexible' @ [199:30] ==> public fun KotlinType.isFlexible(): Boolean defined in org.jetbrains.kotlin.types in file flexibleTypes.kt[SimpleFunctionDescriptorImpl]

'asFlexibleType' @ [200:25] ==> public fun KotlinType.asFlexibleType(): FlexibleType defined in org.jetbrains.kotlin.types in file flexibleTypes.kt[SimpleFunctionDescriptorImpl]
...
'lowerBound' @ [200:56] ==> public final val lowerBound: SimpleType defined in org.jetbrains.kotlin.types.FlexibleType[PropertyDescriptorImpl]
...
'upperBound' @ [200:71] ==> public final val upperBound: SimpleType defined in org.jetbrains.kotlin.types.FlexibleType[PropertyDescriptorImpl]
...
'isMarkedNullable' @ [206:31] ==> public abstract val isMarkedNullable: Boolean defined in org.jetbrains.kotlin.types.KotlinType[PropertyDescriptorImpl]
...
'isMarkedNullable' @ [207:32] ==> public abstract val isMarkedNullable: Boolean defined in org.jetbrains.kotlin.types.KotlinType[PropertyDescriptorImpl]
...
'unwrap' @ [215:46] ==> public abstract fun unwrap(): UnwrappedType defined in org.jetbrains.kotlin.types.KotlinType[SimpleFunctionDescriptorImpl]
...
'annotations' @ [221:58] ==> public abstract val annotations: Annotations defined in org.jetbrains.kotlin.descriptors.annotations.Annotated[PropertyDescriptorImpl]

'annotations' @ [221:71] ==> public abstract val annotations: Annotations defined in org.jetbrains.kotlin.types.KotlinType[PropertyDescriptorImpl]

'annotations' @ [223:25] ==> public abstract val annotations: Annotations defined in org.jetbrains.kotlin.types.KotlinType[PropertyDescriptorImpl]
...
'findAnnotation' @ [226:50] ==> public open fun findAnnotation(fqName: FqName): AnnotationDescriptor? defined in org.jetbrains.kotlin.descriptors.annotations.Annotations[SimpleFunctionDescriptorImpl]
...
'isTypeParameter' @ [250:109] ==> public fun KotlinType.isTypeParameter(): Boolean defined in org.jetbrains.kotlin.types.typeUtil in file TypeUtils.kt[SimpleFunctionDescriptorImpl]
...
'firstNotNullResult' @ [256:22] ==> public inline fun <T, R : Any> Iterable<AnnotationDescriptor>.firstNotNullResult(transform: (AnnotationDescriptor) -> NullabilityQualifierWithMigrationStatus?): NullabilityQualifierWithMigrationStatus? defined in org.jetbrains.kotlin.utils.addToStdlib[SimpleFunctionDescriptorImpl]
Inferred types:
    <T> -> AnnotationDescriptor
...
'arguments' @ [264:38] ==> public abstract val arguments: List<TypeProjection> defined in org.jetbrains.kotlin.types.KotlinType[PropertyDescriptorImpl]
...
'equalTypes' @ [286:106] ==> public abstract fun equalTypes(@NotNull a: KotlinType, @NotNull b: KotlinType): Boolean defined in org.jetbrains.kotlin.types.checker.KotlinTypeChecker[JavaMethodDescriptor]
...
'unwrapEnhancement' @ [312:38] ==> public fun KotlinType.unwrapEnhancement(): KotlinType defined in org.jetbrains.kotlin.types in file TypeWithEnhancement.kt[SimpleFunctionDescriptorImpl]
