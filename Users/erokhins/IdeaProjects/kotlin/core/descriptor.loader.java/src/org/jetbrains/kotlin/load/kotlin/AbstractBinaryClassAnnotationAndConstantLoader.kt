...
'createMemoizedFunction' @ [42:42] ==> public abstract fun <K, V : Any> createMemoizedFunction(compute: (KotlinJvmBinaryClass) -> AbstractBinaryClassAnnotationAndConstantLoader.Storage<A, C>): MemoizedFunctionToNotNull<KotlinJvmBinaryClass, AbstractBinaryClassAnnotationAndConstantLoader.Storage<A, C>> defined in org.jetbrains.kotlin.storage.StorageManager[SimpleFunctionDescriptorImpl]
Inferred types:
...
'source' @ [68:14] ==> public final val source: SourceElement? defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer.Class[PropertyDescriptorImpl]
...
'debugFqName' @ [73:119] ==> public open fun debugFqName(): FqName defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer.Class[SimpleFunctionDescriptorImpl]
...
'nameResolver' @ [93:84] ==> public final val nameResolver: NameResolver defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer[PropertyDescriptorImpl]
...
'typeTable' @ [93:108] ==> public final val typeTable: TypeTable defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer[PropertyDescriptorImpl]
...
'nameResolver' @ [94:72] ==> public final val nameResolver: NameResolver defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer[PropertyDescriptorImpl]
...
'typeTable' @ [94:96] ==> public final val typeTable: TypeTable defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer[PropertyDescriptorImpl]
...
'get' @ [96:42] ==> @Override @NotNull public open fun get(flags: Int): Boolean defined in org.jetbrains.kotlin.serialization.Flags.BooleanFlagField[JavaMethodDescriptor]
...
'nameResolver' @ [116:63] ==> public final val nameResolver: NameResolver defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer[PropertyDescriptorImpl]
...
'typeTable' @ [116:87] ==> public final val typeTable: TypeTable defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer[PropertyDescriptorImpl]
...
'nameResolver' @ [122:27] ==> public final val nameResolver: NameResolver defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer[PropertyDescriptorImpl]

'getString' @ [122:40] ==> @NotNull public abstract fun getString(index: Int): String defined in org.jetbrains.kotlin.serialization.deserialization.NameResolver[JavaMethodDescriptor]
...
'classId' @ [123:78] ==> public final val classId: ClassId defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer.Class[PropertyDescriptorImpl]
...
'nameResolver' @ [151:77] ==> public final val nameResolver: NameResolver defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer[PropertyDescriptorImpl]
...
'typeTable' @ [151:101] ==> public final val typeTable: TypeTable defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer[PropertyDescriptorImpl]
...
'hasReceiver' @ [163:49] ==> public fun ProtoBuf.Function.hasReceiver(): Boolean defined in org.jetbrains.kotlin.serialization.deserialization in file protoTypeTableUtil.kt[SimpleFunctionDescriptorImpl]
...
'hasReceiver' @ [164:49] ==> public fun ProtoBuf.Property.hasReceiver(): Boolean defined in org.jetbrains.kotlin.serialization.deserialization in file protoTypeTableUtil.kt[SimpleFunctionDescriptorImpl]
...
'kind' @ [166:53] ==> public final val kind: ProtoBuf.Class.Kind defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer.Class[PropertyDescriptorImpl]
...
'isInner' @ [167:27] ==> public final val isInner: Boolean defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer.Class[PropertyDescriptorImpl]
...
'nameResolver' @ [179:69] ==> public final val nameResolver: NameResolver defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer[PropertyDescriptorImpl]
...
'typeTable' @ [179:93] ==> public final val typeTable: TypeTable defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer[PropertyDescriptorImpl]
...
'nameResolver' @ [197:63] ==> public final val nameResolver: NameResolver defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer[PropertyDescriptorImpl]
...
'typeTable' @ [197:87] ==> public final val typeTable: TypeTable defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer[PropertyDescriptorImpl]
...
'get' @ [200:123] ==> @Override @NotNull public open fun get(flags: Int): Boolean defined in org.jetbrains.kotlin.serialization.Flags.BooleanFlagField[JavaMethodDescriptor]
...
'kind' @ [223:64] ==> public final val kind: ProtoBuf.Class.Kind defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer.Class[PropertyDescriptorImpl]
...
'classId' @ [225:35] ==> public final val classId: ClassId defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer.Class[PropertyDescriptorImpl]

'createNestedClassId' @ [225:43] ==> @NotNull public open fun createNestedClassId(@NotNull name: Name): ClassId defined in org.jetbrains.kotlin.name.ClassId[JavaMethodDescriptor]

'identifier' @ [225:68] ==> @NotNull public open fun identifier(@NotNull name: String): Name defined in org.jetbrains.kotlin.name.Name[JavaMethodDescriptor]
...
'source' @ [230:50] ==> public final val source: SourceElement? defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer[PropertyDescriptorImpl]
...
'topLevel' @ [233:70] ==> @NotNull public open fun topLevel(@NotNull topLevelFqName: FqName): ClassId defined in org.jetbrains.kotlin.name.ClassId[JavaMethodDescriptor]

'FqName' @ [233:79] ==> public constructor FqName(@NotNull fqName: String) defined in org.jetbrains.kotlin.name.FqName[JavaClassConstructorDescriptor]
...
'kind' @ [237:69] ==> public final val kind: ProtoBuf.Class.Kind defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer.Class[PropertyDescriptorImpl]
...
'outerClass' @ [238:40] ==> public final val outerClass: ProtoContainer.Class? defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer.Class[PropertyDescriptorImpl]
...
'kind' @ [239:51] ==> public final val kind: ProtoBuf.Class.Kind defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer.Class[PropertyDescriptorImpl]
...
'kind' @ [239:99] ==> public final val kind: ProtoBuf.Class.Kind defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer.Class[PropertyDescriptorImpl]
...
'source' @ [244:62] ==> public final val source: SourceElement? defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer[PropertyDescriptorImpl]
...
'source' @ [245:50] ==> public final val source: SourceElement? defined in org.jetbrains.kotlin.serialization.deserialization.ProtoContainer[PropertyDescriptorImpl]
...
'if (proto.hasExtension(propertySignature)) proto.getExtension(propertySignature)
                else return null' @ [315:17] ==> public final fun <`<TYPE-PARAMETER-FOR-IF-RESOLVE>`> `<SPECIAL-FUNCTION-FOR-IF-RESOLVE>`(thenBranch: (JvmProtoBuf.JvmPropertySignature..JvmProtoBuf.JvmPropertySignature?), elseBranch: (JvmProtoBuf.JvmPropertySignature..JvmProtoBuf.JvmPropertySignature?)): (JvmProtoBuf.JvmPropertySignature..JvmProtoBuf.JvmPropertySignature?)[SimpleFunctionDescriptorImpl]
Inferred types:
...
'?:' @ [319:32] ==> public final fun <`<TYPE-PARAMETER-FOR-ELVIS-RESOLVE>`> `<SPECIAL-FUNCTION-FOR-ELVIS-RESOLVE>`(left: JvmProtoBufUtil.PropertySignature?, right: JvmProtoBufUtil.PropertySignature): JvmProtoBufUtil.PropertySignature[SimpleFunctionDescriptorImpl]
Inferred types:
...
'signature' @ [322:31] ==> val signature: (JvmProtoBuf.JvmPropertySignature..JvmProtoBuf.JvmPropertySignature?) defined in org.jetbrains.kotlin.load.kotlin.AbstractBinaryClassAnnotationAndConstantLoader.getPropertySignature[LocalVariableDescriptor]
...
'signature' @ [323:61] ==> val signature: (JvmProtoBuf.JvmPropertySignature..JvmProtoBuf.JvmPropertySignature?) defined in org.jetbrains.kotlin.load.kotlin.AbstractBinaryClassAnnotationAndConstantLoader.getPropertySignature[LocalVariableDescriptor]
...
'?:' @ [337:55] ==> public final fun <`<TYPE-PARAMETER-FOR-ELVIS-RESOLVE>`> `<SPECIAL-FUNCTION-FOR-ELVIS-RESOLVE>`(left: String?, right: String): String[SimpleFunctionDescriptorImpl]
Inferred types:
...
'?:' @ [340:55] ==> public final fun <`<TYPE-PARAMETER-FOR-ELVIS-RESOLVE>`> `<SPECIAL-FUNCTION-FOR-ELVIS-RESOLVE>`(left: String?, right: String): String[SimpleFunctionDescriptorImpl]
Inferred types:
    <`<TYPE-PARAMETER-FOR-ELVIS-RESOLVE>`> -> String
...
'FqName' @ [365:17] ==> public constructor FqName(@NotNull fqName: String) defined in org.jetbrains.kotlin.name.FqName[JavaClassConstructorDescriptor]

'FqName' @ [366:17] ==> public constructor FqName(@NotNull fqName: String) defined in org.jetbrains.kotlin.name.FqName[JavaClassConstructorDescriptor]

'FqName' @ [367:17] ==> public constructor FqName(@NotNull fqName: String) defined in org.jetbrains.kotlin.name.FqName[JavaClassConstructorDescriptor]
...
'topLevel' @ [368:24] ==> @NotNull public open fun topLevel(@NotNull topLevelFqName: FqName): ClassId defined in org.jetbrains.kotlin.name.ClassId[JavaMethodDescriptor]
